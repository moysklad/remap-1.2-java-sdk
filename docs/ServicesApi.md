...
> List&lt;ModelFile&gt; addServiceFiles(id, fileUpload, accept, acceptEncoding, contentType)
...
import ru.moysklad.remap_1_2.api.ServicesApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            List<ModelFile> result = apiInstance.addServiceFiles(id, fileUpload, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ServicesApi#addServiceFiles");
...
> Service createService(service, expand, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            Service result = apiInstance.createService(service, expand, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
...
> deleteService(id, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            apiInstance.deleteService(id, accept, acceptEncoding);
        } catch (ApiException e) {
...
> deleteServiceFile(id, fileId, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            apiInstance.deleteServiceFile(id, fileId, accept, acceptEncoding);
        } catch (ApiException e) {
            System.err.println("Exception when calling ServicesApi#deleteServiceFile");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> Service getServiceById(id, expand, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            Service result = apiInstance.getServiceById(id, expand, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
...
> GetProductFiles200Response getServiceFiles(id, limit, offset, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            GetProductFiles200Response result = apiInstance.getServiceFiles(id, limit, offset, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ServicesApi#getServiceFiles");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> ServiceList getServices(limit, offset, search, filter, expand, order, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            ServiceList result = apiInstance.getServices(limit, offset, search, filter, expand, order, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
...
> Service updateService(id, service, expand, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            Service result = apiInstance.updateService(id, service, expand, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
