...
| [**getEmissionOrderMetadata**](EmissionOrdersApi.md#getEmissionOrderMetadata) | **GET** /entity/emissionorder/metadata | Метаданные Заказов кодов маркировки |
| [**getEmissionOrderMetadataStateById**](EmissionOrdersApi.md#getEmissionOrderMetadataStateById) | **GET** /entity/emissionorder/metadata/states/{id} | Отдельный статус Заказа кодов маркировки |
| [**getEmissionOrderPositionById**](EmissionOrdersApi.md#getEmissionOrderPositionById) | **GET** /entity/emissionorder/{id}/positions/{positionId} | Получить позицию Заказа кодов маркировки |
| [**getEmissionOrderPositions**](EmissionOrdersApi.md#getEmissionOrderPositions) | **GET** /entity/emissionorder/{id}/positions | Получить позиции Заказа кодов маркировки |
| [**updateEmissionOrder**](EmissionOrdersApi.md#updateEmissionOrder) | **PUT** /entity/emissionorder/{id} | Изменить Заказ кодов маркировки |
| [**updateEmissionOrderMetadataStateById**](EmissionOrdersApi.md#updateEmissionOrderMetadataStateById) | **PUT** /entity/emissionorder/metadata/states/{id} | Обновить отдельный статус Заказа кодов маркировки |
| [**updateEmissionOrderPosition**](EmissionOrdersApi.md#updateEmissionOrderPosition) | **PUT** /entity/emissionorder/{id}/positions/{positionId} | Изменить позицию Заказа кодов маркировки |



## createEmissionOrder

> EmissionOrder createEmissionOrder(emissionOrder, expand, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            EmissionOrder result = apiInstance.createEmissionOrder(emissionOrder, expand, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#createEmissionOrder");
...
|------------- | ------------- | ------------- | -------------|
| **emissionOrder** | [**EmissionOrder**](EmissionOrder.md)|  | |
...
|------------- | ------------- | ------------- | -------------|
| **id** | **UUID**| ID сущности | |
| **emissionOrderPosition** | [**EmissionOrderPosition**](EmissionOrderPosition.md)|  | |
| **expand** | **String**| Замена ссылок объектами с помощью expand | [optional] |
| **accept** | **String**|  | [optional] [default to application/json;charset&#x3D;utf-8] [enum: application/json, application/json;charset=utf-8] |
| **acceptEncoding** | **String**|  | [optional] [default to gzip, deflate, br] |
| **contentType** | **String**|  | [optional] [default to application/json] [enum: application/json] |
...
> deleteEmissionOrderMetadataStateById(id, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            apiInstance.deleteEmissionOrderMetadataStateById(id, accept, acceptEncoding, contentType);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#deleteEmissionOrderMetadataStateById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> EmissionOrder getEmissionOrderById(id, expand, fields, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            EmissionOrder result = apiInstance.getEmissionOrderById(id, expand, fields, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#getEmissionOrderById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> EmissionOrderList getEmissionOrderList(limit, offset, expand, fields, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            EmissionOrderList result = apiInstance.getEmissionOrderList(limit, offset, expand, fields, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#getEmissionOrderList");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> DocumentMetadata getEmissionOrderMetadata(accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            DocumentMetadata result = apiInstance.getEmissionOrderMetadata(accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#getEmissionOrderMetadata");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> State getEmissionOrderMetadataStateById(id, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            State result = apiInstance.getEmissionOrderMetadataStateById(id, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#getEmissionOrderMetadataStateById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> EmissionOrderPosition getEmissionOrderPositionById(id, positionId, expand, fields, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            EmissionOrderPosition result = apiInstance.getEmissionOrderPositionById(id, positionId, expand, fields, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#getEmissionOrderPositionById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> EmissionOrderPositionList getEmissionOrderPositions(id, limit, offset, expand, fields, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            EmissionOrderPositionList result = apiInstance.getEmissionOrderPositions(id, limit, offset, expand, fields, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#getEmissionOrderPositions");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> EmissionOrder updateEmissionOrder(id, emissionOrder, expand, fields, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            EmissionOrder result = apiInstance.updateEmissionOrder(id, emissionOrder, expand, fields, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#updateEmissionOrder");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> State updateEmissionOrderMetadataStateById(id, state, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            State result = apiInstance.updateEmissionOrderMetadataStateById(id, state, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#updateEmissionOrderMetadataStateById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> EmissionOrderPosition updateEmissionOrderPosition(id, positionId, emissionOrderPosition, expand, fields, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            EmissionOrderPosition result = apiInstance.updateEmissionOrderPosition(id, positionId, emissionOrderPosition, expand, fields, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EmissionOrdersApi#updateEmissionOrderPosition");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
