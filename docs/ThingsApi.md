...
> Thing getThingById(id, accept, acceptEncoding)
...
import ru.moysklad.remap_1_2.api.ThingsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            Thing result = apiInstance.getThingById(id, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ThingsApi#getThingById");
...
> ThingList getThings(limit, offset, search, filter, order, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            ThingList result = apiInstance.getThings(limit, offset, search, filter, order, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ThingsApi#getThings");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
