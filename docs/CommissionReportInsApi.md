...
> List&lt;CreateCommissionReportInBatch200ResponseInner&gt; createCommissionReportInBatch(commissionReportIn, expand, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            List<CreateCommissionReportInBatch200ResponseInner> result = apiInstance.createCommissionReportInBatch(commissionReportIn, expand, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
...
[**List&lt;CreateCommissionReportInBatch200ResponseInner&gt;**](CreateCommissionReportInBatch200ResponseInner.md)
...
> CreateInternalOrderMetadataStateRequest createCommissionReportInMetadataState(createInternalOrderMetadataStateRequest, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            CreateInternalOrderMetadataStateRequest result = apiInstance.createCommissionReportInMetadataState(createInternalOrderMetadataStateRequest, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
...
> List&lt;DeleteContractsBatch200ResponseInner&gt; deleteCommissionReportInBatch(commissionReportIn, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            List<DeleteContractsBatch200ResponseInner> result = apiInstance.deleteCommissionReportInBatch(commissionReportIn, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
...
> List&lt;DeleteContractsBatch200ResponseInner&gt; deleteCommissionReportInPositionsBatch(id, commissionReportInPosition, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            List<DeleteContractsBatch200ResponseInner> result = apiInstance.deleteCommissionReportInPositionsBatch(id, commissionReportInPosition, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
...
> List&lt;DeleteContractsBatch200ResponseInner&gt; deleteCommissionReportInReturnedPositionsBatch(id, commissionReportInReturnedPosition, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            List<DeleteContractsBatch200ResponseInner> result = apiInstance.deleteCommissionReportInReturnedPositionsBatch(id, commissionReportInReturnedPosition, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
