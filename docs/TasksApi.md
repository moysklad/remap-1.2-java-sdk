...
| [**deleteTask**](TasksApi.md#deleteTask) | **DELETE** /entity/task/{id} | Удалить задачу |
| [**deleteTaskMetadataStateById**](TasksApi.md#deleteTaskMetadataStateById) | **DELETE** /entity/task/metadata/states/{id} | Удалить тип задачи |
| [**deleteTaskNote**](TasksApi.md#deleteTaskNote) | **DELETE** /entity/task/{id}/notes/{noteId} | Удалить комментарий к Задаче |
| [**deleteTaskNotesBatch**](TasksApi.md#deleteTaskNotesBatch) | **POST** /entity/task/{id}/notes/delete | Удалить комментарии к Задаче |
| [**deleteTasksBatch**](TasksApi.md#deleteTasksBatch) | **POST** /entity/task/delete | Удалить задачи |
| [**getTaskById**](TasksApi.md#getTaskById) | **GET** /entity/task/{id} | Получить задачу по ID |
| [**getTaskMetadata**](TasksApi.md#getTaskMetadata) | **GET** /entity/task/metadata | Получить метаданные задач |
| [**getTaskNoteById**](TasksApi.md#getTaskNoteById) | **GET** /entity/task/{id}/notes/{noteId} | Получить комментарий к Задаче по ID |
| [**getTaskNotes**](TasksApi.md#getTaskNotes) | **GET** /entity/task/{id}/notes | Получить комментарии Задачи |
| [**getTasks**](TasksApi.md#getTasks) | **GET** /entity/task | Получить список задач |
| [**updateTask**](TasksApi.md#updateTask) | **PUT** /entity/task/{id} | Обновить задачу |
| [**updateTaskMetadataStateById**](TasksApi.md#updateTaskMetadataStateById) | **PUT** /entity/task/metadata/states/{id} | Обновить тип задачи |
| [**updateTaskNote**](TasksApi.md#updateTaskNote) | **PUT** /entity/task/{id}/notes/{noteId} | Обновить комментарий к Задаче |



## createTask

> Task createTask(task, expand, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            Task result = apiInstance.createTask(task, expand, accept, acceptEncoding, contentType);
...
> deleteTask(id, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            apiInstance.deleteTask(id, accept, acceptEncoding);
        } catch (ApiException e) {
...
## deleteTaskMetadataStateById

> deleteTaskMetadataStateById(id, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            apiInstance.deleteTaskMetadataStateById(id, accept, acceptEncoding, contentType);
        } catch (ApiException e) {
            System.err.println("Exception when calling TasksApi#deleteTaskMetadataStateById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> deleteTaskNote(id, noteId, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            apiInstance.deleteTaskNote(id, noteId, accept, acceptEncoding);
        } catch (ApiException e) {
            System.err.println("Exception when calling TasksApi#deleteTaskNote");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
|------------- | ------------- | ------------- | -------------|
| **id** | **UUID**| ID сущности | |
| **noteId** | **UUID**| ID комментария к Задаче | |
| **accept** | **String**|  | [optional] [default to application/json;charset&#x3D;utf-8] [enum: application/json, application/json;charset=utf-8] |
| **acceptEncoding** | **String**|  | [optional] [default to gzip, deflate, br] |
...
## deleteTaskNotesBatch

> deleteTaskNotesBatch(id, taskNote, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            apiInstance.deleteTaskNotesBatch(id, taskNote, accept, acceptEncoding, contentType);
        } catch (ApiException e) {
            System.err.println("Exception when calling TasksApi#deleteTaskNotesBatch");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> Task getTaskById(id, expand, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            Task result = apiInstance.getTaskById(id, expand, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
...
> DocumentMetadata getTaskMetadata(accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            DocumentMetadata result = apiInstance.getTaskMetadata(accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TasksApi#getTaskMetadata");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> TaskNote getTaskNoteById(id, noteId, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            TaskNote result = apiInstance.getTaskNoteById(id, noteId, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TasksApi#getTaskNoteById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> TaskNoteList getTaskNotes(id, limit, offset, updatedBy, updatedFrom, updatedTo, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String updatedFrom = "updatedFrom_example"; // String | Нижняя граница даты обновления в формате YYYY-MM-DD HH:MM:SS[.mmm]
        String updatedTo = "updatedTo_example"; // String | Верхняя граница даты обновления в формате YYYY-MM-DD HH:MM:SS[.mmm]
        String accept = "application/json"; // String | 
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            TaskNoteList result = apiInstance.getTaskNotes(id, limit, offset, updatedBy, updatedFrom, updatedTo, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TasksApi#getTaskNotes");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| **updatedFrom** | **String**| Нижняя граница даты обновления в формате YYYY-MM-DD HH:MM:SS[.mmm] | [optional] |
| **updatedTo** | **String**| Верхняя граница даты обновления в формате YYYY-MM-DD HH:MM:SS[.mmm] | [optional] |
| **accept** | **String**|  | [optional] [default to application/json;charset&#x3D;utf-8] [enum: application/json, application/json;charset=utf-8] |
| **acceptEncoding** | **String**|  | [optional] [default to gzip, deflate, br] |
...
> TaskList getTasks(limit, offset, filter, expand, order, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            TaskList result = apiInstance.getTasks(limit, offset, filter, expand, order, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
...
> Task updateTask(id, task, expand, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            Task result = apiInstance.updateTask(id, task, expand, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
...
## updateTaskMetadataStateById

> State updateTaskMetadataStateById(id, state, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            State result = apiInstance.updateTaskMetadataStateById(id, state, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TasksApi#updateTaskMetadataStateById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> TaskNote updateTaskNote(id, noteId, taskNote, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            TaskNote result = apiInstance.updateTaskNote(id, noteId, taskNote, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TasksApi#updateTaskNote");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
