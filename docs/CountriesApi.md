...
import ru.moysklad.remap_1_2.api.CountriesApi;
...
> Country createCountry(country, expand, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            Country result = apiInstance.createCountry(country, expand, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CountriesApi#createCountry");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> deleteCountry(id, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            apiInstance.deleteCountry(id, accept, acceptEncoding);
        } catch (ApiException e) {
            System.err.println("Exception when calling CountriesApi#deleteCountry");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> CountryList getCountries(limit, offset, search, filter, expand, order, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            CountryList result = apiInstance.getCountries(limit, offset, search, filter, expand, order, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
...
> Country getCountryById(id, expand, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            Country result = apiInstance.getCountryById(id, expand, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
...
> Country updateCountry(id, country, expand, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            Country result = apiInstance.updateCountry(id, country, expand, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CountriesApi#updateCountry");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
