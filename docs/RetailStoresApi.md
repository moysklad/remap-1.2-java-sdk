...
> RetailStore addMasterRetailStore(retailStoreId, retailStore, accept, acceptEncoding, expand, contentType)
...
import org.openapitools.client.api.RetailStoresApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            RetailStore result = apiInstance.addMasterRetailStore(retailStoreId, retailStore, accept, acceptEncoding, expand, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailStoresApi#addMasterRetailStore");
...
> List&lt;CreateRetailStoresBatch200ResponseInner&gt; createRetailStoresBatch(retailStore, accept, acceptEncoding, expand, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            List<CreateRetailStoresBatch200ResponseInner> result = apiInstance.createRetailStoresBatch(retailStore, accept, acceptEncoding, expand, contentType);
            System.out.println(result);
        } catch (ApiException e) {
...
[**List&lt;CreateRetailStoresBatch200ResponseInner&gt;**](CreateRetailStoresBatch200ResponseInner.md)
...
> deleteRetailStore(id, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            apiInstance.deleteRetailStore(id, accept, acceptEncoding);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailStoresApi#deleteRetailStore");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> List&lt;DeleteContractsBatch200ResponseInner&gt; deleteRetailStoresBatch(retailStore, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            List<DeleteContractsBatch200ResponseInner> result = apiInstance.deleteRetailStoresBatch(retailStore, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailStoresApi#deleteRetailStoresBatch");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> RetailStoreList getMasterRetailStores(retailStoreId, limit, offset, search, filter, expand, order, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            RetailStoreList result = apiInstance.getMasterRetailStores(retailStoreId, limit, offset, search, filter, expand, order, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailStoresApi#getMasterRetailStores");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> RetailStore getRetailStoreById(id, expand, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            RetailStore result = apiInstance.getRetailStoreById(id, expand, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailStoresApi#getRetailStoreById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> RetailStoreList getRetailStores(limit, offset, search, filter, expand, order, accept, acceptEncoding)
...
public class Example {
    public static void main(String[] args) {
        ...
        String acceptEncoding = "gzip, deflate, br"; // String | 
        try {
            RetailStoreList result = apiInstance.getRetailStores(limit, offset, search, filter, expand, order, accept, acceptEncoding);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling RetailStoresApi#getRetailStores");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
