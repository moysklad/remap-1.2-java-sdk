...
import ru.moysklad.remap_1_2.api.RetailStoresApi;
...
> List&lt;DeleteRowResult&gt; deleteRetailStoresBatch(retailStore, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            List<DeleteRowResult> result = apiInstance.deleteRetailStoresBatch(retailStore, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
