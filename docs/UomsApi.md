...
import ru.moysklad.remap_1_2.api.UomsApi;
...
> List&lt;BatchResponseEntity&gt; createUomsBatch(uom, expand, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        UomsApi apiInstance = new UomsApi(defaultClient);
        List<@Valid Uom> uom = Arrays.asList(); // List<@Valid Uom> | 
        String expand = "expand_example"; // String | Замена ссылок объектами с помощью expand
        String accept = "application/json"; // String | 
        String acceptEncoding = "gzip, deflate, br"; // String | 
        String contentType = "application/json"; // String | 
        try {
            List<BatchResponseEntity> result = apiInstance.createUomsBatch(uom, expand, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
...
> List&lt;DeleteRowResult&gt; deleteUomsBatch(uom, accept, acceptEncoding, contentType)
...
public class Example {
    public static void main(String[] args) {
        ...
        String contentType = "application/json"; // String | 
        try {
            List<DeleteRowResult> result = apiInstance.deleteUomsBatch(uom, accept, acceptEncoding, contentType);
            System.out.println(result);
        } catch (ApiException e) {
