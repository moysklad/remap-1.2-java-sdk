 ...
 */
@JsonPropertyOrder({
  CreateCommissionReportInReturnedPositionsRequest.JSON_PROPERTY_META,
  CreateCommissionReportInReturnedPositionsRequest.JSON_PROPERTY_ID,
  CreateCommissionReportInReturnedPositionsRequest.JSON_PROPERTY_ACCOUNT_ID,
  CreateCommissionReportInReturnedPositionsRequest.JSON_PROPERTY_QUANTITY,
  CreateCommissionReportInReturnedPositionsRequest.JSON_PROPERTY_PRICE,
  CreateCommissionReportInReturnedPositionsRequest.JSON_PROPERTY_REWARD,
  CreateCommissionReportInReturnedPositionsRequest.JSON_PROPERTY_VAT,
  CreateCommissionReportInReturnedPositionsRequest.JSON_PROPERTY_VAT_ENABLED,
...
public class CreateCommissionReportInReturnedPositionsRequest {
  ...
  public CreateCommissionReportInReturnedPositionsRequest() {
  }
  /**
  ...
  public CreateCommissionReportInReturnedPositionsRequest meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreateCommissionReportInReturnedPositionsRequest quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public CreateCommissionReportInReturnedPositionsRequest price(@javax.annotation.Nullable Double price) {
  ...
  public CreateCommissionReportInReturnedPositionsRequest reward(@javax.annotation.Nullable Double reward) {
  ...
  public CreateCommissionReportInReturnedPositionsRequest vat(@javax.annotation.Nullable Integer vat) {
  ...
  public CreateCommissionReportInReturnedPositionsRequest vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public CreateCommissionReportInReturnedPositionsRequest assortment(@javax.annotation.Nullable Assortment assortment) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCommissionReportInReturnedPositionsRequest createCommissionReportInReturnedPositionsRequest = (CreateCommissionReportInReturnedPositionsRequest) o;
    return Objects.equals(this.meta, createCommissionReportInReturnedPositionsRequest.meta) &&
        Objects.equals(this.id, createCommissionReportInReturnedPositionsRequest.id) &&
        Objects.equals(this.accountId, createCommissionReportInReturnedPositionsRequest.accountId) &&
        Objects.equals(this.quantity, createCommissionReportInReturnedPositionsRequest.quantity) &&
        Objects.equals(this.price, createCommissionReportInReturnedPositionsRequest.price) &&
        Objects.equals(this.reward, createCommissionReportInReturnedPositionsRequest.reward) &&
        Objects.equals(this.vat, createCommissionReportInReturnedPositionsRequest.vat) &&
        Objects.equals(this.vatEnabled, createCommissionReportInReturnedPositionsRequest.vatEnabled) &&
        Objects.equals(this.assortment, createCommissionReportInReturnedPositionsRequest.assortment);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCommissionReportInReturnedPositionsRequest {\n");
