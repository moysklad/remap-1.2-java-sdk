 ...
 */
@JsonPropertyOrder({
  CreateCommissionReportInReturnedPositions200ResponseInner.JSON_PROPERTY_META,
  CreateCommissionReportInReturnedPositions200ResponseInner.JSON_PROPERTY_ID,
  CreateCommissionReportInReturnedPositions200ResponseInner.JSON_PROPERTY_ACCOUNT_ID,
  CreateCommissionReportInReturnedPositions200ResponseInner.JSON_PROPERTY_QUANTITY,
  CreateCommissionReportInReturnedPositions200ResponseInner.JSON_PROPERTY_PRICE,
  CreateCommissionReportInReturnedPositions200ResponseInner.JSON_PROPERTY_REWARD,
  CreateCommissionReportInReturnedPositions200ResponseInner.JSON_PROPERTY_VAT,
  CreateCommissionReportInReturnedPositions200ResponseInner.JSON_PROPERTY_VAT_ENABLED,
  CreateCommissionReportInReturnedPositions200ResponseInner.JSON_PROPERTY_ASSORTMENT,
...
public class CreateCommissionReportInReturnedPositions200ResponseInner {
  ...
  public CreateCommissionReportInReturnedPositions200ResponseInner meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreateCommissionReportInReturnedPositions200ResponseInner quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public CreateCommissionReportInReturnedPositions200ResponseInner price(@javax.annotation.Nullable Double price) {
  ...
  public CreateCommissionReportInReturnedPositions200ResponseInner reward(@javax.annotation.Nullable Double reward) {
  ...
  public CreateCommissionReportInReturnedPositions200ResponseInner vat(@javax.annotation.Nullable Integer vat) {
  ...
  public CreateCommissionReportInReturnedPositions200ResponseInner vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public CreateCommissionReportInReturnedPositions200ResponseInner addErrorsItem(ErrorErrorsInner errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCommissionReportInReturnedPositions200ResponseInner createCommissionReportInReturnedPositions200ResponseInner = (CreateCommissionReportInReturnedPositions200ResponseInner) o;
    return Objects.equals(this.meta, createCommissionReportInReturnedPositions200ResponseInner.meta) &&
        Objects.equals(this.id, createCommissionReportInReturnedPositions200ResponseInner.id) &&
        Objects.equals(this.accountId, createCommissionReportInReturnedPositions200ResponseInner.accountId) &&
        Objects.equals(this.quantity, createCommissionReportInReturnedPositions200ResponseInner.quantity) &&
        Objects.equals(this.price, createCommissionReportInReturnedPositions200ResponseInner.price) &&
        Objects.equals(this.reward, createCommissionReportInReturnedPositions200ResponseInner.reward) &&
        Objects.equals(this.vat, createCommissionReportInReturnedPositions200ResponseInner.vat) &&
        Objects.equals(this.vatEnabled, createCommissionReportInReturnedPositions200ResponseInner.vatEnabled) &&
        Objects.equals(this.assortment, createCommissionReportInReturnedPositions200ResponseInner.assortment) &&
        Objects.equals(this.errors, createCommissionReportInReturnedPositions200ResponseInner.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, quantity, price, reward, vat, vatEnabled, assortment, errors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateCommissionReportInReturnedPositions200ResponseInner {\n");
