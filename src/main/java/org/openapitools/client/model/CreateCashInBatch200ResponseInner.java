...
public class CreateCashInBatch200ResponseInner {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, createCashInBatch200ResponseInner.meta) &&
        ...
        equalsNullable(this.attributes, createCashInBatch200ResponseInner.attributes) &&
        ...
        equalsNullable(this.operations, createCashInBatch200ResponseInner.operations) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, applicable, name, code, externalCode, syncId, hashCodeNullable(description), created, deleted, updated, moment, hashCodeNullable(attributes), hashCodeNullable(contract), hashCodeNullable(files), paymentPurpose, printed, hashCodeNullable(project), published, hashCodeNullable(owner), group, hashCodeNullable(salesChannel), shared, hashCodeNullable(state), rate, organization, agent, sum, vatSum, hashCodeNullable(factureOut), hashCodeNullable(operations), errors);
  }
