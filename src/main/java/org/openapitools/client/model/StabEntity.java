...
/**
 * Объект-заглушка для неописанных сущностей
 */
@JsonPropertyOrder({
  StabEntity.JSON_PROPERTY_META,
  StabEntity.JSON_PROPERTY_ID,
  StabEntity.JSON_PROPERTY_ACCOUNT_ID
})
...
public class StabEntity {
  ...
  public StabEntity meta(@javax.annotation.Nullable Meta meta) {
  ...
  public boolean equals(Object o) {
    ...
    StabEntity stabEntity = (StabEntity) o;
    return Objects.equals(this.meta, stabEntity.meta) &&
        Objects.equals(this.id, stabEntity.id) &&
        Objects.equals(this.accountId, stabEntity.accountId);
  }
