 ...
 */
@JsonPropertyOrder({
  AttributeMetaInfoList.JSON_PROPERTY_META,
  AttributeMetaInfoList.JSON_PROPERTY_ROWS
})
...
public class AttributeMetaInfoList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<AttributeMetaInfo>> rows = JsonNullable.<List<AttributeMetaInfo>>undefined();

  public AttributeMetaInfoList() {
  }

  public AttributeMetaInfoList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public AttributeMetaInfoList rows(@javax.annotation.Nullable List<AttributeMetaInfo> rows) {
    this.rows = JsonNullable.<List<AttributeMetaInfo>>of(rows);
    
    return this;
  }

  public AttributeMetaInfoList addRowsItem(AttributeMetaInfo rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<AttributeMetaInfo>>of(new ArrayList<>());
    }
    try {
  ...
  public List<AttributeMetaInfo> getRows() {
  ...
  public JsonNullable<List<AttributeMetaInfo>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<AttributeMetaInfo>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<AttributeMetaInfo> rows) {
    this.rows = JsonNullable.<List<AttributeMetaInfo>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    AttributeMetaInfoList attributeMetaInfoList = (AttributeMetaInfoList) o;
    return Objects.equals(this.meta, attributeMetaInfoList.meta) &&
        equalsNullable(this.rows, attributeMetaInfoList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributeMetaInfoList {\n");
