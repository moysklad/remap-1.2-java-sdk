 ...
 */
@JsonPropertyOrder({
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_META,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_ID,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_ACCOUNT_ID,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_OWNER,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_SHARED,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_GROUP,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_UPDATED,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_NAME,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_DESCRIPTION,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_CODE,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_EXTERNAL_CODE,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_ARCHIVED,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_ADDRESS,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_ADDRESS_FULL,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_PATH_NAME,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_PARENT,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_ATTRIBUTES,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_ZONES,
  CreateStoresBatch200ResponseInner.JSON_PROPERTY_SLOTS,
...
public class CreateStoresBatch200ResponseInner {
  ...
  public CreateStoresBatch200ResponseInner() {
  }
  /**
  ...
  public CreateStoresBatch200ResponseInner meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreateStoresBatch200ResponseInner owner(@javax.annotation.Nullable Employee owner) {
  ...
  public CreateStoresBatch200ResponseInner name(@javax.annotation.Nullable String name) {
  ...
  public CreateStoresBatch200ResponseInner parent(@javax.annotation.Nullable Store parent) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStoresBatch200ResponseInner createStoresBatch200ResponseInner = (CreateStoresBatch200ResponseInner) o;
    return Objects.equals(this.meta, createStoresBatch200ResponseInner.meta) &&
        Objects.equals(this.id, createStoresBatch200ResponseInner.id) &&
        Objects.equals(this.accountId, createStoresBatch200ResponseInner.accountId) &&
        equalsNullable(this.owner, createStoresBatch200ResponseInner.owner) &&
        Objects.equals(this.shared, createStoresBatch200ResponseInner.shared) &&
        Objects.equals(this.group, createStoresBatch200ResponseInner.group) &&
        Objects.equals(this.updated, createStoresBatch200ResponseInner.updated) &&
        Objects.equals(this.name, createStoresBatch200ResponseInner.name) &&
        equalsNullable(this.description, createStoresBatch200ResponseInner.description) &&
        Objects.equals(this.code, createStoresBatch200ResponseInner.code) &&
        Objects.equals(this.externalCode, createStoresBatch200ResponseInner.externalCode) &&
        Objects.equals(this.archived, createStoresBatch200ResponseInner.archived) &&
        Objects.equals(this.address, createStoresBatch200ResponseInner.address) &&
        equalsNullable(this.addressFull, createStoresBatch200ResponseInner.addressFull) &&
        Objects.equals(this.pathName, createStoresBatch200ResponseInner.pathName) &&
        equalsNullable(this.parent, createStoresBatch200ResponseInner.parent) &&
        equalsNullable(this.attributes, createStoresBatch200ResponseInner.attributes) &&
        equalsNullable(this.zones, createStoresBatch200ResponseInner.zones) &&
        equalsNullable(this.slots, createStoresBatch200ResponseInner.slots) &&
        Objects.equals(this.errors, createStoresBatch200ResponseInner.errors);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, hashCodeNullable(owner), shared, group, updated, name, hashCodeNullable(description), code, externalCode, archived, address, hashCodeNullable(addressFull), pathName, hashCodeNullable(parent), hashCodeNullable(attributes), hashCodeNullable(zones), hashCodeNullable(slots), errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStoresBatch200ResponseInner {\n");
