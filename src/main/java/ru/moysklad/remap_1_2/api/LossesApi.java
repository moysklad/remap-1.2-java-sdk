...
if (contentType != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<BatchResponseEntity> createLossBatch(@javax.annotation.Nonnull List<Loss> loss) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
   ...
   * @throws ApiException if fails to make API call
   */
  public List<BatchResponseEntity> createLossBatch(@javax.annotation.Nonnull List<Loss> loss, RequestOptions options) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.emptyIfNull(options);
    return this.createLossBatch(loss, (String) effectiveOptions.get("expand"), null, null, null, effectiveOptions.getAdditionalHeaders());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  protected List<BatchResponseEntity> createLossBatch(@javax.annotation.Nonnull List<Loss> loss, @javax.annotation.Nullable String expand, @javax.annotation.Nullable String accept, @javax.annotation.Nullable String acceptEncoding, @javax.annotation.Nullable String contentType, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = loss;
...
if (contentType != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public State createLossMetadataState(@javax.annotation.Nonnull State state) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
    return this.createLossMetadataState(state, null, null, null, effectiveOptions.getAdditionalHeaders());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public State createLossMetadataState(@javax.annotation.Nonnull State state, RequestOptions options) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.emptyIfNull(options);
    return this.createLossMetadataState(state, null, null, null, effectiveOptions.getAdditionalHeaders());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  protected State createLossMetadataState(@javax.annotation.Nonnull State state, @javax.annotation.Nullable String accept, @javax.annotation.Nullable String acceptEncoding, @javax.annotation.Nullable String contentType, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = state;
    
    // verify the required parameter 'state' is set
    if (state == null) {
      throw new ApiException(400, "Missing the required parameter 'state' when calling createLossMetadataState");
    }
    
    // create path and map variables
    String localVarPath = "/entity/loss/metadata/states";
...
if (contentType != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<StateRowResult> createLossMetadataStatesBatch(@javax.annotation.Nonnull List<State> state) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
    return this.createLossMetadataStatesBatch(state, null, null, null, effectiveOptions.getAdditionalHeaders());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public List<StateRowResult> createLossMetadataStatesBatch(@javax.annotation.Nonnull List<State> state, RequestOptions options) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.emptyIfNull(options);
    return this.createLossMetadataStatesBatch(state, null, null, null, effectiveOptions.getAdditionalHeaders());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  protected List<StateRowResult> createLossMetadataStatesBatch(@javax.annotation.Nonnull List<State> state, @javax.annotation.Nullable String accept, @javax.annotation.Nullable String acceptEncoding, @javax.annotation.Nullable String contentType, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = state;
    
    // verify the required parameter 'state' is set
    if (state == null) {
      throw new ApiException(400, "Missing the required parameter 'state' when calling createLossMetadataStatesBatch");
    }
    
    // create path and map variables
    String localVarPath = "/entity/loss/metadata/states/batch";
...
if (contentType != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<CreateLossPositions200ResponseInner> createLossPositions(@javax.annotation.Nonnull UUID id, @javax.annotation.Nonnull List<LossPosition> lossPosition) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
...
if (acceptEncoding != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<DeleteRowResult> deleteLossBatch(@javax.annotation.Nonnull List<Loss> loss) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
   ...
   * @throws ApiException if fails to make API call
   */
  public List<DeleteRowResult> deleteLossBatch(@javax.annotation.Nonnull List<Loss> loss, RequestOptions options) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.emptyIfNull(options);
    return this.deleteLossBatch(loss, null, null, null, effectiveOptions.getAdditionalHeaders());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  protected List<DeleteRowResult> deleteLossBatch(@javax.annotation.Nonnull List<Loss> loss, @javax.annotation.Nullable String accept, @javax.annotation.Nullable String acceptEncoding, @javax.annotation.Nullable String contentType, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = loss;
...
if (acceptEncoding != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<DeleteRowResult> deleteLossPositionsBatch(@javax.annotation.Nonnull UUID id, @javax.annotation.Nonnull List<LossPosition> lossPosition) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
   ...
   * @throws ApiException if fails to make API call
   */
  public List<DeleteRowResult> deleteLossPositionsBatch(@javax.annotation.Nonnull UUID id, @javax.annotation.Nonnull List<LossPosition> lossPosition, RequestOptions options) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.emptyIfNull(options);
    return this.deleteLossPositionsBatch(id, lossPosition, null, null, null, effectiveOptions.getAdditionalHeaders());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  protected List<DeleteRowResult> deleteLossPositionsBatch(@javax.annotation.Nonnull UUID id, @javax.annotation.Nonnull List<LossPosition> lossPosition, @javax.annotation.Nullable String accept, @javax.annotation.Nullable String acceptEncoding, @javax.annotation.Nullable String contentType, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = lossPosition;
