...
public class CurrenciesApi extends BaseApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<BatchResponseEntity> createCurrenciesBatch(@javax.annotation.Nonnull List<@Valid Currency> currency, RequestOptions options) throws ApiException {
