...
public class RetailDrawerCashInsApi extends BaseApi {
   ...
   */
  public List<ModelFile> addRetailDrawerCashInFiles(@javax.annotation.Nonnull UUID id, @javax.annotation.Nonnull List<FileUpload> fileUpload) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<ModelFile> addRetailDrawerCashInFiles(@javax.annotation.Nonnull UUID id, @javax.annotation.Nonnull List<FileUpload> fileUpload, RequestOptions options) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  protected List<ModelFile> addRetailDrawerCashInFiles(@javax.annotation.Nonnull UUID id, @javax.annotation.Nonnull List<FileUpload> fileUpload, @javax.annotation.Nullable String accept, @javax.annotation.Nullable String acceptEncoding, @javax.annotation.Nullable String contentType, Map<String, String> additionalHeaders) throws ApiException {
...
if (contentType != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<BatchResponseEntity> createRetailDrawerCashInBatch(@javax.annotation.Nonnull List<RetailDrawerCashIn> retailDrawerCashIn) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
   ...
   * @throws ApiException if fails to make API call
   */
  public List<BatchResponseEntity> createRetailDrawerCashInBatch(@javax.annotation.Nonnull List<RetailDrawerCashIn> retailDrawerCashIn, RequestOptions options) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.emptyIfNull(options);
    return this.createRetailDrawerCashInBatch(retailDrawerCashIn, (String) effectiveOptions.get("expand"), null, null, null, effectiveOptions.getAdditionalHeaders());
  }
...
if (contentType != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<StateRowResult> createRetailDrawerCashInMetadataStatesBatch(@javax.annotation.Nonnull List<State> state) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
   ...
   * @throws ApiException if fails to make API call
   */
  public List<StateRowResult> createRetailDrawerCashInMetadataStatesBatch(@javax.annotation.Nonnull List<State> state, RequestOptions options) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.emptyIfNull(options);
    return this.createRetailDrawerCashInMetadataStatesBatch(state, null, null, null, effectiveOptions.getAdditionalHeaders());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  protected List<StateRowResult> createRetailDrawerCashInMetadataStatesBatch(@javax.annotation.Nonnull List<State> state, @javax.annotation.Nullable String accept, @javax.annotation.Nullable String acceptEncoding, @javax.annotation.Nullable String contentType, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = state;
    
    // verify the required parameter 'state' is set
    if (state == null) {
      throw new ApiException(400, "Missing the required parameter 'state' when calling createRetailDrawerCashInMetadataStatesBatch");
    }
    
    // create path and map variables
    String localVarPath = "/entity/retaildrawercashin/metadata/states/batch";
...
if (acceptEncoding != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<DeleteRowResult> deleteRetailDrawerCashInBatch(@javax.annotation.Nonnull List<RetailDrawerCashIn> retailDrawerCashIn) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
   ...
   * @throws ApiException if fails to make API call
   */
  public List<DeleteRowResult> deleteRetailDrawerCashInBatch(@javax.annotation.Nonnull List<RetailDrawerCashIn> retailDrawerCashIn, RequestOptions options) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.emptyIfNull(options);
    return this.deleteRetailDrawerCashInBatch(retailDrawerCashIn, null, null, null, effectiveOptions.getAdditionalHeaders());
  }
