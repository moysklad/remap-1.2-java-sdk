...
import ru.moysklad.remap_1_2.model.BonusProgramList;
...
if (acceptEncoding != null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<DeleteRowResult> deleteBonusProgramsBatch(@javax.annotation.Nonnull List<BonusProgram> bonusProgram) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.empty();
   ...
   * @throws ApiException if fails to make API call
   */
  public List<DeleteRowResult> deleteBonusProgramsBatch(@javax.annotation.Nonnull List<BonusProgram> bonusProgram, RequestOptions options) throws ApiException {
    RequestOptions effectiveOptions = RequestOptions.emptyIfNull(options);
    return this.deleteBonusProgramsBatch(bonusProgram, null, null, null, effectiveOptions.getAdditionalHeaders());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  protected List<DeleteRowResult> deleteBonusProgramsBatch(@javax.annotation.Nonnull List<BonusProgram> bonusProgram, @javax.annotation.Nullable String accept, @javax.annotation.Nullable String acceptEncoding, @javax.annotation.Nullable String contentType, Map<String, String> additionalHeaders) throws ApiException {
    Object localVarPostBody = bonusProgram;
