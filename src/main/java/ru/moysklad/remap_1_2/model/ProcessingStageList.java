 ...
 */
@JsonPropertyOrder({
  ProcessingStageList.JSON_PROPERTY_CONTEXT,
  ProcessingStageList.JSON_PROPERTY_META,
  ProcessingStageList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProcessingStageList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<ProcessingStage> rows = new ArrayList<>();

  public ProcessingStageList() {
  }

  public ProcessingStageList context(@javax.annotation.Nullable Context context) {
  ...
  public ProcessingStageList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ProcessingStageList rows(@javax.annotation.Nullable List<ProcessingStage> rows) {
  ...
  public ProcessingStageList addRowsItem(ProcessingStage rowsItem) {
    if (this.rows == null) {
  ...
  public List<ProcessingStage> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<ProcessingStage> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessingStageList processingStageList = (ProcessingStageList) o;
    return Objects.equals(this.context, processingStageList.context) &&
        Objects.equals(this.meta, processingStageList.meta) &&
        Objects.equals(this.rows, processingStageList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingStageList {\n");
