 ...
 */
@JsonPropertyOrder({
  EnterList.JSON_PROPERTY_CONTEXT,
  EnterList.JSON_PROPERTY_META,
  EnterList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class EnterList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Enter> rows = new ArrayList<>();

  public EnterList() {
  }

  public EnterList context(@javax.annotation.Nullable Context context) {
  ...
  public EnterList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public EnterList rows(@javax.annotation.Nullable List<Enter> rows) {
  ...
  public EnterList addRowsItem(Enter rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Enter> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    EnterList enterList = (EnterList) o;
    return Objects.equals(this.context, enterList.context) &&
        Objects.equals(this.meta, enterList.meta) &&
        Objects.equals(this.rows, enterList.rows);
  }
