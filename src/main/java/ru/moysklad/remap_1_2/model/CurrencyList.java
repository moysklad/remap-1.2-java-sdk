 ...
 */
@JsonPropertyOrder({
  CurrencyList.JSON_PROPERTY_CONTEXT,
  CurrencyList.JSON_PROPERTY_META,
  CurrencyList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CurrencyList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Currency> rows = new ArrayList<>();

  public CurrencyList() {
  }

  public CurrencyList context(@javax.annotation.Nullable Context context) {
  ...
  public CurrencyList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CurrencyList rows(@javax.annotation.Nullable List<Currency> rows) {
  ...
  public CurrencyList addRowsItem(Currency rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Currency> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, currencyList.context) &&
        Objects.equals(this.meta, currencyList.meta) &&
        Objects.equals(this.rows, currencyList.rows);
  }
