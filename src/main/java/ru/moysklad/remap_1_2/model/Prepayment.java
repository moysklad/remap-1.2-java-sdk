 ...
 */
@JsonPropertyOrder({
  Prepayment.JSON_PROPERTY_META,
  Prepayment.JSON_PROPERTY_ID,
  Prepayment.JSON_PROPERTY_ACCOUNT_ID,
  Prepayment.JSON_PROPERTY_NAME,
  Prepayment.JSON_PROPERTY_CODE,
  Prepayment.JSON_PROPERTY_EXTERNAL_CODE,
  Prepayment.JSON_PROPERTY_SYNC_ID,
  Prepayment.JSON_PROPERTY_DESCRIPTION,
  Prepayment.JSON_PROPERTY_CREATED,
  Prepayment.JSON_PROPERTY_DELETED,
  Prepayment.JSON_PROPERTY_UPDATED,
  Prepayment.JSON_PROPERTY_MOMENT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class Prepayment implements MetaEntity {
  public static Prepayment createWithMeta(UUID id) {
    Prepayment o = new Prepayment();
    Meta meta = new Meta();
    meta.setType("prepayment");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "prepayment" + "/" + id;
    try {
  ...
  public Prepayment meta(@javax.annotation.Nullable Meta meta) {
  ...
  public Prepayment name(@javax.annotation.Nullable String name) {
  ...
  public Prepayment moment(@javax.annotation.Nullable String moment) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, prepayment.meta) &&
        Objects.equals(this.id, prepayment.id) &&
        Objects.equals(this.accountId, prepayment.accountId) &&
        Objects.equals(this.name, prepayment.name) &&
        Objects.equals(this.code, prepayment.code) &&
        Objects.equals(this.externalCode, prepayment.externalCode) &&
        Objects.equals(this.syncId, prepayment.syncId) &&
        equalsNullable(this.description, prepayment.description) &&
        Objects.equals(this.created, prepayment.created) &&
        Objects.equals(this.deleted, prepayment.deleted) &&
        Objects.equals(this.updated, prepayment.updated) &&
        Objects.equals(this.moment, prepayment.moment);
  }
