 ...
 */
@JsonPropertyOrder({
  CustomerOrderPosition.JSON_PROPERTY_META,
  CustomerOrderPosition.JSON_PROPERTY_ID,
  CustomerOrderPosition.JSON_PROPERTY_ACCOUNT_ID,
  CustomerOrderPosition.JSON_PROPERTY_QUANTITY,
  CustomerOrderPosition.JSON_PROPERTY_PRICE,
  CustomerOrderPosition.JSON_PROPERTY_DISCOUNT,
  CustomerOrderPosition.JSON_PROPERTY_RESERVE,
  CustomerOrderPosition.JSON_PROPERTY_SHIPPED,
  CustomerOrderPosition.JSON_PROPERTY_VAT,
  CustomerOrderPosition.JSON_PROPERTY_VAT_ENABLED,
  CustomerOrderPosition.JSON_PROPERTY_TAX_SYSTEM,
  CustomerOrderPosition.JSON_PROPERTY_ASSORTMENT,
  CustomerOrderPosition.JSON_PROPERTY_PACK,
  CustomerOrderPosition.JSON_PROPERTY_STOCK
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CustomerOrderPosition extends EntityWithMeta implements DocumentPosition, MetaEntity {
  public static CustomerOrderPosition createWithMeta(UUID parentId, UUID id) {
    ...
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "customerorder" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public CustomerOrderPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CustomerOrderPosition id(@javax.annotation.Nullable UUID id) {
  ...
  public CustomerOrderPosition quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public CustomerOrderPosition vat(@javax.annotation.Nullable Integer vat) {
  ...
  public CustomerOrderPosition assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public boolean equals(Object o) {
    ...
    CustomerOrderPosition customerOrderPosition = (CustomerOrderPosition) o;
    return Objects.equals(this.meta, customerOrderPosition.meta) &&
        Objects.equals(this.id, customerOrderPosition.id) &&
        Objects.equals(this.accountId, customerOrderPosition.accountId) &&
        Objects.equals(this.quantity, customerOrderPosition.quantity) &&
        Objects.equals(this.price, customerOrderPosition.price) &&
        Objects.equals(this.discount, customerOrderPosition.discount) &&
        Objects.equals(this.reserve, customerOrderPosition.reserve) &&
        Objects.equals(this.shipped, customerOrderPosition.shipped) &&
        Objects.equals(this.vat, customerOrderPosition.vat) &&
        Objects.equals(this.vatEnabled, customerOrderPosition.vatEnabled) &&
        Objects.equals(this.taxSystem, customerOrderPosition.taxSystem) &&
        Objects.equals(this.assortment, customerOrderPosition.assortment) &&
        equalsNullable(this.pack, customerOrderPosition.pack) &&
        equalsNullable(this.stock, customerOrderPosition.stock);
  }
