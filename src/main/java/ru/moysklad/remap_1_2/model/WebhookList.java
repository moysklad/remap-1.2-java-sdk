 ...
 */
@JsonPropertyOrder({
  WebhookList.JSON_PROPERTY_CONTEXT,
  WebhookList.JSON_PROPERTY_META,
  WebhookList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class WebhookList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Webhook> rows = new ArrayList<>();

  public WebhookList() {
  }

  public WebhookList context(@javax.annotation.Nullable Context context) {
  ...
  public WebhookList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public WebhookList rows(@javax.annotation.Nullable List<Webhook> rows) {
  ...
  public WebhookList addRowsItem(Webhook rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Webhook> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, webhookList.context) &&
        Objects.equals(this.meta, webhookList.meta) &&
        Objects.equals(this.rows, webhookList.rows);
  }
