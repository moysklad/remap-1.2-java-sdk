 ...
 */
@JsonPropertyOrder({
  FactureInList.JSON_PROPERTY_CONTEXT,
  FactureInList.JSON_PROPERTY_META,
  FactureInList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class FactureInList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<FactureIn> rows = new ArrayList<>();

  public FactureInList() {
  }

  public FactureInList context(@javax.annotation.Nullable Context context) {
  ...
  public FactureInList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public FactureInList rows(@javax.annotation.Nullable List<FactureIn> rows) {
  ...
  public FactureInList addRowsItem(FactureIn rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<FactureIn> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    FactureInList factureInList = (FactureInList) o;
    return Objects.equals(this.context, factureInList.context) &&
        Objects.equals(this.meta, factureInList.meta) &&
        Objects.equals(this.rows, factureInList.rows);
  }
