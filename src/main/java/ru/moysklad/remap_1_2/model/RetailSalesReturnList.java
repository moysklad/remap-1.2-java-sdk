 ...
 */
@JsonPropertyOrder({
  RetailSalesReturnList.JSON_PROPERTY_CONTEXT,
  RetailSalesReturnList.JSON_PROPERTY_META,
  RetailSalesReturnList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class RetailSalesReturnList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<RetailSalesReturn> rows = new ArrayList<>();

  public RetailSalesReturnList() {
  }

  public RetailSalesReturnList context(@javax.annotation.Nullable Context context) {
  ...
  public RetailSalesReturnList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public RetailSalesReturnList rows(@javax.annotation.Nullable List<RetailSalesReturn> rows) {
  ...
  public RetailSalesReturnList addRowsItem(RetailSalesReturn rowsItem) {
    if (this.rows == null) {
  ...
  public List<RetailSalesReturn> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<RetailSalesReturn> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    RetailSalesReturnList retailSalesReturnList = (RetailSalesReturnList) o;
    return Objects.equals(this.context, retailSalesReturnList.context) &&
        Objects.equals(this.meta, retailSalesReturnList.meta) &&
        Objects.equals(this.rows, retailSalesReturnList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailSalesReturnList {\n");
