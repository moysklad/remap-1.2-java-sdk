 ...
 */
@JsonPropertyOrder({
  NotificationSubscribeExpired.JSON_PROPERTY_META,
  NotificationSubscribeExpired.JSON_PROPERTY_ID,
  NotificationSubscribeExpired.JSON_PROPERTY_ACCOUNT_ID,
  NotificationSubscribeExpired.JSON_PROPERTY_CREATED,
  NotificationSubscribeExpired.JSON_PROPERTY_READ,
  NotificationSubscribeExpired.JSON_PROPERTY_TITLE,
  NotificationSubscribeExpired.JSON_PROPERTY_DESCRIPTION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationSubscribeExpired extends NotificationAbstract {
  ...
  public NotificationSubscribeExpired() {
  }
  /**
  ...
  public NotificationSubscribeExpired meta(@javax.annotation.Nullable Meta meta) {
  ...
  public NotificationSubscribeExpired read(@javax.annotation.Nullable Boolean read) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationSubscribeExpired notificationSubscribeExpired = (NotificationSubscribeExpired) o;
    return Objects.equals(this.meta, notificationSubscribeExpired.meta) &&
        Objects.equals(this.id, notificationSubscribeExpired.id) &&
        Objects.equals(this.accountId, notificationSubscribeExpired.accountId) &&
        Objects.equals(this.created, notificationSubscribeExpired.created) &&
        Objects.equals(this.read, notificationSubscribeExpired.read) &&
        Objects.equals(this.title, notificationSubscribeExpired.title) &&
        Objects.equals(this.description, notificationSubscribeExpired.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationSubscribeExpired {\n");
