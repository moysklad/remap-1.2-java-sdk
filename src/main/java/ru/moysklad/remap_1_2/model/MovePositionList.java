 ...
 */
@JsonPropertyOrder({
  MovePositionList.JSON_PROPERTY_CONTEXT,
  MovePositionList.JSON_PROPERTY_META,
  MovePositionList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class MovePositionList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<MovePosition>> rows = JsonNullable.<List<MovePosition>>undefined();

  public MovePositionList() {
  }

  public MovePositionList context(@javax.annotation.Nullable Context context) {
  ...
  public MovePositionList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public MovePositionList rows(@javax.annotation.Nullable List<MovePosition> rows) {
    this.rows = JsonNullable.<List<MovePosition>>of(rows);
    
    return this;
  }


  public MovePositionList addRowsItem(MovePosition rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<MovePosition>>of(new ArrayList<>());
    }
    try {
  ...
  public List<MovePosition> getRows() {
  ...
  public JsonNullable<List<MovePosition>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<MovePosition>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<MovePosition> rows) {
    this.rows = JsonNullable.<List<MovePosition>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    MovePositionList movePositionList = (MovePositionList) o;
    return Objects.equals(this.context, movePositionList.context) &&
        Objects.equals(this.meta, movePositionList.meta) &&
        equalsNullable(this.rows, movePositionList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class MovePositionList {\n");
