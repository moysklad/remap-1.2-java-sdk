 ...
 */
@JsonPropertyOrder({
  CounterpartyAccounts.JSON_PROPERTY_META,
  CounterpartyAccounts.JSON_PROPERTY_ROWS
})
@JsonTypeName("Counterparty_accounts")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-05-22T13:41:10.768379078Z[GMT]", comments = "Generator version: 7.14.0")
public class CounterpartyAccounts {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<Account>> rows = JsonNullable.<List<Account>>undefined();

  public CounterpartyAccounts() {
  }

  public CounterpartyAccounts meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CounterpartyAccounts rows(@javax.annotation.Nullable List<Account> rows) {
    this.rows = JsonNullable.<List<Account>>of(rows);
    
    return this;
  }

  public CounterpartyAccounts addRowsItem(Account rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<Account>>of(new ArrayList<>());
    }
    try {
  ...
  public JsonNullable<List<Account>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<Account>> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    CounterpartyAccounts counterpartyAccounts = (CounterpartyAccounts) o;
    return Objects.equals(this.meta, counterpartyAccounts.meta) &&
        equalsNullable(this.rows, counterpartyAccounts.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class CounterpartyAccounts {\n");
