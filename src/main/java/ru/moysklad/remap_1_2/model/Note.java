...
public class Note implements MetaEntity {
  public static Note createWithMeta(UUID parentId, UUID id) {
    Note o = new Note();
    Meta meta = new Meta();
    meta.setType("note");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "counterparty" + "/" + parentId + "/" + "notes" + "/" + id;
    try {
