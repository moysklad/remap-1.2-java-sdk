...
public class FactureOut {
  public static FactureOut createWithMeta(UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("factureout");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "factureout" + "/" + id;
    try {
  ...
  public FactureOut attributes(@javax.annotation.Nullable List<@Valid AttributeAbstract> attributes) {
 ...
 @Size(max=255)
  ...
  public FactureOut demands(@javax.annotation.Nullable List<Demand> demands) {
