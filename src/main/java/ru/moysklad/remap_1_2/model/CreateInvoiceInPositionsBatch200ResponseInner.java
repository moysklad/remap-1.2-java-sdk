 ...
 */
@JsonPropertyOrder({
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_META,
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_ID,
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_ACCOUNT_ID,
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_QUANTITY,
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_PRICE,
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_DISCOUNT,
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_VAT,
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_VAT_ENABLED,
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_ASSORTMENT,
  CreateInvoiceInPositionsBatch200ResponseInner.JSON_PROPERTY_PACK,
...
public class CreateInvoiceInPositionsBatch200ResponseInner {
  ...
  public CreateInvoiceInPositionsBatch200ResponseInner meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreateInvoiceInPositionsBatch200ResponseInner quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public CreateInvoiceInPositionsBatch200ResponseInner price(@javax.annotation.Nullable Double price) {
  ...
  public CreateInvoiceInPositionsBatch200ResponseInner discount(@javax.annotation.Nullable Double discount) {
  ...
  public CreateInvoiceInPositionsBatch200ResponseInner vat(@javax.annotation.Nullable Integer vat) {
  ...
  public CreateInvoiceInPositionsBatch200ResponseInner vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public CreateInvoiceInPositionsBatch200ResponseInner assortment(@javax.annotation.Nullable Assortment assortment) {
  ...
  public CreateInvoiceInPositionsBatch200ResponseInner pack(@javax.annotation.Nullable Pack pack) {
  ...
  public CreateInvoiceInPositionsBatch200ResponseInner errors(@javax.annotation.Nonnull List<ErrorErrorsInner> errors) {
  ...
  public boolean equals(Object o) {
    ...
    CreateInvoiceInPositionsBatch200ResponseInner createInvoiceInPositionsBatch200ResponseInner = (CreateInvoiceInPositionsBatch200ResponseInner) o;
    return Objects.equals(this.meta, createInvoiceInPositionsBatch200ResponseInner.meta) &&
        Objects.equals(this.id, createInvoiceInPositionsBatch200ResponseInner.id) &&
        Objects.equals(this.accountId, createInvoiceInPositionsBatch200ResponseInner.accountId) &&
        Objects.equals(this.quantity, createInvoiceInPositionsBatch200ResponseInner.quantity) &&
        Objects.equals(this.price, createInvoiceInPositionsBatch200ResponseInner.price) &&
        Objects.equals(this.discount, createInvoiceInPositionsBatch200ResponseInner.discount) &&
        Objects.equals(this.vat, createInvoiceInPositionsBatch200ResponseInner.vat) &&
        Objects.equals(this.vatEnabled, createInvoiceInPositionsBatch200ResponseInner.vatEnabled) &&
        Objects.equals(this.assortment, createInvoiceInPositionsBatch200ResponseInner.assortment) &&
        equalsNullable(this.pack, createInvoiceInPositionsBatch200ResponseInner.pack) &&
        Objects.equals(this.errors, createInvoiceInPositionsBatch200ResponseInner.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateInvoiceInPositionsBatch200ResponseInner {\n");
