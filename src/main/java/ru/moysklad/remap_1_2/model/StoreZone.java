 ...
 */
@JsonPropertyOrder({
  StoreZone.JSON_PROPERTY_META,
  StoreZone.JSON_PROPERTY_ID,
  StoreZone.JSON_PROPERTY_ACCOUNT_ID,
  StoreZone.JSON_PROPERTY_UPDATED,
...
public class StoreZone {
  public static StoreZone createWithMeta(UUID parentId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("storezone");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "store" + "/" + parentId + "/" + "zones" + "/" + id;
    try {
  ...
  public StoreZone meta(@javax.annotation.Nullable Meta meta) {
  ...
  public StoreZone name(@javax.annotation.Nullable String name) {
  ...
  public StoreZone externalCode(@javax.annotation.Nullable String externalCode) {
  ...
  public boolean equals(Object o) {
    ...
    StoreZone storeZone = (StoreZone) o;
    return Objects.equals(this.meta, storeZone.meta) &&
        Objects.equals(this.id, storeZone.id) &&
        Objects.equals(this.accountId, storeZone.accountId) &&
        Objects.equals(this.updated, storeZone.updated) &&
        Objects.equals(this.name, storeZone.name) &&
        Objects.equals(this.externalCode, storeZone.externalCode);
  }
