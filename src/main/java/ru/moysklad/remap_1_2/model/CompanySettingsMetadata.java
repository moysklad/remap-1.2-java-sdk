...
public class CompanySettingsMetadata {
  ...
  public static final String JSON_PROPERTY_CUSTOM_ENTITIES = "customEntities";
  @javax.annotation.Nullable
  private List<CustomEntityMetadata> customEntities = new ArrayList<>();

  public CompanySettingsMetadata() {
  }

  public CompanySettingsMetadata meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CompanySettingsMetadata addCustomEntitiesItem(CustomEntityMetadata customEntitiesItem) {
    ...
    this.customEntities.add(customEntitiesItem);
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CUSTOM_ENTITIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<CustomEntityMetadata> getCustomEntities() {
    return customEntities;
  }
  ...
  public boolean equals(Object o) {
    ...
    CompanySettingsMetadata companySettingsMetadata = (CompanySettingsMetadata) o;
    return Objects.equals(this.meta, companySettingsMetadata.meta) &&
        Objects.equals(this.customEntities, companySettingsMetadata.customEntities);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, customEntities);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompanySettingsMetadata {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `customEntities` to the URL query string
    if (getCustomEntities() != null) {
      for (int i = 0; i < getCustomEntities().size(); i++) {
        if (getCustomEntities().get(i) != null) {
          joiner.add(getCustomEntities().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%scustomEntities%s%s", prefix, suffix,
