 ...
 */
public enum WebhookStockStockType {
  
  STOCK("stock");

  private String value;

  WebhookStockStockType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static WebhookStockStockType fromValue(String value) {
    for (WebhookStockStockType b : WebhookStockStockType.values()) {
