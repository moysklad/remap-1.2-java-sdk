 ...
 */
@JsonPropertyOrder({
  NotificationBonusMoney.JSON_PROPERTY_META,
  NotificationBonusMoney.JSON_PROPERTY_ID,
  NotificationBonusMoney.JSON_PROPERTY_ACCOUNT_ID,
  NotificationBonusMoney.JSON_PROPERTY_CREATED,
  NotificationBonusMoney.JSON_PROPERTY_READ,
  NotificationBonusMoney.JSON_PROPERTY_TITLE,
  NotificationBonusMoney.JSON_PROPERTY_DESCRIPTION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationBonusMoney extends NotificationAbstract {
  ...
  public NotificationBonusMoney meta(@javax.annotation.Nullable Meta meta) {
  ...
  public NotificationBonusMoney read(@javax.annotation.Nullable Boolean read) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationBonusMoney notificationBonusMoney = (NotificationBonusMoney) o;
    return Objects.equals(this.meta, notificationBonusMoney.meta) &&
        Objects.equals(this.id, notificationBonusMoney.id) &&
        Objects.equals(this.accountId, notificationBonusMoney.accountId) &&
        Objects.equals(this.created, notificationBonusMoney.created) &&
        Objects.equals(this.read, notificationBonusMoney.read) &&
        Objects.equals(this.title, notificationBonusMoney.title) &&
        Objects.equals(this.description, notificationBonusMoney.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationBonusMoney {\n");
