 ...
 */
@JsonPropertyOrder({
  ProcessingPlanProduct.JSON_PROPERTY_META,
  ProcessingPlanProduct.JSON_PROPERTY_ID,
  ProcessingPlanProduct.JSON_PROPERTY_ACCOUNT_ID,
  ProcessingPlanProduct.JSON_PROPERTY_ASSORTMENT,
  ProcessingPlanProduct.JSON_PROPERTY_PRODUCT,
  ProcessingPlanProduct.JSON_PROPERTY_QUANTITY
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProcessingPlanProduct implements MetaEntity {
  public static ProcessingPlanProduct createWithMeta(UUID parentId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("processingplanresult");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "processingplan" + "/" + parentId + "/" + "products" + "/" + id;
    try {
  ...
  public ProcessingPlanProduct meta(@javax.annotation.Nullable Meta meta) {
  ...
  public ProcessingPlanProduct assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public boolean equals(Object o) {
    ...
    ProcessingPlanProduct processingPlanProduct = (ProcessingPlanProduct) o;
    return Objects.equals(this.meta, processingPlanProduct.meta) &&
        Objects.equals(this.id, processingPlanProduct.id) &&
        Objects.equals(this.accountId, processingPlanProduct.accountId) &&
        Objects.equals(this.assortment, processingPlanProduct.assortment) &&
        Objects.equals(this.product, processingPlanProduct.product) &&
        Objects.equals(this.quantity, processingPlanProduct.quantity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, assortment, product, quantity);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProcessingPlanProduct {\n");
