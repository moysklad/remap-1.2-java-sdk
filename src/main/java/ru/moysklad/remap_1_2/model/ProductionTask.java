 ...
 */
@JsonPropertyOrder({
  ProductionTask.JSON_PROPERTY_META,
  ProductionTask.JSON_PROPERTY_ID,
  ProductionTask.JSON_PROPERTY_ACCOUNT_ID,
  ProductionTask.JSON_PROPERTY_NAME,
  ProductionTask.JSON_PROPERTY_CODE,
  ProductionTask.JSON_PROPERTY_EXTERNAL_CODE,
  ProductionTask.JSON_PROPERTY_SYNC_ID,
  ProductionTask.JSON_PROPERTY_DESCRIPTION,
  ProductionTask.JSON_PROPERTY_CREATED,
  ProductionTask.JSON_PROPERTY_DELETED,
  ProductionTask.JSON_PROPERTY_UPDATED,
  ProductionTask.JSON_PROPERTY_MOMENT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProductionTask implements MetaEntity {
  public static ProductionTask createWithMeta(UUID id) {
    ProductionTask o = new ProductionTask();
    Meta meta = new Meta();
    meta.setType("productiontask");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "productiontask" + "/" + id;
    try {
  ...
  public ProductionTask meta(@javax.annotation.Nullable Meta meta) {
  ...
  public ProductionTask name(@javax.annotation.Nullable String name) {
  ...
  public ProductionTask moment(@javax.annotation.Nullable String moment) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, productionTask.meta) &&
        Objects.equals(this.id, productionTask.id) &&
        Objects.equals(this.accountId, productionTask.accountId) &&
        Objects.equals(this.name, productionTask.name) &&
        Objects.equals(this.code, productionTask.code) &&
        Objects.equals(this.externalCode, productionTask.externalCode) &&
        Objects.equals(this.syncId, productionTask.syncId) &&
        equalsNullable(this.description, productionTask.description) &&
        Objects.equals(this.created, productionTask.created) &&
        Objects.equals(this.deleted, productionTask.deleted) &&
        Objects.equals(this.updated, productionTask.updated) &&
        Objects.equals(this.moment, productionTask.moment);
  }
