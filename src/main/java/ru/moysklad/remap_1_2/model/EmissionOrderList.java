 ...
 */
@JsonPropertyOrder({
  EmissionOrderList.JSON_PROPERTY_CONTEXT,
...
public class EmissionOrderList {
  ...
  @javax.annotation.Nullable
  private List<EmissionOrder> rows = new ArrayList<>();

  public EmissionOrderList() {
  }

  public EmissionOrderList context(@javax.annotation.Nullable Context context) {
  ...
  public EmissionOrderList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public EmissionOrderList rows(@javax.annotation.Nullable List<EmissionOrder> rows) {
  ...
  public EmissionOrderList addRowsItem(EmissionOrder rowsItem) {
    if (this.rows == null) {
  ...
  public List<EmissionOrder> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<EmissionOrder> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmissionOrderList emissionOrderList = (EmissionOrderList) o;
    return Objects.equals(this.context, emissionOrderList.context) &&
        Objects.equals(this.meta, emissionOrderList.meta) &&
        Objects.equals(this.rows, emissionOrderList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmissionOrderList {\n");
