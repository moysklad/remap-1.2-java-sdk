 ...
 */
@JsonPropertyOrder({
  RetailDrawerCashOutList.JSON_PROPERTY_CONTEXT,
  RetailDrawerCashOutList.JSON_PROPERTY_META,
  RetailDrawerCashOutList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class RetailDrawerCashOutList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<RetailDrawerCashOut> rows = new ArrayList<>();

  public RetailDrawerCashOutList() {
  }

  public RetailDrawerCashOutList context(@javax.annotation.Nullable Context context) {
  ...
  public RetailDrawerCashOutList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public RetailDrawerCashOutList rows(@javax.annotation.Nullable List<RetailDrawerCashOut> rows) {
  ...
  public RetailDrawerCashOutList addRowsItem(RetailDrawerCashOut rowsItem) {
    if (this.rows == null) {
  ...
  public List<RetailDrawerCashOut> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<RetailDrawerCashOut> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    RetailDrawerCashOutList retailDrawerCashOutList = (RetailDrawerCashOutList) o;
    return Objects.equals(this.context, retailDrawerCashOutList.context) &&
        Objects.equals(this.meta, retailDrawerCashOutList.meta) &&
        Objects.equals(this.rows, retailDrawerCashOutList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailDrawerCashOutList {\n");
