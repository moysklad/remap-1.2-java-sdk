...
public class CreateProcessingOrderPositions200ResponseInner {
 ...
 @DecimalMin("0")
  ...
  public CreateProcessingOrderPositions200ResponseInner errors(@javax.annotation.Nonnull List<@Valid ErrorErrorsInner> errors) {
  ...
  public CreateProcessingOrderPositions200ResponseInner addErrorsItem(ErrorErrorsInner errorsItem) {
    if (this.errors == null) {
