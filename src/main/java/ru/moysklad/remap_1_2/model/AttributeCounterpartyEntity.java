 ...
 */
@JsonPropertyOrder({
  AttributeCounterpartyEntity.JSON_PROPERTY_TYPE,
  AttributeCounterpartyEntity.JSON_PROPERTY_VALUE
})
...
public class AttributeCounterpartyEntity extends AttributeAbstract implements Attribute<Agent> {
  ...
  public AttributeCounterpartyEntity() {

  }

  public AttributeCounterpartyEntity type(@javax.annotation.Nullable TypeEnum type) {
  ...
  public AttributeCounterpartyEntity value(@javax.annotation.Nullable Agent value) {
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(@javax.annotation.Nullable Agent value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    AttributeCounterpartyEntity attributeCounterpartyEntity = (AttributeCounterpartyEntity) o;
    return Objects.equals(this.type, attributeCounterpartyEntity.type) &&
        Objects.equals(this.value, attributeCounterpartyEntity.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributeCounterpartyEntity {\n");
