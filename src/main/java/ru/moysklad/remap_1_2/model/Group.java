 ...
 */
@JsonPropertyOrder({
  Group.JSON_PROPERTY_META,
  Group.JSON_PROPERTY_ID,
  Group.JSON_PROPERTY_ACCOUNT_ID,
  Group.JSON_PROPERTY_NAME,
  Group.JSON_PROPERTY_INDEX
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class Group implements MetaEntity {
  public static Group createWithMeta(UUID id) {
    Group o = new Group();
    Meta meta = new Meta();
    meta.setType("group");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "group" + "/" + id;
    try {
  ...
  public Group meta(@javax.annotation.Nullable Meta meta) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, group.meta) &&
        ...
        Objects.equals(this.index, group.index);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, name, index);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIndex() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%sindex%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIndex()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
