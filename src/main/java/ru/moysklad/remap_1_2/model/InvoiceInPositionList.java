...
public class InvoiceInPositionList implements EntityList {
  ...
  public InvoiceInPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public InvoiceInPositionList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public String toString() {
    ...
    sb.append("class InvoiceInPositionList {\n");
