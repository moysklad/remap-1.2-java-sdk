 ...
 */
@JsonPropertyOrder({
  BonusProgramList.JSON_PROPERTY_CONTEXT,
  BonusProgramList.JSON_PROPERTY_META,
  BonusProgramList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class BonusProgramList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<BonusProgram> rows = new ArrayList<>();

  public BonusProgramList() {
  }

  public BonusProgramList context(@javax.annotation.Nullable Context context) {
  ...
  public BonusProgramList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public BonusProgramList rows(@javax.annotation.Nullable List<BonusProgram> rows) {
  ...
  public BonusProgramList addRowsItem(BonusProgram rowsItem) {
    if (this.rows == null) {
  ...
  public List<BonusProgram> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<BonusProgram> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    BonusProgramList bonusProgramList = (BonusProgramList) o;
    return Objects.equals(this.context, bonusProgramList.context) &&
        Objects.equals(this.meta, bonusProgramList.meta) &&
        Objects.equals(this.rows, bonusProgramList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class BonusProgramList {\n");
