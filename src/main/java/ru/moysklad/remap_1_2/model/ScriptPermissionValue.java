 ...
 */
public enum ScriptPermissionValue {
  ...
  ScriptPermissionValue(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ScriptPermissionValue fromValue(String value) {
    for (ScriptPermissionValue b : ScriptPermissionValue.values()) {
