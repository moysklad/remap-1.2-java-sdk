 ...
 */
@JsonPropertyOrder({
  CashIn.JSON_PROPERTY_META,
  CashIn.JSON_PROPERTY_ID,
  CashIn.JSON_PROPERTY_ACCOUNT_ID,
  CashIn.JSON_PROPERTY_APPLICABLE,
  CashIn.JSON_PROPERTY_NAME,
  CashIn.JSON_PROPERTY_CODE,
  CashIn.JSON_PROPERTY_EXTERNAL_CODE,
  CashIn.JSON_PROPERTY_SYNC_ID,
  CashIn.JSON_PROPERTY_DESCRIPTION,
  CashIn.JSON_PROPERTY_CREATED,
  CashIn.JSON_PROPERTY_DELETED,
  CashIn.JSON_PROPERTY_UPDATED,
  CashIn.JSON_PROPERTY_MOMENT,
  CashIn.JSON_PROPERTY_ATTRIBUTES,
  CashIn.JSON_PROPERTY_CONTRACT,
  CashIn.JSON_PROPERTY_FILES,
  CashIn.JSON_PROPERTY_PAYMENT_PURPOSE,
  CashIn.JSON_PROPERTY_PRINTED,
  CashIn.JSON_PROPERTY_PROJECT,
  CashIn.JSON_PROPERTY_PUBLISHED,
  CashIn.JSON_PROPERTY_OWNER,
  CashIn.JSON_PROPERTY_GROUP,
  CashIn.JSON_PROPERTY_SALES_CHANNEL,
  CashIn.JSON_PROPERTY_SHARED,
  CashIn.JSON_PROPERTY_STATE,
  CashIn.JSON_PROPERTY_RATE,
  CashIn.JSON_PROPERTY_ORGANIZATION,
  CashIn.JSON_PROPERTY_AGENT,
  CashIn.JSON_PROPERTY_SUM,
  CashIn.JSON_PROPERTY_VAT_SUM,
...
public class CashIn extends EntityWithMeta {
  public static CashIn createWithMeta(UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("cashin");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "cashin" + "/" + id;
    try {
  ...
  public CashIn applicable(@javax.annotation.Nullable Boolean applicable) {
  ...
  public CashIn name(@javax.annotation.Nullable String name) {
 ...
 @Size(max=255)
  ...
  public CashIn code(@javax.annotation.Nullable String code) {
 ...
 @Size(max=255)
  ...
  public CashIn externalCode(@javax.annotation.Nullable String externalCode) {
 ...
 @Size(max=255)
  ...
  public CashIn syncId(@javax.annotation.Nullable UUID syncId) {
  ...
  public CashIn description(@javax.annotation.Nullable String description) {
 ...
 @Size(max=4096)
  ...
  public CashIn moment(@javax.annotation.Nullable String moment) {
  ...
  public CashIn attributes(@javax.annotation.Nullable List<@Valid AttributeAbstract> attributes) {
  ...
  public CashIn addAttributesItem(AttributeAbstract attributesItem) {
  ...
  public CashIn contract(@javax.annotation.Nullable Contract contract) {
  ...
  public CashIn files(@javax.annotation.Nullable FileList files) {
  ...
  public CashIn paymentPurpose(@javax.annotation.Nullable String paymentPurpose) {
 ...
 @Size(max=255)
  ...
  public CashIn project(@javax.annotation.Nullable Project project) {
  ...
  public CashIn owner(@javax.annotation.Nullable Employee owner) {
  ...
  public CashIn group(@javax.annotation.Nullable Group group) {
  ...
  public CashIn salesChannel(@javax.annotation.Nullable SalesChannel salesChannel) {
  ...
  public CashIn state(@javax.annotation.Nullable State state) {
  ...
  public CashIn rate(@javax.annotation.Nullable CurrencyRate rate) {
  ...
  public CashIn organization(@javax.annotation.Nullable Organization organization) {
  ...
  public CashIn agent(@javax.annotation.Nullable Agent agent) {
  ...
  public CashIn operations(@javax.annotation.Nullable List<@Valid FinanceInOperationAbstract> operations) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, cashIn.meta) &&
        Objects.equals(this.id, cashIn.id) &&
        Objects.equals(this.accountId, cashIn.accountId) &&
        Objects.equals(this.applicable, cashIn.applicable) &&
        Objects.equals(this.name, cashIn.name) &&
        Objects.equals(this.code, cashIn.code) &&
        Objects.equals(this.externalCode, cashIn.externalCode) &&
        Objects.equals(this.syncId, cashIn.syncId) &&
        equalsNullable(this.description, cashIn.description) &&
        Objects.equals(this.created, cashIn.created) &&
        Objects.equals(this.deleted, cashIn.deleted) &&
        Objects.equals(this.updated, cashIn.updated) &&
        Objects.equals(this.moment, cashIn.moment) &&
        equalsNullable(this.attributes, cashIn.attributes) &&
        equalsNullable(this.contract, cashIn.contract) &&
        equalsNullable(this.files, cashIn.files) &&
        Objects.equals(this.paymentPurpose, cashIn.paymentPurpose) &&
        Objects.equals(this.printed, cashIn.printed) &&
        equalsNullable(this.project, cashIn.project) &&
        Objects.equals(this.published, cashIn.published) &&
        equalsNullable(this.owner, cashIn.owner) &&
        Objects.equals(this.group, cashIn.group) &&
        equalsNullable(this.salesChannel, cashIn.salesChannel) &&
        Objects.equals(this.shared, cashIn.shared) &&
        equalsNullable(this.state, cashIn.state) &&
        Objects.equals(this.rate, cashIn.rate) &&
        Objects.equals(this.organization, cashIn.organization) &&
        Objects.equals(this.agent, cashIn.agent) &&
        Objects.equals(this.sum, cashIn.sum) &&
        Objects.equals(this.vatSum, cashIn.vatSum) &&
        equalsNullable(this.factureOut, cashIn.factureOut) &&
        equalsNullable(this.operations, cashIn.operations);
  }
