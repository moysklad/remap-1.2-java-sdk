 ...
 */
@JsonPropertyOrder({
  ContractList.JSON_PROPERTY_CONTEXT,
  ContractList.JSON_PROPERTY_META,
  ContractList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ContractList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Contract> rows = new ArrayList<>();

  public ContractList() {
  }

  public ContractList context(@javax.annotation.Nullable Context context) {
  ...
  public ContractList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ContractList rows(@javax.annotation.Nullable List<Contract> rows) {
  ...
  public ContractList addRowsItem(Contract rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Contract> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, contractList.context) &&
        Objects.equals(this.meta, contractList.meta) &&
        Objects.equals(this.rows, contractList.rows);
  }
