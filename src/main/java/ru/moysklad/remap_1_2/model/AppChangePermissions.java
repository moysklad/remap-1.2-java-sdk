 ...
 */
@JsonPropertyOrder({
  AppChangePermissions.JSON_PROPERTY_META,
  AppChangePermissions.JSON_PROPERTY_ID,
  AppChangePermissions.JSON_PROPERTY_ACCOUNT_ID,
  AppChangePermissions.JSON_PROPERTY_CREATED,
  AppChangePermissions.JSON_PROPERTY_READ,
  AppChangePermissions.JSON_PROPERTY_TITLE,
  AppChangePermissions.JSON_PROPERTY_DESCRIPTION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class AppChangePermissions extends NotificationAbstract {
  ...
  public AppChangePermissions meta(@javax.annotation.Nullable Meta meta) {
  ...
  public AppChangePermissions read(@javax.annotation.Nullable Boolean read) {
  ...
  public boolean equals(Object o) {
    ...
    AppChangePermissions appChangePermissions = (AppChangePermissions) o;
    return Objects.equals(this.meta, appChangePermissions.meta) &&
        Objects.equals(this.id, appChangePermissions.id) &&
        Objects.equals(this.accountId, appChangePermissions.accountId) &&
        Objects.equals(this.created, appChangePermissions.created) &&
        Objects.equals(this.read, appChangePermissions.read) &&
        Objects.equals(this.title, appChangePermissions.title) &&
        Objects.equals(this.description, appChangePermissions.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppChangePermissions {\n");
