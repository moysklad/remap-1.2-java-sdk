...
public class SupplyPositionList implements EntityList {
  ...
  public SupplyPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public SupplyPositionList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public String toString() {
    ...
    sb.append("class SupplyPositionList {\n");
