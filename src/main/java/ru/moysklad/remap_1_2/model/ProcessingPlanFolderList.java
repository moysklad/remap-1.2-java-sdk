 ...
 */
@JsonPropertyOrder({
  ProcessingPlanFolderList.JSON_PROPERTY_CONTEXT,
  ProcessingPlanFolderList.JSON_PROPERTY_META,
  ProcessingPlanFolderList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProcessingPlanFolderList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<ProcessingPlanFolder> rows = new ArrayList<>();

  public ProcessingPlanFolderList() {
  }

  public ProcessingPlanFolderList context(@javax.annotation.Nullable Context context) {
  ...
  public ProcessingPlanFolderList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ProcessingPlanFolderList rows(@javax.annotation.Nullable List<ProcessingPlanFolder> rows) {
  ...
  public ProcessingPlanFolderList addRowsItem(ProcessingPlanFolder rowsItem) {
    if (this.rows == null) {
  ...
  public List<ProcessingPlanFolder> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<ProcessingPlanFolder> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessingPlanFolderList processingPlanFolderList = (ProcessingPlanFolderList) o;
    return Objects.equals(this.context, processingPlanFolderList.context) &&
        Objects.equals(this.meta, processingPlanFolderList.meta) &&
        Objects.equals(this.rows, processingPlanFolderList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingPlanFolderList {\n");
