...
public class CreatePurchaseReturnPositions200ResponseInner {
  ...
  public CreatePurchaseReturnPositions200ResponseInner id(@javax.annotation.Nullable UUID id) {
  ...
  public CreatePurchaseReturnPositions200ResponseInner assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public CreatePurchaseReturnPositions200ResponseInner errors(@javax.annotation.Nonnull List<Error> errors) {
  ...
  public CreatePurchaseReturnPositions200ResponseInner addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
