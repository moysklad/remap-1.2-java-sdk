 ...
 */
@JsonPropertyOrder({
  CustomRole.JSON_PROPERTY_META,
  CustomRole.JSON_PROPERTY_ID,
...
public class CustomRole {
  public static CustomRole createWithMeta(UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("customrole");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "role" + "/" + id;
    try {
  ...
  public CustomRole meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CustomRole name(@javax.annotation.Nullable String name) {
 ...
 @Size(max=255)
  ...
  public CustomRole permissions(@javax.annotation.Nullable EmployeeRolePermissions permissions) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, customRole.meta) &&
        Objects.equals(this.id, customRole.id) &&
        Objects.equals(this.name, customRole.name) &&
        equalsNullable(this.permissions, customRole.permissions);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, name, hashCodeNullable(permissions));
  }
