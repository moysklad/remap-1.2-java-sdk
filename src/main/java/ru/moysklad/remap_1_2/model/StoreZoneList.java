 ...
 */
@JsonPropertyOrder({
  StoreZoneList.JSON_PROPERTY_CONTEXT,
  StoreZoneList.JSON_PROPERTY_META,
  StoreZoneList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class StoreZoneList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<StoreZone> rows = new ArrayList<>();

  public StoreZoneList() {
  }

  public StoreZoneList context(@javax.annotation.Nullable Context context) {
  ...
  public StoreZoneList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public StoreZoneList rows(@javax.annotation.Nullable List<StoreZone> rows) {
  ...
  public StoreZoneList addRowsItem(StoreZone rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<StoreZone> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    StoreZoneList storeZoneList = (StoreZoneList) o;
    return Objects.equals(this.context, storeZoneList.context) &&
        Objects.equals(this.meta, storeZoneList.meta) &&
        Objects.equals(this.rows, storeZoneList.rows);
  }
