 ...
 */
@JsonPropertyOrder({
  NotificationTaskCompleted.JSON_PROPERTY_PERFORMED_BY,
  NotificationTaskCompleted.JSON_PROPERTY_TASK
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationTaskCompleted extends NotificationAbstract {
  ...
  public NotificationTaskCompleted() {
  }

  public NotificationTaskCompleted performedBy(@javax.annotation.Nullable NotificationNamedEntity performedBy) {
  ...
  public NotificationTaskCompleted task(@javax.annotation.Nullable NotificationTask task) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationTaskCompleted notificationTaskCompleted = (NotificationTaskCompleted) o;
    return Objects.equals(this.performedBy, notificationTaskCompleted.performedBy) &&
        Objects.equals(this.task, notificationTaskCompleted.task);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationTaskCompleted {\n");
