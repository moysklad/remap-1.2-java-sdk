...
public class CreateCommissionReportInPositions200ResponseInner {
  ...
  public CreateCommissionReportInPositions200ResponseInner id(@javax.annotation.Nullable UUID id) {
  ...
  public CreateCommissionReportInPositions200ResponseInner assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public CreateCommissionReportInPositions200ResponseInner errors(@javax.annotation.Nonnull List<Error> errors) {
  ...
  public CreateCommissionReportInPositions200ResponseInner addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
