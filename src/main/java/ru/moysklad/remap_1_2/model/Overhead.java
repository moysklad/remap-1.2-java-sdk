 ...
 */
@JsonPropertyOrder({
  Overhead.JSON_PROPERTY_SUM,
  Overhead.JSON_PROPERTY_DISTRIBUTION
})
@JsonTypeName("overhead")
...
public class Overhead {
  ...
  public Overhead sum(@javax.annotation.Nullable Double sum) {
  ...
  public Overhead distribution(@javax.annotation.Nullable String distribution) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sum, overhead.sum) &&
        Objects.equals(this.distribution, overhead.distribution);
  }
