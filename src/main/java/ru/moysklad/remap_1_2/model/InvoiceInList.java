 ...
 */
@JsonPropertyOrder({
  InvoiceInList.JSON_PROPERTY_CONTEXT,
  InvoiceInList.JSON_PROPERTY_META,
  InvoiceInList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class InvoiceInList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<InvoiceIn>> rows = JsonNullable.<List<InvoiceIn>>undefined();

  public InvoiceInList() {
  }

  public InvoiceInList context(@javax.annotation.Nullable Context context) {
  ...
  public InvoiceInList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public InvoiceInList rows(@javax.annotation.Nullable List<InvoiceIn> rows) {
    this.rows = JsonNullable.<List<InvoiceIn>>of(rows);
    
    return this;
  }


  public InvoiceInList addRowsItem(InvoiceIn rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<InvoiceIn>>of(new ArrayList<>());
    }
    try {
  ...
  public JsonNullable<List<InvoiceIn>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<InvoiceIn>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<InvoiceIn> rows) {
    this.rows = JsonNullable.<List<InvoiceIn>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    InvoiceInList invoiceInList = (InvoiceInList) o;
    return Objects.equals(this.context, invoiceInList.context) &&
        Objects.equals(this.meta, invoiceInList.meta) &&
        equalsNullable(this.rows, invoiceInList.rows);
  }
