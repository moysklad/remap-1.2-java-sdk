 ...
 */
@JsonPropertyOrder({
  TaskList.JSON_PROPERTY_CONTEXT,
  TaskList.JSON_PROPERTY_META,
  TaskList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class TaskList implements EntityList {
  ...
  public TaskList context(@javax.annotation.Nullable Context context) {
  ...
  public TaskList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public TaskList rows(@javax.annotation.Nullable List<Task> rows) {
  ...
  public TaskList addRowsItem(Task rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Task> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, taskList.context) &&
        Objects.equals(this.meta, taskList.meta) &&
        Objects.equals(this.rows, taskList.rows);
  }
