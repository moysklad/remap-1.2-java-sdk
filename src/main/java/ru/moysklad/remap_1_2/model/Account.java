...
public class Account implements MetaEntity {
  public static Account createWithMeta(UUID entityType, UUID parentId, UUID id) {
    Account o = new Account();
    Meta meta = new Meta();
    meta.setType("account");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + entityType + "/" + parentId + "/" + "accounts" + "/" + id;
    try {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, updated, isDefault, accountNumber, bankName, bankLocation, correspondentAccount, bic, hashCodeNullable(currency));
  }
