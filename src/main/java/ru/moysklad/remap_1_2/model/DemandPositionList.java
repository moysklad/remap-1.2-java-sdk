 ...
 */
@JsonPropertyOrder({
  DemandPositionList.JSON_PROPERTY_CONTEXT,
  DemandPositionList.JSON_PROPERTY_META,
  DemandPositionList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class DemandPositionList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<DemandPosition>> rows = JsonNullable.<List<DemandPosition>>undefined();

  public DemandPositionList() {
  }

  public DemandPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public DemandPositionList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public DemandPositionList rows(@javax.annotation.Nullable List<DemandPosition> rows) {
    this.rows = JsonNullable.<List<DemandPosition>>of(rows);
    
    return this;
  }


  public DemandPositionList addRowsItem(DemandPosition rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<DemandPosition>>of(new ArrayList<>());
    }
    try {
  ...
  public List<DemandPosition> getRows() {
  ...
  public JsonNullable<List<DemandPosition>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<DemandPosition>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<DemandPosition> rows) {
    this.rows = JsonNullable.<List<DemandPosition>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    DemandPositionList demandPositionList = (DemandPositionList) o;
    return Objects.equals(this.context, demandPositionList.context) &&
        Objects.equals(this.meta, demandPositionList.meta) &&
        equalsNullable(this.rows, demandPositionList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class DemandPositionList {\n");
