 ...
 */
@JsonPropertyOrder({
  PurchaseOrderPosition.JSON_PROPERTY_META,
  PurchaseOrderPosition.JSON_PROPERTY_ID,
  PurchaseOrderPosition.JSON_PROPERTY_ACCOUNT_ID,
  PurchaseOrderPosition.JSON_PROPERTY_QUANTITY,
  PurchaseOrderPosition.JSON_PROPERTY_PRICE,
  PurchaseOrderPosition.JSON_PROPERTY_DISCOUNT,
  PurchaseOrderPosition.JSON_PROPERTY_SHIPPED,
  PurchaseOrderPosition.JSON_PROPERTY_IN_TRANSIT,
  PurchaseOrderPosition.JSON_PROPERTY_VAT,
  PurchaseOrderPosition.JSON_PROPERTY_VAT_ENABLED,
  PurchaseOrderPosition.JSON_PROPERTY_ASSORTMENT,
...
public class PurchaseOrderPosition {
  public static PurchaseOrderPosition createWithMeta(UUID parentId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("purchaseorderposition");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "purchaseorder" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public PurchaseOrderPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public PurchaseOrderPosition quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public PurchaseOrderPosition price(@javax.annotation.Nullable Double price) {
  ...
  public PurchaseOrderPosition discount(@javax.annotation.Nullable Double discount) {
  ...
  public PurchaseOrderPosition vat(@javax.annotation.Nullable Integer vat) {
  ...
  public PurchaseOrderPosition vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public PurchaseOrderPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public PurchaseOrderPosition stock(@javax.annotation.Nullable PositionStock stock) {
  ...
  public boolean equals(Object o) {
    ...
    PurchaseOrderPosition purchaseOrderPosition = (PurchaseOrderPosition) o;
    return Objects.equals(this.meta, purchaseOrderPosition.meta) &&
        Objects.equals(this.id, purchaseOrderPosition.id) &&
        Objects.equals(this.accountId, purchaseOrderPosition.accountId) &&
        Objects.equals(this.quantity, purchaseOrderPosition.quantity) &&
        Objects.equals(this.price, purchaseOrderPosition.price) &&
        Objects.equals(this.discount, purchaseOrderPosition.discount) &&
        Objects.equals(this.shipped, purchaseOrderPosition.shipped) &&
        Objects.equals(this.inTransit, purchaseOrderPosition.inTransit) &&
        Objects.equals(this.vat, purchaseOrderPosition.vat) &&
        Objects.equals(this.vatEnabled, purchaseOrderPosition.vatEnabled) &&
        Objects.equals(this.assortment, purchaseOrderPosition.assortment) &&
        equalsNullable(this.pack, purchaseOrderPosition.pack) &&
        equalsNullable(this.stock, purchaseOrderPosition.stock);
  }
  ...
  public String toString() {
    ...
    sb.append("class PurchaseOrderPosition {\n");
