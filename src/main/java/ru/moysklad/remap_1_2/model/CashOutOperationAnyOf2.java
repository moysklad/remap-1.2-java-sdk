 ...
 */
@JsonPropertyOrder({
  CashOutOperationAnyOf2.JSON_PROPERTY_META,
  CashOutOperationAnyOf2.JSON_PROPERTY_ID,
  CashOutOperationAnyOf2.JSON_PROPERTY_ACCOUNT_ID,
  CashOutOperationAnyOf2.JSON_PROPERTY_NAME,
  CashOutOperationAnyOf2.JSON_PROPERTY_CODE,
  CashOutOperationAnyOf2.JSON_PROPERTY_EXTERNAL_CODE,
  CashOutOperationAnyOf2.JSON_PROPERTY_SYNC_ID,
  CashOutOperationAnyOf2.JSON_PROPERTY_DESCRIPTION,
  CashOutOperationAnyOf2.JSON_PROPERTY_CREATED,
  CashOutOperationAnyOf2.JSON_PROPERTY_DELETED,
  CashOutOperationAnyOf2.JSON_PROPERTY_UPDATED,
  CashOutOperationAnyOf2.JSON_PROPERTY_MOMENT,
  CashOutOperationAnyOf2.JSON_PROPERTY_LINKED_SUM
})
@JsonTypeName("CashOutOperation_anyOf_2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-05-22T13:41:10.768379078Z[GMT]", comments = "Generator version: 7.14.0")
public class CashOutOperationAnyOf2 {
  ...
  public CashOutOperationAnyOf2 meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CashOutOperationAnyOf2 name(@javax.annotation.Nullable String name) {
  ...
  public CashOutOperationAnyOf2 code(@javax.annotation.Nullable String code) {
  ...
  public CashOutOperationAnyOf2 externalCode(@javax.annotation.Nullable String externalCode) {
  ...
  public CashOutOperationAnyOf2 syncId(@javax.annotation.Nullable UUID syncId) {
  ...
  public CashOutOperationAnyOf2 description(@javax.annotation.Nullable String description) {
  ...
  public CashOutOperationAnyOf2 moment(@javax.annotation.Nullable String moment) {
  ...
  public CashOutOperationAnyOf2 linkedSum(@javax.annotation.Nonnull Double linkedSum) {
  ...
  public boolean equals(Object o) {
    ...
    CashOutOperationAnyOf2 cashOutOperationAnyOf2 = (CashOutOperationAnyOf2) o;
    return Objects.equals(this.meta, cashOutOperationAnyOf2.meta) &&
        Objects.equals(this.id, cashOutOperationAnyOf2.id) &&
        Objects.equals(this.accountId, cashOutOperationAnyOf2.accountId) &&
        Objects.equals(this.name, cashOutOperationAnyOf2.name) &&
        Objects.equals(this.code, cashOutOperationAnyOf2.code) &&
        Objects.equals(this.externalCode, cashOutOperationAnyOf2.externalCode) &&
        Objects.equals(this.syncId, cashOutOperationAnyOf2.syncId) &&
        equalsNullable(this.description, cashOutOperationAnyOf2.description) &&
        Objects.equals(this.created, cashOutOperationAnyOf2.created) &&
        Objects.equals(this.deleted, cashOutOperationAnyOf2.deleted) &&
        Objects.equals(this.updated, cashOutOperationAnyOf2.updated) &&
        Objects.equals(this.moment, cashOutOperationAnyOf2.moment) &&
        Objects.equals(this.linkedSum, cashOutOperationAnyOf2.linkedSum);
  }
  ...
  public String toString() {
    ...
    sb.append("class CashOutOperationAnyOf2 {\n");
