 ...
 */
@JsonPropertyOrder({
  RetailDemandPositionList.JSON_PROPERTY_CONTEXT,
  RetailDemandPositionList.JSON_PROPERTY_META,
  RetailDemandPositionList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class RetailDemandPositionList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<RetailDemandPosition>> rows = JsonNullable.<List<RetailDemandPosition>>undefined();

  public RetailDemandPositionList() {
  }

  public RetailDemandPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public RetailDemandPositionList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public RetailDemandPositionList rows(@javax.annotation.Nullable List<RetailDemandPosition> rows) {
    this.rows = JsonNullable.<List<RetailDemandPosition>>of(rows);
    
    return this;
  }


  public RetailDemandPositionList addRowsItem(RetailDemandPosition rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<RetailDemandPosition>>of(new ArrayList<>());
    }
    try {
  ...
  public List<RetailDemandPosition> getRows() {
  ...
  public JsonNullable<List<RetailDemandPosition>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<RetailDemandPosition>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<RetailDemandPosition> rows) {
    this.rows = JsonNullable.<List<RetailDemandPosition>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    RetailDemandPositionList retailDemandPositionList = (RetailDemandPositionList) o;
    return Objects.equals(this.context, retailDemandPositionList.context) &&
        Objects.equals(this.meta, retailDemandPositionList.meta) &&
        equalsNullable(this.rows, retailDemandPositionList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailDemandPositionList {\n");
