...
public class CreateInvoiceOutBatch200ResponseInner {
  ...
  public CreateInvoiceOutBatch200ResponseInner errors(@javax.annotation.Nonnull List<Error> errors) {
  ...
  public CreateInvoiceOutBatch200ResponseInner addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
