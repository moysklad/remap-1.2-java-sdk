 ...
 */
@JsonPropertyOrder({
  ProcessingList.JSON_PROPERTY_CONTEXT,
  ProcessingList.JSON_PROPERTY_META,
  ProcessingList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProcessingList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Processing> rows = new ArrayList<>();

  public ProcessingList() {
  }

  public ProcessingList context(@javax.annotation.Nullable Context context) {
  ...
  public ProcessingList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ProcessingList rows(@javax.annotation.Nullable List<Processing> rows) {
  ...
  public ProcessingList addRowsItem(Processing rowsItem) {
    if (this.rows == null) {
  ...
  public List<Processing> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Processing> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessingList processingList = (ProcessingList) o;
    return Objects.equals(this.context, processingList.context) &&
        Objects.equals(this.meta, processingList.meta) &&
        Objects.equals(this.rows, processingList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingList {\n");
