 ...
 */
@JsonPropertyOrder({
  ProcessingMaterial.JSON_PROPERTY_META,
  ProcessingMaterial.JSON_PROPERTY_ID,
  ProcessingMaterial.JSON_PROPERTY_ACCOUNT_ID,
  ProcessingMaterial.JSON_PROPERTY_ASSORTMENT,
...
public class ProcessingMaterial implements MetaEntity {
  public static ProcessingMaterial createWithMeta(UUID parentId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("processingpositionmaterial");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "processing" + "/" + parentId + "/" + "materials" + "/" + id;
    try {
  ...
  public ProcessingMaterial meta(@javax.annotation.Nullable Meta meta) {
  ...
  public ProcessingMaterial assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public ProcessingMaterial quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public ProcessingMaterial things(@javax.annotation.Nullable List<String> things) {
  ...
  public ProcessingMaterial addThingsItem(String thingsItem) {
    if (this.things == null) {
  ...
  public boolean equals(Object o) {
    ...
    ProcessingMaterial processingMaterial = (ProcessingMaterial) o;
    return Objects.equals(this.meta, processingMaterial.meta) &&
        Objects.equals(this.id, processingMaterial.id) &&
        Objects.equals(this.accountId, processingMaterial.accountId) &&
        Objects.equals(this.assortment, processingMaterial.assortment) &&
        Objects.equals(this.quantity, processingMaterial.quantity) &&
        Objects.equals(this.things, processingMaterial.things);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingMaterial {\n");
