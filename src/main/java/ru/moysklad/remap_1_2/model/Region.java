 ...
 */
@JsonPropertyOrder({
  Region.JSON_PROPERTY_META,
  Region.JSON_PROPERTY_ID,
  Region.JSON_PROPERTY_ACCOUNT_ID,
  Region.JSON_PROPERTY_NAME,
  Region.JSON_PROPERTY_CODE,
  Region.JSON_PROPERTY_EXTERNAL_CODE,
  Region.JSON_PROPERTY_UPDATED,
  Region.JSON_PROPERTY_VERSION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class Region implements Named, MetaEntity {
  public static Region createWithMeta(UUID id) {
    Region o = new Region();
    Meta meta = new Meta();
    meta.setType("region");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "region" + "/" + id;
    try {
  ...
  public Region(
    ...
    @JsonProperty(value = JSON_PROPERTY_VERSION, required = false) Integer version
  ) {
    this();
    this.id = id;
  ...
  public Region meta(@javax.annotation.Nullable Meta meta) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, region.meta) &&
        Objects.equals(this.id, region.id) &&
        Objects.equals(this.accountId, region.accountId) &&
        Objects.equals(this.name, region.name) &&
        Objects.equals(this.code, region.code) &&
        Objects.equals(this.externalCode, region.externalCode) &&
        Objects.equals(this.updated, region.updated) &&
        Objects.equals(this.version, region.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, name, code, externalCode, updated, version);
  }
