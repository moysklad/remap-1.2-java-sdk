 ...
 */
@JsonPropertyOrder({
  ProcessingProcessList.JSON_PROPERTY_CONTEXT,
  ProcessingProcessList.JSON_PROPERTY_META,
  ProcessingProcessList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProcessingProcessList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<ProcessingProcess> rows = new ArrayList<>();

  public ProcessingProcessList() {
  }

  public ProcessingProcessList context(@javax.annotation.Nullable Context context) {
  ...
  public ProcessingProcessList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ProcessingProcessList rows(@javax.annotation.Nullable List<ProcessingProcess> rows) {
  ...
  public ProcessingProcessList addRowsItem(ProcessingProcess rowsItem) {
    if (this.rows == null) {
  ...
  public List<ProcessingProcess> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<ProcessingProcess> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessingProcessList processingProcessList = (ProcessingProcessList) o;
    return Objects.equals(this.context, processingProcessList.context) &&
        Objects.equals(this.meta, processingProcessList.meta) &&
        Objects.equals(this.rows, processingProcessList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingProcessList {\n");
