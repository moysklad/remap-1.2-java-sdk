 ...
 */
@JsonPropertyOrder({
  NotificationSalesManagerChatMessage.JSON_PROPERTY_META,
  NotificationSalesManagerChatMessage.JSON_PROPERTY_ID,
  NotificationSalesManagerChatMessage.JSON_PROPERTY_ACCOUNT_ID,
  NotificationSalesManagerChatMessage.JSON_PROPERTY_CREATED,
  NotificationSalesManagerChatMessage.JSON_PROPERTY_READ,
  NotificationSalesManagerChatMessage.JSON_PROPERTY_TITLE,
  NotificationSalesManagerChatMessage.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("notificationSalesManagerChatMessage")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationSalesManagerChatMessage extends NotificationAbstract {
  ...
  public NotificationSalesManagerChatMessage() {
  }
  /**
  ...
  public NotificationSalesManagerChatMessage meta(@javax.annotation.Nullable Meta meta) {
  ...
  public NotificationSalesManagerChatMessage read(@javax.annotation.Nullable Boolean read) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationSalesManagerChatMessage notificationSalesManagerChatMessage = (NotificationSalesManagerChatMessage) o;
    return Objects.equals(this.meta, notificationSalesManagerChatMessage.meta) &&
        Objects.equals(this.id, notificationSalesManagerChatMessage.id) &&
        Objects.equals(this.accountId, notificationSalesManagerChatMessage.accountId) &&
        Objects.equals(this.created, notificationSalesManagerChatMessage.created) &&
        Objects.equals(this.read, notificationSalesManagerChatMessage.read) &&
        Objects.equals(this.title, notificationSalesManagerChatMessage.title) &&
        Objects.equals(this.description, notificationSalesManagerChatMessage.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationSalesManagerChatMessage {\n");
