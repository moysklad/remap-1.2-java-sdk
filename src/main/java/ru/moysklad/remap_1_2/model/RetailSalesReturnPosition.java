 ...
 */
@JsonPropertyOrder({
  RetailSalesReturnPosition.JSON_PROPERTY_META,
  RetailSalesReturnPosition.JSON_PROPERTY_ID,
  RetailSalesReturnPosition.JSON_PROPERTY_ACCOUNT_ID,
  RetailSalesReturnPosition.JSON_PROPERTY_ASSORTMENT,
  RetailSalesReturnPosition.JSON_PROPERTY_COST,
  RetailSalesReturnPosition.JSON_PROPERTY_DISCOUNT,
  RetailSalesReturnPosition.JSON_PROPERTY_PACK,
  RetailSalesReturnPosition.JSON_PROPERTY_PRICE,
  RetailSalesReturnPosition.JSON_PROPERTY_QUANTITY,
  RetailSalesReturnPosition.JSON_PROPERTY_THINGS,
  RetailSalesReturnPosition.JSON_PROPERTY_VAT,
  RetailSalesReturnPosition.JSON_PROPERTY_VAT_ENABLED
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class RetailSalesReturnPosition extends EntityWithMeta implements DocumentPosition, MetaEntity {
  public static RetailSalesReturnPosition createWithMeta(UUID parentId, UUID id) {
    RetailSalesReturnPosition o = new RetailSalesReturnPosition();
    Meta meta = new Meta();
    meta.setType("salesreturnposition");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "retailsalesreturn" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public RetailSalesReturnPosition() {
  }
  /**
  ...
  public RetailSalesReturnPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public RetailSalesReturnPosition id(@javax.annotation.Nullable UUID id) {
  ...
  public RetailSalesReturnPosition assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public RetailSalesReturnPosition cost(@javax.annotation.Nullable Integer cost) {
  ...
  public RetailSalesReturnPosition discount(@javax.annotation.Nullable Double discount) {
  ...
  public RetailSalesReturnPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public RetailSalesReturnPosition price(@javax.annotation.Nullable Double price) {
  ...
  public RetailSalesReturnPosition quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public RetailSalesReturnPosition things(@javax.annotation.Nullable List<String> things) {
  ...
  public RetailSalesReturnPosition addThingsItem(String thingsItem) {
    if (this.things == null) {
  ...
  public RetailSalesReturnPosition vat(@javax.annotation.Nullable Integer vat) {
  ...
  public RetailSalesReturnPosition vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    RetailSalesReturnPosition retailSalesReturnPosition = (RetailSalesReturnPosition) o;
    return Objects.equals(this.meta, retailSalesReturnPosition.meta) &&
        Objects.equals(this.id, retailSalesReturnPosition.id) &&
        Objects.equals(this.accountId, retailSalesReturnPosition.accountId) &&
        Objects.equals(this.assortment, retailSalesReturnPosition.assortment) &&
        Objects.equals(this.cost, retailSalesReturnPosition.cost) &&
        Objects.equals(this.discount, retailSalesReturnPosition.discount) &&
        equalsNullable(this.pack, retailSalesReturnPosition.pack) &&
        Objects.equals(this.price, retailSalesReturnPosition.price) &&
        Objects.equals(this.quantity, retailSalesReturnPosition.quantity) &&
        Objects.equals(this.things, retailSalesReturnPosition.things) &&
        Objects.equals(this.vat, retailSalesReturnPosition.vat) &&
        Objects.equals(this.vatEnabled, retailSalesReturnPosition.vatEnabled);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, assortment, cost, discount, hashCodeNullable(pack), price, quantity, things, vat, vatEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailSalesReturnPosition {\n");
