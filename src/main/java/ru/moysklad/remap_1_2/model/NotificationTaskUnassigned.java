 ...
 */
@JsonPropertyOrder({
  NotificationTaskUnassigned.JSON_PROPERTY_PERFORMED_BY,
  NotificationTaskUnassigned.JSON_PROPERTY_TASK
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationTaskUnassigned extends NotificationAbstract {
  ...
  public NotificationTaskUnassigned() {
  }

  public NotificationTaskUnassigned performedBy(@javax.annotation.Nullable NotificationNamedEntity performedBy) {
  ...
  public NotificationTaskUnassigned task(@javax.annotation.Nullable NotificationTask task) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationTaskUnassigned notificationTaskUnassigned = (NotificationTaskUnassigned) o;
    return Objects.equals(this.performedBy, notificationTaskUnassigned.performedBy) &&
        Objects.equals(this.task, notificationTaskUnassigned.task);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationTaskUnassigned {\n");
