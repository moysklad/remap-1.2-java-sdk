...
public class CreateSalesReturnPositions200ResponseInner {
  ...
  public CreateSalesReturnPositions200ResponseInner id(@javax.annotation.Nullable UUID id) {
  ...
  public CreateSalesReturnPositions200ResponseInner assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public CreateSalesReturnPositions200ResponseInner errors(@javax.annotation.Nonnull List<Error> errors) {
  ...
  public CreateSalesReturnPositions200ResponseInner addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
