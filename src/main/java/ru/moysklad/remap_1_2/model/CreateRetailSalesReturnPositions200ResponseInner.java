 ...
 */
@JsonPropertyOrder({
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_META,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_ID,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_ACCOUNT_ID,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_ASSORTMENT,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_COST,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_DISCOUNT,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_PACK,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_PRICE,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_QUANTITY,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_THINGS,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_VAT,
  CreateRetailSalesReturnPositions200ResponseInner.JSON_PROPERTY_VAT_ENABLED,
...
public class CreateRetailSalesReturnPositions200ResponseInner {
  ...
  public CreateRetailSalesReturnPositions200ResponseInner meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreateRetailSalesReturnPositions200ResponseInner assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public CreateRetailSalesReturnPositions200ResponseInner cost(@javax.annotation.Nullable Integer cost) {
 ...
 @Min(0)
  ...
  public CreateRetailSalesReturnPositions200ResponseInner discount(@javax.annotation.Nullable Double discount) {
 ...
 @DecimalMax("100")
  ...
  public CreateRetailSalesReturnPositions200ResponseInner pack(@javax.annotation.Nullable Pack pack) {
  ...
  public CreateRetailSalesReturnPositions200ResponseInner price(@javax.annotation.Nullable Double price) {
 ...
 @DecimalMin("0")
  ...
  public CreateRetailSalesReturnPositions200ResponseInner quantity(@javax.annotation.Nullable Double quantity) {
 ...
 @DecimalMin("0.00010")
  ...
  public CreateRetailSalesReturnPositions200ResponseInner things(@javax.annotation.Nullable List<String> things) {
  ...
  public CreateRetailSalesReturnPositions200ResponseInner addThingsItem(String thingsItem) {
    if (this.things == null) {
  ...
  public CreateRetailSalesReturnPositions200ResponseInner vat(@javax.annotation.Nullable Integer vat) {
 ...
 @Min(0) @Max(100)
  ...
  public CreateRetailSalesReturnPositions200ResponseInner vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRetailSalesReturnPositions200ResponseInner createRetailSalesReturnPositions200ResponseInner = (CreateRetailSalesReturnPositions200ResponseInner) o;
    return Objects.equals(this.meta, createRetailSalesReturnPositions200ResponseInner.meta) &&
        Objects.equals(this.id, createRetailSalesReturnPositions200ResponseInner.id) &&
        Objects.equals(this.accountId, createRetailSalesReturnPositions200ResponseInner.accountId) &&
        Objects.equals(this.assortment, createRetailSalesReturnPositions200ResponseInner.assortment) &&
        Objects.equals(this.cost, createRetailSalesReturnPositions200ResponseInner.cost) &&
        Objects.equals(this.discount, createRetailSalesReturnPositions200ResponseInner.discount) &&
        equalsNullable(this.pack, createRetailSalesReturnPositions200ResponseInner.pack) &&
        Objects.equals(this.price, createRetailSalesReturnPositions200ResponseInner.price) &&
        Objects.equals(this.quantity, createRetailSalesReturnPositions200ResponseInner.quantity) &&
        Objects.equals(this.things, createRetailSalesReturnPositions200ResponseInner.things) &&
        Objects.equals(this.vat, createRetailSalesReturnPositions200ResponseInner.vat) &&
        Objects.equals(this.vatEnabled, createRetailSalesReturnPositions200ResponseInner.vatEnabled) &&
        Objects.equals(this.errors, createRetailSalesReturnPositions200ResponseInner.errors);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, assortment, cost, discount, hashCodeNullable(pack), price, quantity, things, vat, vatEnabled, errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRetailSalesReturnPositions200ResponseInner {\n");
