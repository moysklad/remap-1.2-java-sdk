 ...
 */
@JsonPropertyOrder({
  DemandPosition.JSON_PROPERTY_META,
  DemandPosition.JSON_PROPERTY_ID,
  DemandPosition.JSON_PROPERTY_ACCOUNT_ID,
  DemandPosition.JSON_PROPERTY_ASSORTMENT,
  DemandPosition.JSON_PROPERTY_COST,
  DemandPosition.JSON_PROPERTY_DECLARATION,
  DemandPosition.JSON_PROPERTY_DISCOUNT,
  DemandPosition.JSON_PROPERTY_PACK,
  DemandPosition.JSON_PROPERTY_PRICE,
  DemandPosition.JSON_PROPERTY_QUANTITY,
  DemandPosition.JSON_PROPERTY_SLOT,
  DemandPosition.JSON_PROPERTY_THINGS,
  DemandPosition.JSON_PROPERTY_TRACKING_CODES,
  DemandPosition.JSON_PROPERTY_TRACKING_CODES1162,
  DemandPosition.JSON_PROPERTY_OVERHEAD,
...
public class DemandPosition {
  public static DemandPosition createWithMeta(UUID parentId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("demandposition");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "demand" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public DemandPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public DemandPosition assortment(@javax.annotation.Nullable Assortment assortment) {
  ...
  public DemandPosition discount(@javax.annotation.Nullable Double discount) {
  ...
  public DemandPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public DemandPosition price(@javax.annotation.Nullable Double price) {
  ...
  public DemandPosition quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public DemandPosition slot(@javax.annotation.Nullable StoreSlot slot) {
  ...
  public DemandPosition things(@javax.annotation.Nullable List<String> things) {
    
    this.things = things;
    return this;
  }

  public DemandPosition addThingsItem(String thingsItem) {
    if (this.things == null) {
  ...
  public DemandPosition trackingCodes(@javax.annotation.Nullable List<DemandPositionTrackingCode> trackingCodes) {
    
    this.trackingCodes = trackingCodes;
    return this;
  }

  public DemandPosition addTrackingCodesItem(DemandPositionTrackingCode trackingCodesItem) {
  ...
  public DemandPosition addTrackingCodes1162Item(DemandPositionTrackingCode1162 trackingCodes1162Item) {
  ...
  public DemandPosition vat(@javax.annotation.Nullable Integer vat) {
  ...
  public DemandPosition vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    DemandPosition demandPosition = (DemandPosition) o;
    return Objects.equals(this.meta, demandPosition.meta) &&
        Objects.equals(this.id, demandPosition.id) &&
        Objects.equals(this.accountId, demandPosition.accountId) &&
        Objects.equals(this.assortment, demandPosition.assortment) &&
        Objects.equals(this.cost, demandPosition.cost) &&
        Objects.equals(this.declaration, demandPosition.declaration) &&
        Objects.equals(this.discount, demandPosition.discount) &&
        equalsNullable(this.pack, demandPosition.pack) &&
        Objects.equals(this.price, demandPosition.price) &&
        Objects.equals(this.quantity, demandPosition.quantity) &&
        equalsNullable(this.slot, demandPosition.slot) &&
        Objects.equals(this.things, demandPosition.things) &&
        Objects.equals(this.trackingCodes, demandPosition.trackingCodes) &&
        Objects.equals(this.trackingCodes1162, demandPosition.trackingCodes1162) &&
        Objects.equals(this.overhead, demandPosition.overhead) &&
        Objects.equals(this.vat, demandPosition.vat) &&
        Objects.equals(this.vatEnabled, demandPosition.vatEnabled);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, assortment, cost, declaration, discount, hashCodeNullable(pack), price, quantity, hashCodeNullable(slot), things, trackingCodes, trackingCodes1162, overhead, vat, vatEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class DemandPosition {\n");
