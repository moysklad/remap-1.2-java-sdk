...
public class Employee extends Agent implements Named {
  public static Employee createWithMeta(UUID id) {
    Employee o = new Employee();
    Meta meta = new Meta();
    meta.setType("employee");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "employee" + "/" + id;
    try {
