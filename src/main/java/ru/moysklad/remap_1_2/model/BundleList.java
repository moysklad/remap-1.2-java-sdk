 ...
 */
@JsonPropertyOrder({
  BundleList.JSON_PROPERTY_CONTEXT,
  BundleList.JSON_PROPERTY_META,
  BundleList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class BundleList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Bundle> rows = new ArrayList<>();

  public BundleList() {
  }

  public BundleList context(@javax.annotation.Nullable Context context) {
  ...
  public BundleList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public BundleList rows(@javax.annotation.Nullable List<Bundle> rows) {
  ...
  public BundleList addRowsItem(Bundle rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Bundle> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, bundleList.context) &&
        Objects.equals(this.meta, bundleList.meta) &&
        Objects.equals(this.rows, bundleList.rows);
  }
