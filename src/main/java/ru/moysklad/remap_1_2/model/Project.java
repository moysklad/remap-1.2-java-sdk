...
@JsonPropertyOrder({
  ...
  Project.JSON_PROPERTY_EXTERNAL_CODE,
  Project.JSON_PROPERTY_GROUP,
  Project.JSON_PROPERTY_NAME,
  Project.JSON_PROPERTY_OWNER,
...
public class Project extends EntityWithMeta {
  public static Project createWithMeta(UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("project");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "project" + "/" + id;
    try {
  ...
  public Project meta(@javax.annotation.Nullable Meta meta) {
  ...
  public Project attributes(@javax.annotation.Nullable List<@Valid AttributeAbstract> attributes) {
 ...
 @Size(max=255)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, project.meta) &&
        Objects.equals(this.id, project.id) &&
        Objects.equals(this.accountId, project.accountId) &&
        Objects.equals(this.archived, project.archived) &&
        equalsNullable(this.attributes, project.attributes) &&
        Objects.equals(this.code, project.code) &&
        Objects.equals(this.description, project.description) &&
        Objects.equals(this.externalCode, project.externalCode) &&
        Objects.equals(this.group, project.group) &&
        Objects.equals(this.name, project.name) &&
        equalsNullable(this.owner, project.owner) &&
        Objects.equals(this.shared, project.shared) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, archived, hashCodeNullable(attributes), code, description, externalCode, group, name, hashCodeNullable(owner), shared, updated);
  }
