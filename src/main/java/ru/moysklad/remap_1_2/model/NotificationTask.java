 ...
 */
@JsonPropertyOrder({
  NotificationTask.JSON_PROPERTY_META,
  NotificationTask.JSON_PROPERTY_ID,
  NotificationTask.JSON_PROPERTY_NAME,
  NotificationTask.JSON_PROPERTY_DEADLINE
})
...
public class NotificationTask {
  ...
  public NotificationTask meta(@javax.annotation.Nullable Meta meta) {
  ...
  public NotificationTask id(@javax.annotation.Nullable UUID id) {
  ...
  public NotificationTask name(@javax.annotation.Nullable String name) {
  ...
  public NotificationTask deadline(@javax.annotation.Nullable String deadline) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, notificationTask.meta) &&
        Objects.equals(this.id, notificationTask.id) &&
        Objects.equals(this.name, notificationTask.name) &&
        Objects.equals(this.deadline, notificationTask.deadline);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, name, deadline);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NotificationTask {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDeadline() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%sdeadline%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDeadline()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
