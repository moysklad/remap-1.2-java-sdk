 ...
 */
public enum EmissionOrderPositionStatus {
  ...
  EmissionOrderPositionStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EmissionOrderPositionStatus fromValue(String value) {
    for (EmissionOrderPositionStatus b : EmissionOrderPositionStatus.values()) {
