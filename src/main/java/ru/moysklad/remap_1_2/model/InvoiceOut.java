...
public class InvoiceOut {
  ...
  public InvoiceOut payments(@javax.annotation.Nullable List<CustomerOrderPaymentsInner> payments) {
  ...
  public InvoiceOut addPaymentsItem(CustomerOrderPaymentsInner paymentsItem) {
