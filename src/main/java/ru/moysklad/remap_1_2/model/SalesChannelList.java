 ...
 */
@JsonPropertyOrder({
  SalesChannelList.JSON_PROPERTY_CONTEXT,
  SalesChannelList.JSON_PROPERTY_META,
  SalesChannelList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class SalesChannelList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<SalesChannel> rows = new ArrayList<>();

  public SalesChannelList() {
  }

  public SalesChannelList context(@javax.annotation.Nullable Context context) {
  ...
  public SalesChannelList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public SalesChannelList rows(@javax.annotation.Nullable List<SalesChannel> rows) {
  ...
  public SalesChannelList addRowsItem(SalesChannel rowsItem) {
    if (this.rows == null) {
  ...
  public List<SalesChannel> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<SalesChannel> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    SalesChannelList salesChannelList = (SalesChannelList) o;
    return Objects.equals(this.context, salesChannelList.context) &&
        Objects.equals(this.meta, salesChannelList.meta) &&
        Objects.equals(this.rows, salesChannelList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class SalesChannelList {\n");
