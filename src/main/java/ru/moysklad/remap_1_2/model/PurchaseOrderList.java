 ...
 */
@JsonPropertyOrder({
  PurchaseOrderList.JSON_PROPERTY_CONTEXT,
  PurchaseOrderList.JSON_PROPERTY_META,
  PurchaseOrderList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class PurchaseOrderList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<PurchaseOrder> rows = new ArrayList<>();

  public PurchaseOrderList() {
  }

  public PurchaseOrderList context(@javax.annotation.Nullable Context context) {
  ...
  public PurchaseOrderList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public PurchaseOrderList rows(@javax.annotation.Nullable List<PurchaseOrder> rows) {
  ...
  public PurchaseOrderList addRowsItem(PurchaseOrder rowsItem) {
    if (this.rows == null) {
  ...
  public List<PurchaseOrder> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<PurchaseOrder> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    PurchaseOrderList purchaseOrderList = (PurchaseOrderList) o;
    return Objects.equals(this.context, purchaseOrderList.context) &&
        Objects.equals(this.meta, purchaseOrderList.meta) &&
        Objects.equals(this.rows, purchaseOrderList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class PurchaseOrderList {\n");
