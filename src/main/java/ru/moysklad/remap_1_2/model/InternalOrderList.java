 ...
 */
@JsonPropertyOrder({
  InternalOrderList.JSON_PROPERTY_CONTEXT,
  InternalOrderList.JSON_PROPERTY_META,
  InternalOrderList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class InternalOrderList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<InternalOrder> rows = new ArrayList<>();

  public InternalOrderList() {
  }

  public InternalOrderList context(@javax.annotation.Nullable Context context) {
  ...
  public InternalOrderList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public InternalOrderList rows(@javax.annotation.Nullable List<InternalOrder> rows) {
  ...
  public InternalOrderList addRowsItem(InternalOrder rowsItem) {
    if (this.rows == null) {
  ...
  public List<InternalOrder> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<InternalOrder> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    InternalOrderList internalOrderList = (InternalOrderList) o;
    return Objects.equals(this.context, internalOrderList.context) &&
        Objects.equals(this.meta, internalOrderList.meta) &&
        Objects.equals(this.rows, internalOrderList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class InternalOrderList {\n");
