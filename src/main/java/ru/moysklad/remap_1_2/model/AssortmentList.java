 ...
 */
@JsonPropertyOrder({
  AssortmentList.JSON_PROPERTY_CONTEXT,
  AssortmentList.JSON_PROPERTY_META,
  AssortmentList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class AssortmentList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Assortment> rows = new ArrayList<>();

  public AssortmentList() {
  }

  public AssortmentList context(@javax.annotation.Nullable Context context) {
  ...
  public AssortmentList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public AssortmentList rows(@javax.annotation.Nullable List<Assortment> rows) {
  ...
  public AssortmentList addRowsItem(Assortment rowsItem) {
    if (this.rows == null) {
  ...
  public List<Assortment> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Assortment> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    AssortmentList assortmentList = (AssortmentList) o;
    return Objects.equals(this.context, assortmentList.context) &&
        Objects.equals(this.meta, assortmentList.meta) &&
        Objects.equals(this.rows, assortmentList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssortmentList {\n");
