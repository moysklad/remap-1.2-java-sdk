 ...
 */
@JsonPropertyOrder({
  LossPositionList.JSON_PROPERTY_CONTEXT,
  LossPositionList.JSON_PROPERTY_META,
  LossPositionList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class LossPositionList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<LossPosition>> rows = JsonNullable.<List<LossPosition>>undefined();

  public LossPositionList() {
  }

  public LossPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public LossPositionList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public LossPositionList rows(@javax.annotation.Nullable List<LossPosition> rows) {
    this.rows = JsonNullable.<List<LossPosition>>of(rows);
    
    return this;
  }


  public LossPositionList addRowsItem(LossPosition rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<LossPosition>>of(new ArrayList<>());
    }
    try {
  ...
  public List<LossPosition> getRows() {
  ...
  public JsonNullable<List<LossPosition>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<LossPosition>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<LossPosition> rows) {
    this.rows = JsonNullable.<List<LossPosition>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    LossPositionList lossPositionList = (LossPositionList) o;
    return Objects.equals(this.context, lossPositionList.context) &&
        Objects.equals(this.meta, lossPositionList.meta) &&
        equalsNullable(this.rows, lossPositionList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class LossPositionList {\n");
