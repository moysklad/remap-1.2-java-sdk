 ...
 */
@JsonPropertyOrder({
  ConsignmentList.JSON_PROPERTY_CONTEXT,
  ConsignmentList.JSON_PROPERTY_META,
  ConsignmentList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ConsignmentList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Consignment> rows = new ArrayList<>();

  public ConsignmentList() {
  }

  public ConsignmentList context(@javax.annotation.Nullable Context context) {
  ...
  public ConsignmentList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ConsignmentList rows(@javax.annotation.Nullable List<Consignment> rows) {
  ...
  public ConsignmentList addRowsItem(Consignment rowsItem) {
    if (this.rows == null) {
  ...
  public List<Consignment> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Consignment> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConsignmentList consignmentList = (ConsignmentList) o;
    return Objects.equals(this.context, consignmentList.context) &&
        Objects.equals(this.meta, consignmentList.meta) &&
        Objects.equals(this.rows, consignmentList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConsignmentList {\n");
