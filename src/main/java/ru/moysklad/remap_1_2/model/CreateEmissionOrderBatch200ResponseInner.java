 ...
 */
@JsonPropertyOrder({
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_META,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_ID,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_ACCOUNT_ID,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_CREATED,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_DESCRIPTION,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_DOCUMENT_STATE,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_EMISSION_TYPE,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_EXTERNAL_CODE,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_GROUP,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_MOMENT,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_NAME,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_ORGANIZATION,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_OWNER,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_POSITIONS,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_PRINTED,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_PRODUCTION_TASKS,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_PUBLISHED,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_SHARED,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_STATE,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_TRACKING_TYPE,
  CreateEmissionOrderBatch200ResponseInner.JSON_PROPERTY_UPDATED,
...
public class CreateEmissionOrderBatch200ResponseInner {
  ...
  public CreateEmissionOrderBatch200ResponseInner() {
  }
  /**
  ...
  public CreateEmissionOrderBatch200ResponseInner meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreateEmissionOrderBatch200ResponseInner description(@javax.annotation.Nullable String description) {
  ...
  public CreateEmissionOrderBatch200ResponseInner emissionType(@javax.annotation.Nullable String emissionType) {
  ...
  public CreateEmissionOrderBatch200ResponseInner productionTasks(@javax.annotation.Nullable List<ProductionTask> productionTasks) {
  ...
  public CreateEmissionOrderBatch200ResponseInner shared(@javax.annotation.Nullable Boolean shared) {
  ...
  public CreateEmissionOrderBatch200ResponseInner errors(@javax.annotation.Nonnull List<ErrorErrorsInner> errors) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEmissionOrderBatch200ResponseInner createEmissionOrderBatch200ResponseInner = (CreateEmissionOrderBatch200ResponseInner) o;
    return Objects.equals(this.meta, createEmissionOrderBatch200ResponseInner.meta) &&
        Objects.equals(this.id, createEmissionOrderBatch200ResponseInner.id) &&
        Objects.equals(this.accountId, createEmissionOrderBatch200ResponseInner.accountId) &&
        Objects.equals(this.created, createEmissionOrderBatch200ResponseInner.created) &&
        Objects.equals(this.description, createEmissionOrderBatch200ResponseInner.description) &&
        Objects.equals(this.documentState, createEmissionOrderBatch200ResponseInner.documentState) &&
        Objects.equals(this.emissionType, createEmissionOrderBatch200ResponseInner.emissionType) &&
        Objects.equals(this.externalCode, createEmissionOrderBatch200ResponseInner.externalCode) &&
        Objects.equals(this.group, createEmissionOrderBatch200ResponseInner.group) &&
        Objects.equals(this.moment, createEmissionOrderBatch200ResponseInner.moment) &&
        Objects.equals(this.name, createEmissionOrderBatch200ResponseInner.name) &&
        Objects.equals(this.organization, createEmissionOrderBatch200ResponseInner.organization) &&
        equalsNullable(this.owner, createEmissionOrderBatch200ResponseInner.owner) &&
        Objects.equals(this.positions, createEmissionOrderBatch200ResponseInner.positions) &&
        Objects.equals(this.printed, createEmissionOrderBatch200ResponseInner.printed) &&
        equalsNullable(this.productionTasks, createEmissionOrderBatch200ResponseInner.productionTasks) &&
        Objects.equals(this.published, createEmissionOrderBatch200ResponseInner.published) &&
        Objects.equals(this.shared, createEmissionOrderBatch200ResponseInner.shared) &&
        equalsNullable(this.state, createEmissionOrderBatch200ResponseInner.state) &&
        Objects.equals(this.trackingType, createEmissionOrderBatch200ResponseInner.trackingType) &&
        Objects.equals(this.updated, createEmissionOrderBatch200ResponseInner.updated) &&
        Objects.equals(this.errors, createEmissionOrderBatch200ResponseInner.errors);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, created, description, documentState, emissionType, externalCode, group, moment, name, organization, hashCodeNullable(owner), positions, printed, hashCodeNullable(productionTasks), published, shared, hashCodeNullable(state), trackingType, updated, errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEmissionOrderBatch200ResponseInner {\n");
