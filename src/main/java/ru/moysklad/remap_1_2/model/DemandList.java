 ...
 */
@JsonPropertyOrder({
  DemandList.JSON_PROPERTY_CONTEXT,
  DemandList.JSON_PROPERTY_META,
  DemandList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class DemandList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Demand> rows = new ArrayList<>();

  public DemandList() {
  }

  public DemandList context(@javax.annotation.Nullable Context context) {
  ...
  public DemandList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public DemandList rows(@javax.annotation.Nullable List<Demand> rows) {
  ...
  public DemandList addRowsItem(Demand rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Demand> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    DemandList demandList = (DemandList) o;
    return Objects.equals(this.context, demandList.context) &&
        Objects.equals(this.meta, demandList.meta) &&
        Objects.equals(this.rows, demandList.rows);
  }
