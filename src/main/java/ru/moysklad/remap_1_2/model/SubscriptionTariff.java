 ...
 */
public enum SubscriptionTariff {
  ...
  SubscriptionTariff(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static SubscriptionTariff fromValue(String value) {
    for (SubscriptionTariff b : SubscriptionTariff.values()) {
