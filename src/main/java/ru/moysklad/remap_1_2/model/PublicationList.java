 ...
 */
@JsonPropertyOrder({
  PublicationList.JSON_PROPERTY_CONTEXT,
  PublicationList.JSON_PROPERTY_META,
  PublicationList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class PublicationList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<Publication>> rows = JsonNullable.<List<Publication>>undefined();

  public PublicationList() {
  }

  public PublicationList context(@javax.annotation.Nullable Context context) {
  ...
  public PublicationList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public PublicationList rows(@javax.annotation.Nullable List<Publication> rows) {
    this.rows = JsonNullable.<List<Publication>>of(rows);
    
    return this;
  }


  public PublicationList addRowsItem(Publication rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<Publication>>of(new ArrayList<>());
    }
    try {
  ...
  public JsonNullable<List<Publication>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<Publication>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<Publication> rows) {
    this.rows = JsonNullable.<List<Publication>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, publicationList.context) &&
        Objects.equals(this.meta, publicationList.meta) &&
        equalsNullable(this.rows, publicationList.rows);
  }
