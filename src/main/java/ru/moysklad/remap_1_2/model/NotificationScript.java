 ...
 */
@JsonPropertyOrder({
  NotificationScript.JSON_PROPERTY_EVENT_TYPE,
  NotificationScript.JSON_PROPERTY_ENTITY
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationScript extends NotificationAbstract {
  ...
  @javax.annotation.Nullable
  private NotificationNamedEntity entity;
  ...
  @JsonCreator
  public NotificationScript(
    @JsonProperty(value = JSON_PROPERTY_EVENT_TYPE, required = false) String eventType, 
    @JsonProperty(value = JSON_PROPERTY_ENTITY, required = false) NotificationNamedEntity entity
  ) {
    this();
  ...
  public NotificationNamedEntity getEntity() {
    return entity;
  }
  ...
  public boolean equals(Object o) {
    ...
    NotificationScript notificationScript = (NotificationScript) o;
    return Objects.equals(this.eventType, notificationScript.eventType) &&
        Objects.equals(this.entity, notificationScript.entity);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationScript {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEventType() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%seventType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEventType()), "UTF-8").replaceAll("\\+", "%20")));
