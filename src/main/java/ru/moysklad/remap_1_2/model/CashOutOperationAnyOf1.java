 ...
 */
@JsonPropertyOrder({
  CashOutOperationAnyOf1.JSON_PROPERTY_META,
  CashOutOperationAnyOf1.JSON_PROPERTY_ID,
  CashOutOperationAnyOf1.JSON_PROPERTY_ACCOUNT_ID,
  CashOutOperationAnyOf1.JSON_PROPERTY_NAME,
  CashOutOperationAnyOf1.JSON_PROPERTY_CODE,
  CashOutOperationAnyOf1.JSON_PROPERTY_EXTERNAL_CODE,
  CashOutOperationAnyOf1.JSON_PROPERTY_SYNC_ID,
  CashOutOperationAnyOf1.JSON_PROPERTY_DESCRIPTION,
  CashOutOperationAnyOf1.JSON_PROPERTY_CREATED,
  CashOutOperationAnyOf1.JSON_PROPERTY_DELETED,
  CashOutOperationAnyOf1.JSON_PROPERTY_UPDATED,
  CashOutOperationAnyOf1.JSON_PROPERTY_MOMENT,
...
public class CashOutOperationAnyOf1 {
  ...
  public CashOutOperationAnyOf1 meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CashOutOperationAnyOf1 name(@javax.annotation.Nullable String name) {
  ...
  public CashOutOperationAnyOf1 code(@javax.annotation.Nullable String code) {
  ...
  public CashOutOperationAnyOf1 externalCode(@javax.annotation.Nullable String externalCode) {
  ...
  public CashOutOperationAnyOf1 syncId(@javax.annotation.Nullable UUID syncId) {
  ...
  public CashOutOperationAnyOf1 description(@javax.annotation.Nullable String description) {
  ...
  public CashOutOperationAnyOf1 moment(@javax.annotation.Nullable String moment) {
  ...
  public CashOutOperationAnyOf1 linkedSum(@javax.annotation.Nonnull Double linkedSum) {
  ...
  public boolean equals(Object o) {
    ...
    CashOutOperationAnyOf1 cashOutOperationAnyOf1 = (CashOutOperationAnyOf1) o;
    return Objects.equals(this.meta, cashOutOperationAnyOf1.meta) &&
        Objects.equals(this.id, cashOutOperationAnyOf1.id) &&
        Objects.equals(this.accountId, cashOutOperationAnyOf1.accountId) &&
        Objects.equals(this.name, cashOutOperationAnyOf1.name) &&
        Objects.equals(this.code, cashOutOperationAnyOf1.code) &&
        Objects.equals(this.externalCode, cashOutOperationAnyOf1.externalCode) &&
        Objects.equals(this.syncId, cashOutOperationAnyOf1.syncId) &&
        equalsNullable(this.description, cashOutOperationAnyOf1.description) &&
        Objects.equals(this.created, cashOutOperationAnyOf1.created) &&
        Objects.equals(this.deleted, cashOutOperationAnyOf1.deleted) &&
        Objects.equals(this.updated, cashOutOperationAnyOf1.updated) &&
        Objects.equals(this.moment, cashOutOperationAnyOf1.moment) &&
        Objects.equals(this.linkedSum, cashOutOperationAnyOf1.linkedSum);
  }
  ...
  public String toString() {
    ...
    sb.append("class CashOutOperationAnyOf1 {\n");
