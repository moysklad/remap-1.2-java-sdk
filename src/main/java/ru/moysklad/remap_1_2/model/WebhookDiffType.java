...
public enum WebhookDiffType {
  ...
  @JsonCreator
  public static WebhookDiffType fromValue(String value) {
    for (WebhookDiffType b : WebhookDiffType.values()) {
