...
@JsonPropertyOrder({
  ...
  ProductList.JSON_PROPERTY_META,
  ProductList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProductList implements EntityList {
  ...
  public ProductList context(@javax.annotation.Nullable Context context) {
  ...
  public ProductList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ProductList rows(@javax.annotation.Nullable List<Product> rows) {
  ...
  public ProductList addRowsItem(Product rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Product> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, productList.context) &&
        Objects.equals(this.meta, productList.meta) &&
        Objects.equals(this.rows, productList.rows);
  }
