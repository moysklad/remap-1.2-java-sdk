...
public class RetailDrawerCashOut extends EntityWithMeta {
  ...
  public RetailDrawerCashOut attributes(@javax.annotation.Nullable List<@Valid AttributeAbstract> attributes) {
