 ...
 */
@JsonPropertyOrder({
  SupplyList.JSON_PROPERTY_CONTEXT,
  SupplyList.JSON_PROPERTY_META,
  SupplyList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class SupplyList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Supply> rows = new ArrayList<>();

  public SupplyList() {
  }

  public SupplyList context(@javax.annotation.Nullable Context context) {
  ...
  public SupplyList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public SupplyList rows(@javax.annotation.Nullable List<Supply> rows) {
  ...
  public SupplyList addRowsItem(Supply rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Supply> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    SupplyList supplyList = (SupplyList) o;
    return Objects.equals(this.context, supplyList.context) &&
        Objects.equals(this.meta, supplyList.meta) &&
        Objects.equals(this.rows, supplyList.rows);
  }
