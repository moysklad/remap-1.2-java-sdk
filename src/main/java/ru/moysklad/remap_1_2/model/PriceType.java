 ...
 */
@JsonPropertyOrder({
  PriceType.JSON_PROPERTY_META,
  PriceType.JSON_PROPERTY_ID,
  PriceType.JSON_PROPERTY_NAME,
  PriceType.JSON_PROPERTY_EXTERNAL_CODE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class PriceType extends EntityWithMeta implements MetaEntity {
  public static PriceType createWithMeta(UUID id) {
    PriceType o = new PriceType();
    Meta meta = new Meta();
    meta.setType("pricetype");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "context" + "/" + "companysettings" + "/" + "pricetype" + "/" + id;
    try {
  ...
  public PriceType meta(@javax.annotation.Nullable Meta meta) {
  ...
  public PriceType name(@javax.annotation.Nullable String name) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, priceType.meta) &&
        Objects.equals(this.id, priceType.id) &&
        Objects.equals(this.name, priceType.name) &&
        Objects.equals(this.externalCode, priceType.externalCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, name, externalCode);
  }
