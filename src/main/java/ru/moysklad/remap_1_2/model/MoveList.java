 ...
 */
@JsonPropertyOrder({
  MoveList.JSON_PROPERTY_CONTEXT,
  MoveList.JSON_PROPERTY_META,
  MoveList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class MoveList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<Move>> rows = JsonNullable.<List<Move>>undefined();

  public MoveList() {
  }

  public MoveList context(@javax.annotation.Nullable Context context) {
  ...
  public MoveList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public MoveList rows(@javax.annotation.Nullable List<Move> rows) {
    this.rows = JsonNullable.<List<Move>>of(rows);
    
    return this;
  }


  public MoveList addRowsItem(Move rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<Move>>of(new ArrayList<>());
    }
    try {
  ...
  public JsonNullable<List<Move>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<Move>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<Move> rows) {
    this.rows = JsonNullable.<List<Move>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    MoveList moveList = (MoveList) o;
    return Objects.equals(this.context, moveList.context) &&
        Objects.equals(this.meta, moveList.meta) &&
        equalsNullable(this.rows, moveList.rows);
  }
