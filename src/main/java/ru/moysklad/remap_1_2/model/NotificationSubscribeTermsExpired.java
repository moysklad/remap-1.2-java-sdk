 ...
 */
@JsonPropertyOrder({
  NotificationSubscribeTermsExpired.JSON_PROPERTY_DAYS_LEFT
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationSubscribeTermsExpired extends NotificationAbstract {

  public static final String JSON_PROPERTY_DAYS_LEFT = "daysLeft";
  @javax.annotation.Nullable
  private Integer daysLeft;

  public NotificationSubscribeTermsExpired() {
  }

  public NotificationSubscribeTermsExpired daysLeft(@javax.annotation.Nullable Integer daysLeft) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationSubscribeTermsExpired notificationSubscribeTermsExpired = (NotificationSubscribeTermsExpired) o;
    return Objects.equals(this.daysLeft, notificationSubscribeTermsExpired.daysLeft);
  }

  @Override
  public int hashCode() {
    return Objects.hash(daysLeft);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NotificationSubscribeTermsExpired {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `daysLeft` to the URL query string
    if (getDaysLeft() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%sdaysLeft%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDaysLeft()), "UTF-8").replaceAll("\\+", "%20")));
