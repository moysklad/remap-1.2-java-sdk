...
import ru.moysklad.remap_1_2.model.RetailShiftPaymentOperationAnyOf;
import ru.moysklad.remap_1_2.model.RetailShiftPaymentOperationAnyOf1;
 ...
 */
@JsonPropertyOrder({
  RetailShiftPaymentOperation.JSON_PROPERTY_META,
  RetailShiftPaymentOperation.JSON_PROPERTY_ID,
  RetailShiftPaymentOperation.JSON_PROPERTY_ACCOUNT_ID,
  RetailShiftPaymentOperation.JSON_PROPERTY_APPLICABLE,
  RetailShiftPaymentOperation.JSON_PROPERTY_NAME,
  RetailShiftPaymentOperation.JSON_PROPERTY_CODE,
  RetailShiftPaymentOperation.JSON_PROPERTY_EXTERNAL_CODE,
  RetailShiftPaymentOperation.JSON_PROPERTY_SYNC_ID,
  RetailShiftPaymentOperation.JSON_PROPERTY_DESCRIPTION,
  RetailShiftPaymentOperation.JSON_PROPERTY_CREATED,
  RetailShiftPaymentOperation.JSON_PROPERTY_DELETED,
  RetailShiftPaymentOperation.JSON_PROPERTY_UPDATED,
  RetailShiftPaymentOperation.JSON_PROPERTY_MOMENT,
  RetailShiftPaymentOperation.JSON_PROPERTY_ATTRIBUTES,
  RetailShiftPaymentOperation.JSON_PROPERTY_CONTRACT,
  RetailShiftPaymentOperation.JSON_PROPERTY_FILES,
  RetailShiftPaymentOperation.JSON_PROPERTY_PAYMENT_PURPOSE,
  RetailShiftPaymentOperation.JSON_PROPERTY_PRINTED,
  RetailShiftPaymentOperation.JSON_PROPERTY_PROJECT,
  RetailShiftPaymentOperation.JSON_PROPERTY_PUBLISHED,
  RetailShiftPaymentOperation.JSON_PROPERTY_OWNER,
  RetailShiftPaymentOperation.JSON_PROPERTY_GROUP,
  RetailShiftPaymentOperation.JSON_PROPERTY_SALES_CHANNEL,
  RetailShiftPaymentOperation.JSON_PROPERTY_SHARED,
  RetailShiftPaymentOperation.JSON_PROPERTY_STATE,
  RetailShiftPaymentOperation.JSON_PROPERTY_RATE,
  RetailShiftPaymentOperation.JSON_PROPERTY_ORGANIZATION,
  RetailShiftPaymentOperation.JSON_PROPERTY_AGENT,
  RetailShiftPaymentOperation.JSON_PROPERTY_SUM,
  RetailShiftPaymentOperation.JSON_PROPERTY_VAT_SUM,
  RetailShiftPaymentOperation.JSON_PROPERTY_FACTURE_OUT,
  RetailShiftPaymentOperation.JSON_PROPERTY_OPERATIONS,
  RetailShiftPaymentOperation.JSON_PROPERTY_LINKED_SUM,
  RetailShiftPaymentOperation.JSON_PROPERTY_AGENT_ACCOUNT,
  RetailShiftPaymentOperation.JSON_PROPERTY_ORGANIZATION_ACCOUNT,
  RetailShiftPaymentOperation.JSON_PROPERTY_INCOMING_NUMBER,
  RetailShiftPaymentOperation.JSON_PROPERTY_INCOMING_DATE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-07-06T06:01:46.826243949Z[GMT]", comments = "Generator version: 7.14.0")
public class RetailShiftPaymentOperation {
  ...
  public RetailShiftPaymentOperation() {
  }
  /**
  ...
  public RetailShiftPaymentOperation meta(@javax.annotation.Nullable Meta meta) {
  ...
  public RetailShiftPaymentOperation applicable(@javax.annotation.Nullable Boolean applicable) {
  ...
  public RetailShiftPaymentOperation name(@javax.annotation.Nullable String name) {
 ...
 @Size(max=255)
  ...
  public RetailShiftPaymentOperation code(@javax.annotation.Nullable String code) {
 ...
 @Size(max=255)
  ...
  public RetailShiftPaymentOperation externalCode(@javax.annotation.Nullable String externalCode) {
 ...
 @Size(max=255)
  ...
  public RetailShiftPaymentOperation syncId(@javax.annotation.Nullable UUID syncId) {
  ...
  public RetailShiftPaymentOperation description(@javax.annotation.Nullable String description) {
 ...
 @Size(max=4096)
  ...
  public RetailShiftPaymentOperation moment(@javax.annotation.Nullable String moment) {
  ...
  public RetailShiftPaymentOperation attributes(@javax.annotation.Nullable List<@Valid AttributeAbstract> attributes) {
  ...
  public RetailShiftPaymentOperation addAttributesItem(AttributeAbstract attributesItem) {
  ...
  public RetailShiftPaymentOperation contract(@javax.annotation.Nullable Contract contract) {
  ...
  public RetailShiftPaymentOperation files(@javax.annotation.Nullable FileList files) {
  ...
  public RetailShiftPaymentOperation paymentPurpose(@javax.annotation.Nullable String paymentPurpose) {
 ...
 @Size(max=255)
  ...
  public RetailShiftPaymentOperation project(@javax.annotation.Nullable Project project) {
  ...
  public RetailShiftPaymentOperation owner(@javax.annotation.Nullable Employee owner) {
  ...
  public RetailShiftPaymentOperation group(@javax.annotation.Nullable Group group) {
  ...
  public RetailShiftPaymentOperation salesChannel(@javax.annotation.Nullable SalesChannel salesChannel) {
  ...
  public RetailShiftPaymentOperation state(@javax.annotation.Nullable State state) {
  ...
  public RetailShiftPaymentOperation rate(@javax.annotation.Nullable CurrencyRate rate) {
  ...
  public RetailShiftPaymentOperation organization(@javax.annotation.Nullable Organization organization) {
  ...
  public RetailShiftPaymentOperation agent(@javax.annotation.Nullable Agent agent) {
 ...
 @DecimalMin("0")
  ...
  public RetailShiftPaymentOperation factureOut(@javax.annotation.Nullable FactureOut factureOut) {
  ...
  public RetailShiftPaymentOperation operations(@javax.annotation.Nullable List<@Valid FinanceInOperationAbstract> operations) {
  ...
  public RetailShiftPaymentOperation addOperationsItem(FinanceInOperationAbstract operationsItem) {
  ...
  public RetailShiftPaymentOperation linkedSum(@javax.annotation.Nonnull Double linkedSum) {
  ...
  public RetailShiftPaymentOperation agentAccount(@javax.annotation.Nullable Account agentAccount) {
  ...
  public RetailShiftPaymentOperation organizationAccount(@javax.annotation.Nullable Account organizationAccount) {
  ...
  public RetailShiftPaymentOperation incomingNumber(@javax.annotation.Nullable String incomingNumber) {
 ...
 @Size(max=255)
  ...
  public RetailShiftPaymentOperation incomingDate(@javax.annotation.Nullable String incomingDate) {
  ...
  public boolean equals(Object o) {
    ...
    RetailShiftPaymentOperation retailShiftPaymentOperation = (RetailShiftPaymentOperation) o;
    return Objects.equals(this.meta, retailShiftPaymentOperation.meta) &&
        Objects.equals(this.id, retailShiftPaymentOperation.id) &&
        Objects.equals(this.accountId, retailShiftPaymentOperation.accountId) &&
        Objects.equals(this.applicable, retailShiftPaymentOperation.applicable) &&
        Objects.equals(this.name, retailShiftPaymentOperation.name) &&
        Objects.equals(this.code, retailShiftPaymentOperation.code) &&
        Objects.equals(this.externalCode, retailShiftPaymentOperation.externalCode) &&
        Objects.equals(this.syncId, retailShiftPaymentOperation.syncId) &&
        equalsNullable(this.description, retailShiftPaymentOperation.description) &&
        Objects.equals(this.created, retailShiftPaymentOperation.created) &&
        Objects.equals(this.deleted, retailShiftPaymentOperation.deleted) &&
        Objects.equals(this.updated, retailShiftPaymentOperation.updated) &&
        Objects.equals(this.moment, retailShiftPaymentOperation.moment) &&
        equalsNullable(this.attributes, retailShiftPaymentOperation.attributes) &&
        equalsNullable(this.contract, retailShiftPaymentOperation.contract) &&
        equalsNullable(this.files, retailShiftPaymentOperation.files) &&
        Objects.equals(this.paymentPurpose, retailShiftPaymentOperation.paymentPurpose) &&
        Objects.equals(this.printed, retailShiftPaymentOperation.printed) &&
        equalsNullable(this.project, retailShiftPaymentOperation.project) &&
        Objects.equals(this.published, retailShiftPaymentOperation.published) &&
        equalsNullable(this.owner, retailShiftPaymentOperation.owner) &&
        Objects.equals(this.group, retailShiftPaymentOperation.group) &&
        equalsNullable(this.salesChannel, retailShiftPaymentOperation.salesChannel) &&
        Objects.equals(this.shared, retailShiftPaymentOperation.shared) &&
        equalsNullable(this.state, retailShiftPaymentOperation.state) &&
        Objects.equals(this.rate, retailShiftPaymentOperation.rate) &&
        Objects.equals(this.organization, retailShiftPaymentOperation.organization) &&
        Objects.equals(this.agent, retailShiftPaymentOperation.agent) &&
        Objects.equals(this.sum, retailShiftPaymentOperation.sum) &&
        Objects.equals(this.vatSum, retailShiftPaymentOperation.vatSum) &&
        equalsNullable(this.factureOut, retailShiftPaymentOperation.factureOut) &&
        equalsNullable(this.operations, retailShiftPaymentOperation.operations) &&
        Objects.equals(this.linkedSum, retailShiftPaymentOperation.linkedSum) &&
        equalsNullable(this.agentAccount, retailShiftPaymentOperation.agentAccount) &&
        equalsNullable(this.organizationAccount, retailShiftPaymentOperation.organizationAccount) &&
        equalsNullable(this.incomingNumber, retailShiftPaymentOperation.incomingNumber) &&
        equalsNullable(this.incomingDate, retailShiftPaymentOperation.incomingDate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, applicable, name, code, externalCode, syncId, hashCodeNullable(description), created, deleted, updated, moment, hashCodeNullable(attributes), hashCodeNullable(contract), hashCodeNullable(files), paymentPurpose, printed, hashCodeNullable(project), published, hashCodeNullable(owner), group, hashCodeNullable(salesChannel), shared, hashCodeNullable(state), rate, organization, agent, sum, vatSum, hashCodeNullable(factureOut), hashCodeNullable(operations), linkedSum, hashCodeNullable(agentAccount), hashCodeNullable(organizationAccount), hashCodeNullable(incomingNumber), hashCodeNullable(incomingDate));
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailShiftPaymentOperation {\n");
