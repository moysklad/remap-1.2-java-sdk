...
@OpenApiPolymorphicSubTypes({
  @OpenApiPolymorphicSubTypes.Type(value = RetailShiftPaymentOperationCashIn.class, name = "cashin"),
  @OpenApiPolymorphicSubTypes.Type(value = RetailShiftPaymentOperationPaymentIn.class, name = "paymentin")
})
...
public class RetailShiftPaymentOperation {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.linkedSum, retailShiftPaymentOperation.linkedSum);
  }
