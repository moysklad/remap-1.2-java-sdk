 ...
 */
@JsonPropertyOrder({
  BundleComponentList.JSON_PROPERTY_CONTEXT,
  BundleComponentList.JSON_PROPERTY_META,
  BundleComponentList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-07-16T11:58:06.724471822Z[GMT]", comments = "Generator version: 7.14.0")
public class BundleComponentList {
  ...
  @javax.annotation.Nullable
  private List<@Valid BundleComponent> rows = new ArrayList<>();

  public BundleComponentList() {
  }

  public BundleComponentList context(@javax.annotation.Nullable Context context) {
  ...
  public BundleComponentList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public BundleComponentList rows(@javax.annotation.Nullable List<@Valid BundleComponent> rows) {
  ...
  public BundleComponentList addRowsItem(BundleComponent rowsItem) {
    if (this.rows == null) {
  ...
  public List<@Valid BundleComponent> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<@Valid BundleComponent> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    BundleComponentList bundleComponentList = (BundleComponentList) o;
    return Objects.equals(this.context, bundleComponentList.context) &&
        Objects.equals(this.meta, bundleComponentList.meta) &&
        Objects.equals(this.rows, bundleComponentList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class BundleComponentList {\n");
