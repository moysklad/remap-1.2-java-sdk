 ...
 */
@JsonPropertyOrder({
  GetCounterpartyNotes200Response.JSON_PROPERTY_META,
  GetCounterpartyNotes200Response.JSON_PROPERTY_ROWS
})
@JsonTypeName("getCounterpartyNotes_200_response")
...
public class GetCounterpartyNotes200Response {
  ...
  @javax.annotation.Nullable
  private List<@Valid Note> rows = new ArrayList<>();

  public GetCounterpartyNotes200Response() {
  }

  public GetCounterpartyNotes200Response meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public GetCounterpartyNotes200Response rows(@javax.annotation.Nullable List<@Valid Note> rows) {
  ...
  public GetCounterpartyNotes200Response addRowsItem(Note rowsItem) {
    if (this.rows == null) {
  ...
  public List<@Valid Note> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<@Valid Note> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetCounterpartyNotes200Response getCounterpartyNotes200Response = (GetCounterpartyNotes200Response) o;
    return Objects.equals(this.meta, getCounterpartyNotes200Response.meta) &&
        Objects.equals(this.rows, getCounterpartyNotes200Response.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCounterpartyNotes200Response {\n");
