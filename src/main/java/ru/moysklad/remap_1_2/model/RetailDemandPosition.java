 ...
 */
@JsonPropertyOrder({
  RetailDemandPosition.JSON_PROPERTY_META,
  RetailDemandPosition.JSON_PROPERTY_ID,
  RetailDemandPosition.JSON_PROPERTY_ACCOUNT_ID,
  RetailDemandPosition.JSON_PROPERTY_ASSORTMENT,
  RetailDemandPosition.JSON_PROPERTY_COST,
  RetailDemandPosition.JSON_PROPERTY_DECLARATION,
  RetailDemandPosition.JSON_PROPERTY_DISCOUNT,
  RetailDemandPosition.JSON_PROPERTY_PACK,
  RetailDemandPosition.JSON_PROPERTY_PRICE,
  RetailDemandPosition.JSON_PROPERTY_QUANTITY,
  RetailDemandPosition.JSON_PROPERTY_THINGS,
...
public class RetailDemandPosition {
  public static RetailDemandPosition createWithMeta(UUID parentId, UUID id) {
    ...
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "retaildemand" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public RetailDemandPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public RetailDemandPosition assortment(@javax.annotation.Nullable ProductMarker assortment) {
 ...
 @Min(0)
  ...
  public RetailDemandPosition discount(@javax.annotation.Nullable Double discount) {
 ...
 @DecimalMax("100")
  ...
  public RetailDemandPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public RetailDemandPosition price(@javax.annotation.Nullable Double price) {
 ...
 @DecimalMin("0")
  ...
  public RetailDemandPosition quantity(@javax.annotation.Nullable Double quantity) {
 ...
 @DecimalMin(value="0.00010",inclusive=false)
  ...
  public RetailDemandPosition things(@javax.annotation.Nullable List<String> things) {
  ...
  public RetailDemandPosition addThingsItem(String thingsItem) {
    if (this.things == null) {
  ...
  public RetailDemandPosition vat(@javax.annotation.Nullable Integer vat) {
  ...
  public RetailDemandPosition vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    RetailDemandPosition retailDemandPosition = (RetailDemandPosition) o;
    return Objects.equals(this.meta, retailDemandPosition.meta) &&
        Objects.equals(this.id, retailDemandPosition.id) &&
        Objects.equals(this.accountId, retailDemandPosition.accountId) &&
        Objects.equals(this.assortment, retailDemandPosition.assortment) &&
        Objects.equals(this.cost, retailDemandPosition.cost) &&
        Objects.equals(this.declaration, retailDemandPosition.declaration) &&
        Objects.equals(this.discount, retailDemandPosition.discount) &&
        equalsNullable(this.pack, retailDemandPosition.pack) &&
        Objects.equals(this.price, retailDemandPosition.price) &&
        Objects.equals(this.quantity, retailDemandPosition.quantity) &&
        Objects.equals(this.things, retailDemandPosition.things) &&
        Objects.equals(this.vat, retailDemandPosition.vat) &&
        Objects.equals(this.vatEnabled, retailDemandPosition.vatEnabled);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, assortment, cost, declaration, discount, hashCodeNullable(pack), price, quantity, things, vat, vatEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailDemandPosition {\n");
