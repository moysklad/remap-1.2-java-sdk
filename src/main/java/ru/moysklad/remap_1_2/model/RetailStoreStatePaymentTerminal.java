...
public class RetailStoreStatePaymentTerminal {
  ...
  public RetailStoreStatePaymentTerminal() {
  }

  public RetailStoreStatePaymentTerminal acquiringType(@javax.annotation.Nullable String acquiringType) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ACQUIRING_TYPE)
  ...
  public boolean equals(Object o) {
    ...
    RetailStoreStatePaymentTerminal retailStoreStatePaymentTerminal = (RetailStoreStatePaymentTerminal) o;
    return Objects.equals(this.acquiringType, retailStoreStatePaymentTerminal.acquiringType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acquiringType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RetailStoreStatePaymentTerminal {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `acquiringType` to the URL query string
    if (getAcquiringType() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%sacquiringType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAcquiringType()), "UTF-8").replaceAll("\\+", "%20")));
