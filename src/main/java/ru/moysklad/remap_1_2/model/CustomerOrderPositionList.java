...
public class CustomerOrderPositionList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<CustomerOrderPosition>> rows = JsonNullable.<List<CustomerOrderPosition>>undefined();

  public CustomerOrderPositionList() {
  }

  public CustomerOrderPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public CustomerOrderPositionList rows(@javax.annotation.Nullable List<CustomerOrderPosition> rows) {
    this.rows = JsonNullable.<List<CustomerOrderPosition>>of(rows);
  ...
  public CustomerOrderPositionList addRowsItem(CustomerOrderPosition rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<CustomerOrderPosition>>of(new ArrayList<>());
    }
    try {
  ...
  public List<CustomerOrderPosition> getRows() {
  ...
  public JsonNullable<List<CustomerOrderPosition>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<CustomerOrderPosition>> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    CustomerOrderPositionList customerOrderPositionList = (CustomerOrderPositionList) o;
    return Objects.equals(this.context, customerOrderPositionList.context) &&
        Objects.equals(this.meta, customerOrderPositionList.meta) &&
        equalsNullable(this.rows, customerOrderPositionList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomerOrderPositionList {\n");
