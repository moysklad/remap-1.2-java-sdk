 ...
 */
@JsonPropertyOrder({
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_META,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_ID,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_ACCOUNT_ID,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_QUANTITY,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_PRICE,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_DISCOUNT,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_SHIPPED,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_IN_TRANSIT,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_VAT,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_VAT_ENABLED,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_ASSORTMENT,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_PACK,
  CreatePurchaseOrderPositions200ResponseInner.JSON_PROPERTY_STOCK,
...
public class CreatePurchaseOrderPositions200ResponseInner {
  ...
  public CreatePurchaseOrderPositions200ResponseInner() {
  }
  /**
  ...
  public CreatePurchaseOrderPositions200ResponseInner meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreatePurchaseOrderPositions200ResponseInner id(@javax.annotation.Nullable UUID id) {
  ...
  public CreatePurchaseOrderPositions200ResponseInner quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public CreatePurchaseOrderPositions200ResponseInner vat(@javax.annotation.Nullable Integer vat) {
  ...
  public CreatePurchaseOrderPositions200ResponseInner errors(@javax.annotation.Nonnull List<Error> errors) {
  ...
  public CreatePurchaseOrderPositions200ResponseInner addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreatePurchaseOrderPositions200ResponseInner createPurchaseOrderPositions200ResponseInner = (CreatePurchaseOrderPositions200ResponseInner) o;
    return Objects.equals(this.meta, createPurchaseOrderPositions200ResponseInner.meta) &&
        Objects.equals(this.id, createPurchaseOrderPositions200ResponseInner.id) &&
        Objects.equals(this.accountId, createPurchaseOrderPositions200ResponseInner.accountId) &&
        Objects.equals(this.quantity, createPurchaseOrderPositions200ResponseInner.quantity) &&
        Objects.equals(this.price, createPurchaseOrderPositions200ResponseInner.price) &&
        Objects.equals(this.discount, createPurchaseOrderPositions200ResponseInner.discount) &&
        Objects.equals(this.shipped, createPurchaseOrderPositions200ResponseInner.shipped) &&
        Objects.equals(this.inTransit, createPurchaseOrderPositions200ResponseInner.inTransit) &&
        Objects.equals(this.vat, createPurchaseOrderPositions200ResponseInner.vat) &&
        Objects.equals(this.vatEnabled, createPurchaseOrderPositions200ResponseInner.vatEnabled) &&
        Objects.equals(this.assortment, createPurchaseOrderPositions200ResponseInner.assortment) &&
        equalsNullable(this.pack, createPurchaseOrderPositions200ResponseInner.pack) &&
        equalsNullable(this.stock, createPurchaseOrderPositions200ResponseInner.stock) &&
        Objects.equals(this.errors, createPurchaseOrderPositions200ResponseInner.errors);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, quantity, price, discount, shipped, inTransit, vat, vatEnabled, assortment, hashCodeNullable(pack), hashCodeNullable(stock), errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePurchaseOrderPositions200ResponseInner {\n");
