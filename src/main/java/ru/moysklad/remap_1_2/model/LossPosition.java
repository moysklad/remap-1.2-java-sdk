 ...
 */
@JsonPropertyOrder({
  LossPosition.JSON_PROPERTY_META,
  LossPosition.JSON_PROPERTY_ID,
  LossPosition.JSON_PROPERTY_ACCOUNT_ID,
  LossPosition.JSON_PROPERTY_ASSORTMENT,
  LossPosition.JSON_PROPERTY_DECLARATION,
  LossPosition.JSON_PROPERTY_PACK,
  LossPosition.JSON_PROPERTY_PRICE,
  LossPosition.JSON_PROPERTY_QUANTITY,
  LossPosition.JSON_PROPERTY_REASON,
...
public class LossPosition extends EntityWithMeta implements DocumentPosition, MetaEntity {
  public static LossPosition createWithMeta(UUID parentId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("lossposition");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "loss" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public LossPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public LossPosition assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public LossPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public LossPosition price(@javax.annotation.Nullable Double price) {
  ...
  public LossPosition quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public LossPosition reason(@javax.annotation.Nullable String reason) {
  ...
  public LossPosition slot(@javax.annotation.Nullable StoreSlot slot) {
  ...
  public LossPosition things(@javax.annotation.Nullable List<String> things) {
  ...
  public LossPosition addThingsItem(String thingsItem) {
    if (this.things == null) {
  ...
  public boolean equals(Object o) {
    ...
    LossPosition lossPosition = (LossPosition) o;
    return Objects.equals(this.meta, lossPosition.meta) &&
        Objects.equals(this.id, lossPosition.id) &&
        Objects.equals(this.accountId, lossPosition.accountId) &&
        Objects.equals(this.assortment, lossPosition.assortment) &&
        Objects.equals(this.declaration, lossPosition.declaration) &&
        equalsNullable(this.pack, lossPosition.pack) &&
        Objects.equals(this.price, lossPosition.price) &&
        Objects.equals(this.quantity, lossPosition.quantity) &&
        Objects.equals(this.reason, lossPosition.reason) &&
        equalsNullable(this.slot, lossPosition.slot) &&
        Objects.equals(this.things, lossPosition.things);
  }
