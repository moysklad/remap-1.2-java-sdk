 ...
 */
@JsonPropertyOrder({
  StoreSlot.JSON_PROPERTY_META,
  StoreSlot.JSON_PROPERTY_ID,
  StoreSlot.JSON_PROPERTY_ACCOUNT_ID,
  StoreSlot.JSON_PROPERTY_UPDATED,
  StoreSlot.JSON_PROPERTY_NAME,
  StoreSlot.JSON_PROPERTY_EXTERNAL_CODE,
...
public class StoreSlot {
  public static StoreSlot createWithMeta(UUID parentId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("slot");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "store" + "/" + parentId + "/" + "slots" + "/" + id;
    try {
  ...
  public StoreSlot meta(@javax.annotation.Nullable Meta meta) {
  ...
  public StoreSlot name(@javax.annotation.Nullable String name) {
  ...
  public boolean equals(Object o) {
    ...
    StoreSlot storeSlot = (StoreSlot) o;
    return Objects.equals(this.meta, storeSlot.meta) &&
        Objects.equals(this.id, storeSlot.id) &&
        Objects.equals(this.accountId, storeSlot.accountId) &&
        Objects.equals(this.updated, storeSlot.updated) &&
        Objects.equals(this.name, storeSlot.name) &&
        Objects.equals(this.externalCode, storeSlot.externalCode) &&
        Objects.equals(this.barcode, storeSlot.barcode) &&
        Objects.equals(this.zone, storeSlot.zone);
  }
