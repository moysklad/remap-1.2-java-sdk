 ...
 */
@JsonPropertyOrder({
  NotificationTaskReopened.JSON_PROPERTY_PERFORMED_BY,
  NotificationTaskReopened.JSON_PROPERTY_TASK
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationTaskReopened extends NotificationAbstract {
  ...
  public NotificationTaskReopened() {
  }

  public NotificationTaskReopened performedBy(@javax.annotation.Nullable NotificationNamedEntity performedBy) {
  ...
  public NotificationTaskReopened task(@javax.annotation.Nullable NotificationTask task) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationTaskReopened notificationTaskReopened = (NotificationTaskReopened) o;
    return Objects.equals(this.performedBy, notificationTaskReopened.performedBy) &&
        Objects.equals(this.task, notificationTaskReopened.task);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationTaskReopened {\n");
