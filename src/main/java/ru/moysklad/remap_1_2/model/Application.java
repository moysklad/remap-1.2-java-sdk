...
public class Application implements MetaEntity {
  public static Application createWithMeta(UUID id) {
    Application o = new Application();
    Meta meta = new Meta();
    meta.setType("application");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "application" + "/" + id;
    try {
