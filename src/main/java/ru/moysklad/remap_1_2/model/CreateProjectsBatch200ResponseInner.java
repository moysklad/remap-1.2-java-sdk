 ...
 */
@JsonPropertyOrder({
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_META,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_ID,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_ACCOUNT_ID,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_ARCHIVED,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_ATTRIBUTES,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_CODE,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_DESCRIPTION,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_EXTERNAL_CODE,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_GROUP,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_NAME,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_OWNER,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_SHARED,
  CreateProjectsBatch200ResponseInner.JSON_PROPERTY_UPDATED,
...
public class CreateProjectsBatch200ResponseInner {
  ...
  public CreateProjectsBatch200ResponseInner() {
  }
  /**
  ...
  public CreateProjectsBatch200ResponseInner meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreateProjectsBatch200ResponseInner archived(@javax.annotation.Nullable Boolean archived) {
  ...
  public CreateProjectsBatch200ResponseInner errors(@javax.annotation.Nonnull List<ErrorErrorsInner> errors) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProjectsBatch200ResponseInner createProjectsBatch200ResponseInner = (CreateProjectsBatch200ResponseInner) o;
    return Objects.equals(this.meta, createProjectsBatch200ResponseInner.meta) &&
        Objects.equals(this.id, createProjectsBatch200ResponseInner.id) &&
        Objects.equals(this.accountId, createProjectsBatch200ResponseInner.accountId) &&
        Objects.equals(this.archived, createProjectsBatch200ResponseInner.archived) &&
        equalsNullable(this.attributes, createProjectsBatch200ResponseInner.attributes) &&
        Objects.equals(this.code, createProjectsBatch200ResponseInner.code) &&
        Objects.equals(this.description, createProjectsBatch200ResponseInner.description) &&
        Objects.equals(this.externalCode, createProjectsBatch200ResponseInner.externalCode) &&
        Objects.equals(this.group, createProjectsBatch200ResponseInner.group) &&
        Objects.equals(this.name, createProjectsBatch200ResponseInner.name) &&
        equalsNullable(this.owner, createProjectsBatch200ResponseInner.owner) &&
        Objects.equals(this.shared, createProjectsBatch200ResponseInner.shared) &&
        Objects.equals(this.updated, createProjectsBatch200ResponseInner.updated) &&
        Objects.equals(this.errors, createProjectsBatch200ResponseInner.errors);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, archived, hashCodeNullable(attributes), code, description, externalCode, group, name, hashCodeNullable(owner), shared, updated, errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateProjectsBatch200ResponseInner {\n");
