 ...
 */
@JsonPropertyOrder({
  ProductFolder.JSON_PROPERTY_META,
  ProductFolder.JSON_PROPERTY_ID,
  ProductFolder.JSON_PROPERTY_ACCOUNT_ID,
  ProductFolder.JSON_PROPERTY_NAME,
  ProductFolder.JSON_PROPERTY_CODE,
  ProductFolder.JSON_PROPERTY_EXTERNAL_CODE,
  ProductFolder.JSON_PROPERTY_ARCHIVED,
  ProductFolder.JSON_PROPERTY_PATH_NAME,
  ProductFolder.JSON_PROPERTY_DESCRIPTION,
  ProductFolder.JSON_PROPERTY_VAT,
  ProductFolder.JSON_PROPERTY_VAT_ENABLED,
  ProductFolder.JSON_PROPERTY_EFFECTIVE_VAT,
  ProductFolder.JSON_PROPERTY_EFFECTIVE_VAT_ENABLED,
  ProductFolder.JSON_PROPERTY_USE_PARENT_VAT,
  ProductFolder.JSON_PROPERTY_SHARED,
  ProductFolder.JSON_PROPERTY_GROUP,
  ProductFolder.JSON_PROPERTY_OWNER,
  ProductFolder.JSON_PROPERTY_UPDATED,
...
public class ProductFolder {
  public static ProductFolder createWithMeta(UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("productfolder");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "productfolder" + "/" + id;
    try {
  ...
  public ProductFolder meta(@javax.annotation.Nullable Meta meta) {
  ...
  public ProductFolder name(@javax.annotation.Nullable String name) {
  ...
  public ProductFolder description(@javax.annotation.Nullable String description) {
  ...
  public ProductFolder useParentVat(@javax.annotation.Nullable Boolean useParentVat) {
  ...
  public ProductFolder productFolder(@javax.annotation.Nullable ProductFolder productFolder) {
  ...
  public boolean equals(Object o) {
    ...
    ProductFolder productFolder = (ProductFolder) o;
    return Objects.equals(this.meta, productFolder.meta) &&
        Objects.equals(this.id, productFolder.id) &&
        Objects.equals(this.accountId, productFolder.accountId) &&
        Objects.equals(this.name, productFolder.name) &&
        Objects.equals(this.code, productFolder.code) &&
        Objects.equals(this.externalCode, productFolder.externalCode) &&
        Objects.equals(this.archived, productFolder.archived) &&
        Objects.equals(this.pathName, productFolder.pathName) &&
        equalsNullable(this.description, productFolder.description) &&
        Objects.equals(this.vat, productFolder.vat) &&
        Objects.equals(this.vatEnabled, productFolder.vatEnabled) &&
        Objects.equals(this.effectiveVat, productFolder.effectiveVat) &&
        Objects.equals(this.effectiveVatEnabled, productFolder.effectiveVatEnabled) &&
        Objects.equals(this.useParentVat, productFolder.useParentVat) &&
        Objects.equals(this.shared, productFolder.shared) &&
        Objects.equals(this.group, productFolder.group) &&
        equalsNullable(this.owner, productFolder.owner) &&
        Objects.equals(this.updated, productFolder.updated) &&
        equalsNullable(this.productFolder, productFolder.productFolder) &&
        Objects.equals(this.taxSystem, productFolder.taxSystem);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, name, code, externalCode, archived, pathName, hashCodeNullable(description), vat, vatEnabled, effectiveVat, effectiveVatEnabled, useParentVat, shared, group, hashCodeNullable(owner), updated, hashCodeNullable(productFolder), taxSystem);
  }
