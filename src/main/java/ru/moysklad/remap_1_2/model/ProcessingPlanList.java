...
public class ProcessingPlanList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<ProcessingPlan>> rows = JsonNullable.<List<ProcessingPlan>>undefined();

  public ProcessingPlanList() {
  }

  public ProcessingPlanList context(@javax.annotation.Nullable Context context) {
  ...
  public ProcessingPlanList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ProcessingPlanList rows(@javax.annotation.Nullable List<ProcessingPlan> rows) {
    this.rows = JsonNullable.<List<ProcessingPlan>>of(rows);
    
    return this;
  }


  public ProcessingPlanList addRowsItem(ProcessingPlan rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<ProcessingPlan>>of(new ArrayList<>());
    }
    try {
  ...
  public List<ProcessingPlan> getRows() {
  ...
  public JsonNullable<List<ProcessingPlan>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<ProcessingPlan>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<ProcessingPlan> rows) {
    this.rows = JsonNullable.<List<ProcessingPlan>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessingPlanList processingPlanList = (ProcessingPlanList) o;
    return Objects.equals(this.context, processingPlanList.context) &&
        Objects.equals(this.meta, processingPlanList.meta) &&
        equalsNullable(this.rows, processingPlanList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingPlanList {\n");
