...
public class ByOperationsReserveList {
  ...
  @javax.annotation.Nullable
  private List<ByOperationsReserve> rows = new ArrayList<>();
  ...
  public ByOperationsReserveList rows(@javax.annotation.Nullable List<ByOperationsReserve> rows) {
  ...
  public List<ByOperationsReserve> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<ByOperationsReserve> rows) {
    this.rows = rows;
  }
