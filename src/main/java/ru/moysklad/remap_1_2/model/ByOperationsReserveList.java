...
import ru.moysklad.remap_1_2.model.ByOperationsReserve;
 ...
 */
@JsonPropertyOrder({
  ByOperationsReserveList.JSON_PROPERTY_CONTEXT,
  ByOperationsReserveList.JSON_PROPERTY_META,
  ByOperationsReserveList.JSON_PROPERTY_ROWS
})
...
public class ByOperationsReserveList {
  ...
  @javax.annotation.Nullable
  private List<@Valid ByOperationsReserve> rows = new ArrayList<>();

  public ByOperationsReserveList() {
  }

  public ByOperationsReserveList context(@javax.annotation.Nullable Context context) {
  ...
  public ByOperationsReserveList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ByOperationsReserveList rows(@javax.annotation.Nullable List<@Valid ByOperationsReserve> rows) {
  ...
  public ByOperationsReserveList addRowsItem(ByOperationsReserve rowsItem) {
    if (this.rows == null) {
  ...
  public List<@Valid ByOperationsReserve> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<@Valid ByOperationsReserve> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ByOperationsReserveList byOperationsReserveList = (ByOperationsReserveList) o;
    return Objects.equals(this.context, byOperationsReserveList.context) &&
        Objects.equals(this.meta, byOperationsReserveList.meta) &&
        Objects.equals(this.rows, byOperationsReserveList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ByOperationsReserveList {\n");
