 ...
 */
@JsonPropertyOrder({
  SalesChannel.JSON_PROPERTY_META,
  SalesChannel.JSON_PROPERTY_ID,
  SalesChannel.JSON_PROPERTY_ACCOUNT_ID,
  SalesChannel.JSON_PROPERTY_ARCHIVED,
  SalesChannel.JSON_PROPERTY_CODE,
  SalesChannel.JSON_PROPERTY_DESCRIPTION,
  SalesChannel.JSON_PROPERTY_EXTERNAL_CODE,
  SalesChannel.JSON_PROPERTY_GROUP,
  SalesChannel.JSON_PROPERTY_NAME,
  SalesChannel.JSON_PROPERTY_OWNER,
  SalesChannel.JSON_PROPERTY_SHARED,
  SalesChannel.JSON_PROPERTY_TYPE,
  SalesChannel.JSON_PROPERTY_UPDATED
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class SalesChannel extends EntityWithMeta implements MetaEntity {
  public static SalesChannel createWithMeta(UUID id) {
    SalesChannel o = new SalesChannel();
    Meta meta = new Meta();
    meta.setType("saleschannel");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "saleschannel" + "/" + id;
    try {
  ...
  public SalesChannel meta(@javax.annotation.Nullable Meta meta) {
  ...
  public SalesChannel archived(@javax.annotation.Nullable Boolean archived) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, salesChannel.meta) &&
        Objects.equals(this.id, salesChannel.id) &&
        Objects.equals(this.accountId, salesChannel.accountId) &&
        Objects.equals(this.archived, salesChannel.archived) &&
        Objects.equals(this.code, salesChannel.code) &&
        equalsNullable(this.description, salesChannel.description) &&
        Objects.equals(this.externalCode, salesChannel.externalCode) &&
        Objects.equals(this.group, salesChannel.group) &&
        Objects.equals(this.name, salesChannel.name) &&
        equalsNullable(this.owner, salesChannel.owner) &&
        Objects.equals(this.shared, salesChannel.shared) &&
        Objects.equals(this.type, salesChannel.type) &&
        Objects.equals(this.updated, salesChannel.updated);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, archived, code, hashCodeNullable(description), externalCode, group, name, hashCodeNullable(owner), shared, type, updated);
  }
