...
public class DiscountList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<DiscountAbstract> rows = new ArrayList<>();

  public DiscountList() {
  }

  public DiscountList context(@javax.annotation.Nullable Context context) {
  ...
  public DiscountList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public DiscountList rows(@javax.annotation.Nullable List<DiscountAbstract> rows) {
  ...
  /**
   * Массив скидок всех типов для учётной записи (см. &#x60;meta.type&#x60;: discount, personaldiscount, specialpricediscount, accumulationdiscount, bonusprogram). 
   * @return rows
   */
  @javax.annotation.Nullable
  ...
  public List<DiscountAbstract> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<DiscountAbstract> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    DiscountList discountList = (DiscountList) o;
    return Objects.equals(this.context, discountList.context) &&
        Objects.equals(this.meta, discountList.meta) &&
        Objects.equals(this.rows, discountList.rows);
  }
