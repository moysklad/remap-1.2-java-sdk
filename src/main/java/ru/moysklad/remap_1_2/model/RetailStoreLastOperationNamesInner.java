 ...
 */
@JsonPropertyOrder({
  RetailStoreLastOperationNamesInner.JSON_PROPERTY_ENTITY,
...
public class RetailStoreLastOperationNamesInner {
  ...
  public RetailStoreLastOperationNamesInner() {
  }

  public RetailStoreLastOperationNamesInner entity(@javax.annotation.Nullable String entity) {
  ...
  public boolean equals(Object o) {
    ...
    RetailStoreLastOperationNamesInner retailStoreLastOperationNamesInner = (RetailStoreLastOperationNamesInner) o;
    return Objects.equals(this.entity, retailStoreLastOperationNamesInner.entity) &&
        Objects.equals(this.name, retailStoreLastOperationNamesInner.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailStoreLastOperationNamesInner {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEntity() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%sentity%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEntity()), "UTF-8").replaceAll("\\+", "%20")));
