 ...
 */
@JsonPropertyOrder({
  PrepaymentReturnPositionList.JSON_PROPERTY_CONTEXT,
...
public class PrepaymentReturnPositionList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<PrepaymentReturnPosition>> rows = JsonNullable.<List<PrepaymentReturnPosition>>undefined();

  public PrepaymentReturnPositionList() {
  }

  public PrepaymentReturnPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public PrepaymentReturnPositionList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public PrepaymentReturnPositionList rows(@javax.annotation.Nullable List<PrepaymentReturnPosition> rows) {
    this.rows = JsonNullable.<List<PrepaymentReturnPosition>>of(rows);
    
    return this;
  }


  public PrepaymentReturnPositionList addRowsItem(PrepaymentReturnPosition rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<PrepaymentReturnPosition>>of(new ArrayList<>());
    }
    try {
  ...
  public List<PrepaymentReturnPosition> getRows() {
  ...
  public JsonNullable<List<PrepaymentReturnPosition>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<PrepaymentReturnPosition>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<PrepaymentReturnPosition> rows) {
    this.rows = JsonNullable.<List<PrepaymentReturnPosition>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    PrepaymentReturnPositionList prepaymentReturnPositionList = (PrepaymentReturnPositionList) o;
    return Objects.equals(this.context, prepaymentReturnPositionList.context) &&
        Objects.equals(this.meta, prepaymentReturnPositionList.meta) &&
        equalsNullable(this.rows, prepaymentReturnPositionList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrepaymentReturnPositionList {\n");
