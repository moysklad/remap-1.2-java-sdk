 ...
 */
@JsonPropertyOrder({
  InvoiceOutPosition.JSON_PROPERTY_META,
  InvoiceOutPosition.JSON_PROPERTY_ID,
  InvoiceOutPosition.JSON_PROPERTY_ACCOUNT_ID,
  InvoiceOutPosition.JSON_PROPERTY_QUANTITY,
  InvoiceOutPosition.JSON_PROPERTY_PRICE,
  InvoiceOutPosition.JSON_PROPERTY_DISCOUNT,
  InvoiceOutPosition.JSON_PROPERTY_VAT,
  InvoiceOutPosition.JSON_PROPERTY_VAT_ENABLED,
...
public class InvoiceOutPosition extends EntityWithMeta implements DocumentPosition, MetaEntity {
  public static InvoiceOutPosition createWithMeta(UUID parentId, UUID id) {
    ...
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "invoiceout" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public InvoiceOutPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public InvoiceOutPosition id(@javax.annotation.Nullable UUID id) {
  ...
  public InvoiceOutPosition quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public InvoiceOutPosition price(@javax.annotation.Nullable Double price) {
  ...
  public InvoiceOutPosition discount(@javax.annotation.Nullable Double discount) {
  ...
  public InvoiceOutPosition vat(@javax.annotation.Nullable Integer vat) {
  ...
  public InvoiceOutPosition vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public InvoiceOutPosition assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public InvoiceOutPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceOutPosition invoiceOutPosition = (InvoiceOutPosition) o;
    return Objects.equals(this.meta, invoiceOutPosition.meta) &&
        Objects.equals(this.id, invoiceOutPosition.id) &&
        Objects.equals(this.accountId, invoiceOutPosition.accountId) &&
        Objects.equals(this.quantity, invoiceOutPosition.quantity) &&
        Objects.equals(this.price, invoiceOutPosition.price) &&
        Objects.equals(this.discount, invoiceOutPosition.discount) &&
        Objects.equals(this.vat, invoiceOutPosition.vat) &&
        Objects.equals(this.vatEnabled, invoiceOutPosition.vatEnabled) &&
        Objects.equals(this.assortment, invoiceOutPosition.assortment) &&
        equalsNullable(this.pack, invoiceOutPosition.pack);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoiceOutPosition {\n");
