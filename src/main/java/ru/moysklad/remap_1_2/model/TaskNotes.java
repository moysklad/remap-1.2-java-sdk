...
public class TaskNotes {
  ...
  public TaskNotes meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public TaskNotes rows(@javax.annotation.Nullable List<TaskNote> rows) {
  ...
  public TaskNotes addRowsItem(TaskNote rowsItem) {
    if (this.rows == null) {
  ...
  public boolean equals(Object o) {
    ...
    TaskNotes taskNotes = (TaskNotes) o;
    return Objects.equals(this.meta, taskNotes.meta) &&
        Objects.equals(this.rows, taskNotes.rows);
  }
