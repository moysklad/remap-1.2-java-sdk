...
public class CreateCommissionReportInReturnedPositions200ResponseInner {
  ...
  public CreateCommissionReportInReturnedPositions200ResponseInner errors(@javax.annotation.Nonnull List<Error> errors) {
  ...
  public CreateCommissionReportInReturnedPositions200ResponseInner addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
