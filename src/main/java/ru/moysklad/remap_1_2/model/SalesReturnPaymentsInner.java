 ...
 */
@JsonPropertyOrder({
  SalesReturnPaymentsInner.JSON_PROPERTY_META,
  SalesReturnPaymentsInner.JSON_PROPERTY_ID,
  SalesReturnPaymentsInner.JSON_PROPERTY_ACCOUNT_ID,
  SalesReturnPaymentsInner.JSON_PROPERTY_NAME,
  SalesReturnPaymentsInner.JSON_PROPERTY_CODE,
  SalesReturnPaymentsInner.JSON_PROPERTY_EXTERNAL_CODE,
  SalesReturnPaymentsInner.JSON_PROPERTY_SYNC_ID,
  SalesReturnPaymentsInner.JSON_PROPERTY_DESCRIPTION,
  SalesReturnPaymentsInner.JSON_PROPERTY_CREATED,
  SalesReturnPaymentsInner.JSON_PROPERTY_DELETED,
  SalesReturnPaymentsInner.JSON_PROPERTY_UPDATED,
  SalesReturnPaymentsInner.JSON_PROPERTY_MOMENT,
  SalesReturnPaymentsInner.JSON_PROPERTY_OWNER,
  SalesReturnPaymentsInner.JSON_PROPERTY_GROUP,
  SalesReturnPaymentsInner.JSON_PROPERTY_APPLICABLE,
  SalesReturnPaymentsInner.JSON_PROPERTY_PRINTED,
  SalesReturnPaymentsInner.JSON_PROPERTY_PUBLISHED,
  SalesReturnPaymentsInner.JSON_PROPERTY_RATE,
  SalesReturnPaymentsInner.JSON_PROPERTY_ORGANIZATION,
  SalesReturnPaymentsInner.JSON_PROPERTY_AGENT,
  SalesReturnPaymentsInner.JSON_PROPERTY_EXPENSE_ITEM,
  SalesReturnPaymentsInner.JSON_PROPERTY_ATTRIBUTES,
  SalesReturnPaymentsInner.JSON_PROPERTY_CONTRACT,
  SalesReturnPaymentsInner.JSON_PROPERTY_FILES,
  SalesReturnPaymentsInner.JSON_PROPERTY_NO_CLOSING_DOCS,
  SalesReturnPaymentsInner.JSON_PROPERTY_PAYMENT_PURPOSE,
  SalesReturnPaymentsInner.JSON_PROPERTY_PROJECT,
  SalesReturnPaymentsInner.JSON_PROPERTY_SALES_CHANNEL,
  SalesReturnPaymentsInner.JSON_PROPERTY_SHARED,
  SalesReturnPaymentsInner.JSON_PROPERTY_STATE,
  SalesReturnPaymentsInner.JSON_PROPERTY_SUM,
  SalesReturnPaymentsInner.JSON_PROPERTY_VAT_SUM,
  SalesReturnPaymentsInner.JSON_PROPERTY_FACTURE_IN,
  SalesReturnPaymentsInner.JSON_PROPERTY_AGENT_ACCOUNT,
  SalesReturnPaymentsInner.JSON_PROPERTY_ORGANIZATION_ACCOUNT,
...
public class SalesReturnPaymentsInner {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<@Valid FinanceOutOperationAbstract>> operations = JsonNullable.<List<@Valid FinanceOutOperationAbstract>>undefined();
  ...
  public SalesReturnPaymentsInner name(@javax.annotation.Nullable String name) {
 ...
 @Size(max=255)
  ...
  public SalesReturnPaymentsInner code(@javax.annotation.Nullable String code) {
 ...
 @Size(max=255)
  ...
  public SalesReturnPaymentsInner externalCode(@javax.annotation.Nullable String externalCode) {
 ...
 @Size(max=255)
  ...
  public SalesReturnPaymentsInner syncId(@javax.annotation.Nullable UUID syncId) {
  ...
  public SalesReturnPaymentsInner description(@javax.annotation.Nullable String description) {
 ...
 @Size(max=4096)
  ...
  public SalesReturnPaymentsInner moment(@javax.annotation.Nullable String moment) {
  ...
  public SalesReturnPaymentsInner owner(@javax.annotation.Nullable Employee owner) {
  ...
  public SalesReturnPaymentsInner group(@javax.annotation.Nullable Group group) {
  ...
  public SalesReturnPaymentsInner applicable(@javax.annotation.Nullable Boolean applicable) {
  ...
  public SalesReturnPaymentsInner rate(@javax.annotation.Nullable CurrencyRate rate) {
  ...
  public SalesReturnPaymentsInner organization(@javax.annotation.Nullable Organization organization) {
  ...
  public SalesReturnPaymentsInner agent(@javax.annotation.Nullable Agent agent) {
  ...
  public SalesReturnPaymentsInner expenseItem(@javax.annotation.Nullable ExpenseItem expenseItem) {
  ...
  public SalesReturnPaymentsInner attributes(@javax.annotation.Nullable List<@Valid AttributeAbstract> attributes) {
  ...
  public SalesReturnPaymentsInner addAttributesItem(AttributeAbstract attributesItem) {
  ...
  public SalesReturnPaymentsInner contract(@javax.annotation.Nullable Contract contract) {
  ...
  public SalesReturnPaymentsInner files(@javax.annotation.Nullable FileList files) {
  ...
  public SalesReturnPaymentsInner noClosingDocs(@javax.annotation.Nullable Boolean noClosingDocs) {
  ...
  public SalesReturnPaymentsInner paymentPurpose(@javax.annotation.Nullable String paymentPurpose) {
 ...
 @Size(max=255)
  ...
  public SalesReturnPaymentsInner project(@javax.annotation.Nullable Project project) {
  ...
  public SalesReturnPaymentsInner salesChannel(@javax.annotation.Nullable SalesChannel salesChannel) {
  ...
  public SalesReturnPaymentsInner state(@javax.annotation.Nullable State state) {
  ...
  public SalesReturnPaymentsInner agentAccount(@javax.annotation.Nullable Account agentAccount) {
  ...
  public SalesReturnPaymentsInner organizationAccount(@javax.annotation.Nullable Account organizationAccount) {
  ...
  public SalesReturnPaymentsInner operations(@javax.annotation.Nullable List<@Valid FinanceOutOperationAbstract> operations) {
    this.operations = JsonNullable.<List<@Valid FinanceOutOperationAbstract>>of(operations);
  ...
  public SalesReturnPaymentsInner addOperationsItem(FinanceOutOperationAbstract operationsItem) {
    if (this.operations == null || !this.operations.isPresent()) {
      this.operations = JsonNullable.<List<@Valid FinanceOutOperationAbstract>>of(new ArrayList<>());
    }
    try {
  ...
  public List<@Valid FinanceOutOperationAbstract> getOperations() {
  ...
  public JsonNullable<List<@Valid FinanceOutOperationAbstract>> getOperations_JsonNullable() {
    return operations;
  }
  
  @JsonProperty(value = JSON_PROPERTY_OPERATIONS, required = false)
  public void setOperations_JsonNullable(JsonNullable<List<@Valid FinanceOutOperationAbstract>> operations) {
    this.operations = operations;
  }

  public void setOperations(@javax.annotation.Nullable List<@Valid FinanceOutOperationAbstract> operations) {
    this.operations = JsonNullable.<List<@Valid FinanceOutOperationAbstract>>of(operations);
  }
  ...
  public boolean equals(Object o) {
    ...
    SalesReturnPaymentsInner salesReturnPaymentsInner = (SalesReturnPaymentsInner) o;
    return Objects.equals(this.meta, salesReturnPaymentsInner.meta) &&
        Objects.equals(this.id, salesReturnPaymentsInner.id) &&
        Objects.equals(this.accountId, salesReturnPaymentsInner.accountId) &&
        Objects.equals(this.name, salesReturnPaymentsInner.name) &&
        Objects.equals(this.code, salesReturnPaymentsInner.code) &&
        Objects.equals(this.externalCode, salesReturnPaymentsInner.externalCode) &&
        Objects.equals(this.syncId, salesReturnPaymentsInner.syncId) &&
        equalsNullable(this.description, salesReturnPaymentsInner.description) &&
        Objects.equals(this.created, salesReturnPaymentsInner.created) &&
        Objects.equals(this.deleted, salesReturnPaymentsInner.deleted) &&
        Objects.equals(this.updated, salesReturnPaymentsInner.updated) &&
        Objects.equals(this.moment, salesReturnPaymentsInner.moment) &&
        equalsNullable(this.owner, salesReturnPaymentsInner.owner) &&
        Objects.equals(this.group, salesReturnPaymentsInner.group) &&
        Objects.equals(this.applicable, salesReturnPaymentsInner.applicable) &&
        Objects.equals(this.printed, salesReturnPaymentsInner.printed) &&
        Objects.equals(this.published, salesReturnPaymentsInner.published) &&
        Objects.equals(this.rate, salesReturnPaymentsInner.rate) &&
        Objects.equals(this.organization, salesReturnPaymentsInner.organization) &&
        Objects.equals(this.agent, salesReturnPaymentsInner.agent) &&
        equalsNullable(this.expenseItem, salesReturnPaymentsInner.expenseItem) &&
        equalsNullable(this.attributes, salesReturnPaymentsInner.attributes) &&
        equalsNullable(this.contract, salesReturnPaymentsInner.contract) &&
        equalsNullable(this.files, salesReturnPaymentsInner.files) &&
        Objects.equals(this.noClosingDocs, salesReturnPaymentsInner.noClosingDocs) &&
        Objects.equals(this.paymentPurpose, salesReturnPaymentsInner.paymentPurpose) &&
        equalsNullable(this.project, salesReturnPaymentsInner.project) &&
        equalsNullable(this.salesChannel, salesReturnPaymentsInner.salesChannel) &&
        Objects.equals(this.shared, salesReturnPaymentsInner.shared) &&
        equalsNullable(this.state, salesReturnPaymentsInner.state) &&
        Objects.equals(this.sum, salesReturnPaymentsInner.sum) &&
        Objects.equals(this.vatSum, salesReturnPaymentsInner.vatSum) &&
        equalsNullable(this.factureIn, salesReturnPaymentsInner.factureIn) &&
        equalsNullable(this.agentAccount, salesReturnPaymentsInner.agentAccount) &&
        equalsNullable(this.organizationAccount, salesReturnPaymentsInner.organizationAccount) &&
        equalsNullable(this.operations, salesReturnPaymentsInner.operations);
  }
  ...
  public String toString() {
    ...
    sb.append("class SalesReturnPaymentsInner {\n");
