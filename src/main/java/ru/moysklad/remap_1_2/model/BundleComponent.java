 ...
 */
@JsonPropertyOrder({
  BundleComponent.JSON_PROPERTY_META,
  BundleComponent.JSON_PROPERTY_ID,
  BundleComponent.JSON_PROPERTY_ACCOUNT_ID,
...
public class BundleComponent {
  public static BundleComponent createWithMeta(UUID parentId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("bundlecomponent");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "bundle" + "/" + parentId + "/" + "components" + "/" + id;
    try {
  ...
  public BundleComponent meta(@javax.annotation.Nullable Meta meta) {
  ...
  public boolean equals(Object o) {
    ...
    BundleComponent bundleComponent = (BundleComponent) o;
    return Objects.equals(this.meta, bundleComponent.meta) &&
        Objects.equals(this.id, bundleComponent.id) &&
        Objects.equals(this.accountId, bundleComponent.accountId) &&
        Objects.equals(this.quantity, bundleComponent.quantity) &&
        Objects.equals(this.assortment, bundleComponent.assortment);
  }
  ...
  public String toString() {
    ...
    sb.append("class BundleComponent {\n");
