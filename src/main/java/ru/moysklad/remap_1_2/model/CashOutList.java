 ...
 */
@JsonPropertyOrder({
  CashOutList.JSON_PROPERTY_CONTEXT,
  CashOutList.JSON_PROPERTY_META,
  CashOutList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CashOutList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<CashOut> rows = new ArrayList<>();

  public CashOutList() {
  }

  public CashOutList context(@javax.annotation.Nullable Context context) {
  ...
  public CashOutList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CashOutList rows(@javax.annotation.Nullable List<CashOut> rows) {
  ...
  public CashOutList addRowsItem(CashOut rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<CashOut> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    CashOutList cashOutList = (CashOutList) o;
    return Objects.equals(this.context, cashOutList.context) &&
        Objects.equals(this.meta, cashOutList.meta) &&
        Objects.equals(this.rows, cashOutList.rows);
  }
