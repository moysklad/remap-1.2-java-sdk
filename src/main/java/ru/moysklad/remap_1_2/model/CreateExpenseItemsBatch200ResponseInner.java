 ...
 */
@JsonPropertyOrder({
  CreateExpenseItemsBatch200ResponseInner.JSON_PROPERTY_META,
  CreateExpenseItemsBatch200ResponseInner.JSON_PROPERTY_ID,
  CreateExpenseItemsBatch200ResponseInner.JSON_PROPERTY_ACCOUNT_ID,
  CreateExpenseItemsBatch200ResponseInner.JSON_PROPERTY_CODE,
  CreateExpenseItemsBatch200ResponseInner.JSON_PROPERTY_DESCRIPTION,
  CreateExpenseItemsBatch200ResponseInner.JSON_PROPERTY_EXTERNAL_CODE,
  CreateExpenseItemsBatch200ResponseInner.JSON_PROPERTY_NAME,
  CreateExpenseItemsBatch200ResponseInner.JSON_PROPERTY_UPDATED,
...
public class CreateExpenseItemsBatch200ResponseInner {
  ...
  public CreateExpenseItemsBatch200ResponseInner() {
  }
  /**
  ...
  public CreateExpenseItemsBatch200ResponseInner meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreateExpenseItemsBatch200ResponseInner code(@javax.annotation.Nullable String code) {
  ...
  public CreateExpenseItemsBatch200ResponseInner errors(@javax.annotation.Nonnull List<ErrorErrorsInner> errors) {
  ...
  public boolean equals(Object o) {
    ...
    CreateExpenseItemsBatch200ResponseInner createExpenseItemsBatch200ResponseInner = (CreateExpenseItemsBatch200ResponseInner) o;
    return Objects.equals(this.meta, createExpenseItemsBatch200ResponseInner.meta) &&
        Objects.equals(this.id, createExpenseItemsBatch200ResponseInner.id) &&
        Objects.equals(this.accountId, createExpenseItemsBatch200ResponseInner.accountId) &&
        Objects.equals(this.code, createExpenseItemsBatch200ResponseInner.code) &&
        Objects.equals(this.description, createExpenseItemsBatch200ResponseInner.description) &&
        Objects.equals(this.externalCode, createExpenseItemsBatch200ResponseInner.externalCode) &&
        Objects.equals(this.name, createExpenseItemsBatch200ResponseInner.name) &&
        Objects.equals(this.updated, createExpenseItemsBatch200ResponseInner.updated) &&
        Objects.equals(this.errors, createExpenseItemsBatch200ResponseInner.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, code, description, externalCode, name, updated, errors);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateExpenseItemsBatch200ResponseInner {\n");
