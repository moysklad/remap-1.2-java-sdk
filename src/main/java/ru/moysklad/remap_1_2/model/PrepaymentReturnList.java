 ...
 */
@JsonPropertyOrder({
  PrepaymentReturnList.JSON_PROPERTY_CONTEXT,
  PrepaymentReturnList.JSON_PROPERTY_META,
  PrepaymentReturnList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class PrepaymentReturnList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<PrepaymentReturn> rows = new ArrayList<>();

  public PrepaymentReturnList() {
  }

  public PrepaymentReturnList context(@javax.annotation.Nullable Context context) {
  ...
  public PrepaymentReturnList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public PrepaymentReturnList rows(@javax.annotation.Nullable List<PrepaymentReturn> rows) {
  ...
  public PrepaymentReturnList addRowsItem(PrepaymentReturn rowsItem) {
    if (this.rows == null) {
  ...
  public List<PrepaymentReturn> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<PrepaymentReturn> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    PrepaymentReturnList prepaymentReturnList = (PrepaymentReturnList) o;
    return Objects.equals(this.context, prepaymentReturnList.context) &&
        Objects.equals(this.meta, prepaymentReturnList.meta) &&
        Objects.equals(this.rows, prepaymentReturnList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrepaymentReturnList {\n");
