 ...
 */
public enum EmissionOrderDocumentState {
  ...
  EmissionOrderDocumentState(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EmissionOrderDocumentState fromValue(String value) {
    for (EmissionOrderDocumentState b : EmissionOrderDocumentState.values()) {
