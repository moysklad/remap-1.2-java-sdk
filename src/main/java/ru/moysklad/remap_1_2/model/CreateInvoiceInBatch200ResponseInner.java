...
public class CreateInvoiceInBatch200ResponseInner {
  ...
  public CreateInvoiceInBatch200ResponseInner errors(@javax.annotation.Nonnull List<Error> errors) {
  ...
  public CreateInvoiceInBatch200ResponseInner addErrorsItem(Error errorsItem) {
    if (this.errors == null) {
