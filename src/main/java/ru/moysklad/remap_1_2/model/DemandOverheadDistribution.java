...
/**
 * Распределение накладных расходов между позициями Отгрузки. Известные значения поля overhead.distribution
 */
public enum DemandOverheadDistribution {
  ...
  DemandOverheadDistribution(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DemandOverheadDistribution fromValue(String value) {
    for (DemandOverheadDistribution b : DemandOverheadDistribution.values()) {
