 ...
 */
@JsonPropertyOrder({
  CommissionReportInPosition.JSON_PROPERTY_META,
  CommissionReportInPosition.JSON_PROPERTY_ID,
  CommissionReportInPosition.JSON_PROPERTY_ACCOUNT_ID,
  CommissionReportInPosition.JSON_PROPERTY_QUANTITY,
  CommissionReportInPosition.JSON_PROPERTY_PRICE,
  CommissionReportInPosition.JSON_PROPERTY_REWARD,
  CommissionReportInPosition.JSON_PROPERTY_VAT,
  CommissionReportInPosition.JSON_PROPERTY_VAT_ENABLED,
...
public class CommissionReportInPosition extends EntityWithMeta implements DocumentPosition, MetaEntity {
  public static CommissionReportInPosition createWithMeta(UUID parentId, UUID id) {
    CommissionReportInPosition o = new CommissionReportInPosition();
    Meta meta = new Meta();
    meta.setType("commissionreportinposition");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "commissionreportin" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public CommissionReportInPosition() {
  }
  /**
  ...
  public CommissionReportInPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CommissionReportInPosition id(@javax.annotation.Nullable UUID id) {
  ...
  public CommissionReportInPosition quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public CommissionReportInPosition price(@javax.annotation.Nullable Double price) {
  ...
  public CommissionReportInPosition reward(@javax.annotation.Nullable Double reward) {
  ...
  public CommissionReportInPosition vat(@javax.annotation.Nullable Integer vat) {
  ...
  public CommissionReportInPosition vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public CommissionReportInPosition assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public CommissionReportInPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public boolean equals(Object o) {
    ...
    CommissionReportInPosition commissionReportInPosition = (CommissionReportInPosition) o;
    return Objects.equals(this.meta, commissionReportInPosition.meta) &&
        Objects.equals(this.id, commissionReportInPosition.id) &&
        Objects.equals(this.accountId, commissionReportInPosition.accountId) &&
        Objects.equals(this.quantity, commissionReportInPosition.quantity) &&
        Objects.equals(this.price, commissionReportInPosition.price) &&
        Objects.equals(this.reward, commissionReportInPosition.reward) &&
        Objects.equals(this.vat, commissionReportInPosition.vat) &&
        Objects.equals(this.vatEnabled, commissionReportInPosition.vatEnabled) &&
        Objects.equals(this.assortment, commissionReportInPosition.assortment) &&
        equalsNullable(this.pack, commissionReportInPosition.pack);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, quantity, price, reward, vat, vatEnabled, assortment, hashCodeNullable(pack));
  }
  ...
  public String toString() {
    ...
    sb.append("class CommissionReportInPosition {\n");
