 ...
 */
public enum VariantCharacteristicType {
  
  STRING("string");

  private String value;

  VariantCharacteristicType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static VariantCharacteristicType fromValue(String value) {
    for (VariantCharacteristicType b : VariantCharacteristicType.values()) {
