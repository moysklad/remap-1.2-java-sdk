 ...
 */
public enum EmissionOrderEmissionType {
  ...
  EmissionOrderEmissionType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EmissionOrderEmissionType fromValue(String value) {
    for (EmissionOrderEmissionType b : EmissionOrderEmissionType.values()) {
