 ...
 */
@JsonPropertyOrder({
  OrganizationList.JSON_PROPERTY_CONTEXT,
  OrganizationList.JSON_PROPERTY_META,
  OrganizationList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class OrganizationList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Organization> rows = new ArrayList<>();

  public OrganizationList() {
  }

  public OrganizationList context(@javax.annotation.Nullable Context context) {
  ...
  public OrganizationList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public OrganizationList rows(@javax.annotation.Nullable List<Organization> rows) {
  ...
  public OrganizationList addRowsItem(Organization rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Organization> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, organizationList.context) &&
        Objects.equals(this.meta, organizationList.meta) &&
        Objects.equals(this.rows, organizationList.rows);
  }
