 ...
 */
@JsonPropertyOrder({
  StoreSlotList.JSON_PROPERTY_CONTEXT,
  StoreSlotList.JSON_PROPERTY_META,
  StoreSlotList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class StoreSlotList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<StoreSlot> rows = new ArrayList<>();

  public StoreSlotList() {
  }

  public StoreSlotList context(@javax.annotation.Nullable Context context) {
  ...
  public StoreSlotList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public StoreSlotList rows(@javax.annotation.Nullable List<StoreSlot> rows) {
  ...
  public StoreSlotList addRowsItem(StoreSlot rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<StoreSlot> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    StoreSlotList storeSlotList = (StoreSlotList) o;
    return Objects.equals(this.context, storeSlotList.context) &&
        Objects.equals(this.meta, storeSlotList.meta) &&
        Objects.equals(this.rows, storeSlotList.rows);
  }
