 ...
 */
@JsonPropertyOrder({
  NotificationNamedEntity.JSON_PROPERTY_META,
  NotificationNamedEntity.JSON_PROPERTY_ID,
  NotificationNamedEntity.JSON_PROPERTY_NAME
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationNamedEntity {
  ...
  public NotificationNamedEntity() {
  }

  public NotificationNamedEntity meta(@javax.annotation.Nullable Meta meta) {
  ...
  public NotificationNamedEntity id(@javax.annotation.Nullable UUID id) {
  ...
  public NotificationNamedEntity name(@javax.annotation.Nullable String name) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationNamedEntity notificationNamedEntity = (NotificationNamedEntity) o;
    return Objects.equals(this.meta, notificationNamedEntity.meta) &&
        Objects.equals(this.id, notificationNamedEntity.id) &&
        Objects.equals(this.name, notificationNamedEntity.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NotificationNamedEntity {\n");
