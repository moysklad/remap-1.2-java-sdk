 ...
 */
@JsonPropertyOrder({
  EmployeeList.JSON_PROPERTY_CONTEXT,
  EmployeeList.JSON_PROPERTY_META,
  EmployeeList.JSON_PROPERTY_ROWS
})
...
public class EmployeeList {
  ...
  public EmployeeList context(@javax.annotation.Nullable Context context) {
  ...
  public EmployeeList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public EmployeeList rows(@javax.annotation.Nullable List<Employee> rows) {
  ...
  public EmployeeList addRowsItem(Employee rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Employee> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, employeeList.context) &&
        Objects.equals(this.meta, employeeList.meta) &&
        Objects.equals(this.rows, employeeList.rows);
  }
