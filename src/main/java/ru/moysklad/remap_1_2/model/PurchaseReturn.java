...
public class PurchaseReturn extends EntityWithMeta {
 ...
 @Size(max=4096)
  ...
  public PurchaseReturn payments(@javax.annotation.Nullable List<RetailShiftPaymentsInner> payments) {
  ...
  public PurchaseReturn addPaymentsItem(RetailShiftPaymentsInner paymentsItem) {
