...
/**
 * Известные значения типа кода маркировки в позиции Отгрузки
 */
public enum DemandPositionTrackingCodeType {
  ...
  DemandPositionTrackingCodeType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DemandPositionTrackingCodeType fromValue(String value) {
    for (DemandPositionTrackingCodeType b : DemandPositionTrackingCodeType.values()) {
