 ...
 */
@JsonPropertyOrder({
  CommissionReportIn.JSON_PROPERTY_META,
  CommissionReportIn.JSON_PROPERTY_ID,
  CommissionReportIn.JSON_PROPERTY_ACCOUNT_ID,
  CommissionReportIn.JSON_PROPERTY_AGENT,
  CommissionReportIn.JSON_PROPERTY_AGENT_ACCOUNT,
  CommissionReportIn.JSON_PROPERTY_APPLICABLE,
  CommissionReportIn.JSON_PROPERTY_ATTRIBUTES,
  CommissionReportIn.JSON_PROPERTY_CODE,
  CommissionReportIn.JSON_PROPERTY_COMMISSION_OVERHEAD,
  CommissionReportIn.JSON_PROPERTY_COMMISSION_PERIOD_END,
  CommissionReportIn.JSON_PROPERTY_COMMISSION_PERIOD_START,
  CommissionReportIn.JSON_PROPERTY_COMMITENT_SUM,
  CommissionReportIn.JSON_PROPERTY_CONTRACT,
  CommissionReportIn.JSON_PROPERTY_CREATED,
  CommissionReportIn.JSON_PROPERTY_DELETED,
  CommissionReportIn.JSON_PROPERTY_DESCRIPTION,
  CommissionReportIn.JSON_PROPERTY_EXTERNAL_CODE,
  CommissionReportIn.JSON_PROPERTY_FILES,
  CommissionReportIn.JSON_PROPERTY_GROUP,
  CommissionReportIn.JSON_PROPERTY_MOMENT,
  CommissionReportIn.JSON_PROPERTY_NAME,
  CommissionReportIn.JSON_PROPERTY_ORGANIZATION,
  CommissionReportIn.JSON_PROPERTY_ORGANIZATION_ACCOUNT,
  CommissionReportIn.JSON_PROPERTY_OWNER,
  CommissionReportIn.JSON_PROPERTY_PAYED_SUM,
  CommissionReportIn.JSON_PROPERTY_POSITIONS,
  CommissionReportIn.JSON_PROPERTY_PRINTED,
  CommissionReportIn.JSON_PROPERTY_PROJECT,
  CommissionReportIn.JSON_PROPERTY_PUBLISHED,
  CommissionReportIn.JSON_PROPERTY_RATE,
  CommissionReportIn.JSON_PROPERTY_RETURN_TO_COMMISSIONER_POSITIONS,
  CommissionReportIn.JSON_PROPERTY_REWARD_PERCENT,
  CommissionReportIn.JSON_PROPERTY_REWARD_TYPE,
  CommissionReportIn.JSON_PROPERTY_SALES_CHANNEL,
  CommissionReportIn.JSON_PROPERTY_SHARED,
  CommissionReportIn.JSON_PROPERTY_STATE,
  CommissionReportIn.JSON_PROPERTY_SUM,
  CommissionReportIn.JSON_PROPERTY_SYNC_ID,
  CommissionReportIn.JSON_PROPERTY_UPDATED,
  CommissionReportIn.JSON_PROPERTY_VAT_ENABLED,
  CommissionReportIn.JSON_PROPERTY_VAT_INCLUDED,
  CommissionReportIn.JSON_PROPERTY_VAT_SUM,
  CommissionReportIn.JSON_PROPERTY_PAYMENTS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CommissionReportIn extends EntityWithMeta implements MetaEntity {
  public static CommissionReportIn createWithMeta(UUID id) {
    ...
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "commissionreportin" + "/" + id;
    try {
  ...
  public CommissionReportIn meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CommissionReportIn contract(@javax.annotation.Nullable Contract contract) {
  ...
  public CommissionReportIn description(@javax.annotation.Nullable String description) {
  ...
  public CommissionReportIn positions(@javax.annotation.Nullable CommissionReportInPositionList positions) {
  ...
  public CommissionReportIn project(@javax.annotation.Nullable Project project) {
  ...
  public CommissionReportIn rate(@javax.annotation.Nullable CurrencyRate rate) {
  ...
  public CommissionReportIn rewardPercent(@javax.annotation.Nullable Double rewardPercent) {
  ...
  public CommissionReportIn vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public CommissionReportIn payments(@javax.annotation.Nullable List<RetailShiftPaymentsInner> payments) {
  ...
  public CommissionReportIn addPaymentsItem(RetailShiftPaymentsInner paymentsItem) {
  ...
  public boolean equals(Object o) {
    ...
    CommissionReportIn commissionReportIn = (CommissionReportIn) o;
    return Objects.equals(this.meta, commissionReportIn.meta) &&
        Objects.equals(this.id, commissionReportIn.id) &&
        Objects.equals(this.accountId, commissionReportIn.accountId) &&
        ...
        Objects.equals(this.commissionPeriodStart, commissionReportIn.commissionPeriodStart) &&
        Objects.equals(this.commitentSum, commissionReportIn.commitentSum) &&
        equalsNullable(this.contract, commissionReportIn.contract) &&
        Objects.equals(this.created, commissionReportIn.created) &&
        Objects.equals(this.deleted, commissionReportIn.deleted) &&
        equalsNullable(this.description, commissionReportIn.description) &&
        Objects.equals(this.externalCode, commissionReportIn.externalCode) &&
        equalsNullable(this.files, commissionReportIn.files) &&
        Objects.equals(this.group, commissionReportIn.group) &&
        Objects.equals(this.moment, commissionReportIn.moment) &&
        Objects.equals(this.name, commissionReportIn.name) &&
        Objects.equals(this.organization, commissionReportIn.organization) &&
        equalsNullable(this.organizationAccount, commissionReportIn.organizationAccount) &&
        equalsNullable(this.owner, commissionReportIn.owner) &&
        Objects.equals(this.payedSum, commissionReportIn.payedSum) &&
        Objects.equals(this.positions, commissionReportIn.positions) &&
        Objects.equals(this.printed, commissionReportIn.printed) &&
        equalsNullable(this.project, commissionReportIn.project) &&
        Objects.equals(this.published, commissionReportIn.published) &&
        Objects.equals(this.rate, commissionReportIn.rate) &&
        Objects.equals(this.returnToCommissionerPositions, commissionReportIn.returnToCommissionerPositions) &&
        Objects.equals(this.rewardPercent, commissionReportIn.rewardPercent) &&
        Objects.equals(this.rewardType, commissionReportIn.rewardType) &&
        equalsNullable(this.salesChannel, commissionReportIn.salesChannel) &&
        Objects.equals(this.shared, commissionReportIn.shared) &&
        equalsNullable(this.state, commissionReportIn.state) &&
        Objects.equals(this.sum, commissionReportIn.sum) &&
        Objects.equals(this.syncId, commissionReportIn.syncId) &&
        Objects.equals(this.updated, commissionReportIn.updated) &&
  ...
  public String toString() {
    ...
    sb.append("class CommissionReportIn {\n");
