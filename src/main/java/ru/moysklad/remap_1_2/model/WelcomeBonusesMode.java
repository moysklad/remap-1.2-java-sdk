 ...
 */
public enum WelcomeBonusesMode {
  ...
  WelcomeBonusesMode(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static WelcomeBonusesMode fromValue(String value) {
    for (WelcomeBonusesMode b : WelcomeBonusesMode.values()) {
