 ...
 */
@JsonPropertyOrder({
  AppAsyncButton.JSON_PROPERTY_META,
  AppAsyncButton.JSON_PROPERTY_ID,
  AppAsyncButton.JSON_PROPERTY_ACCOUNT_ID,
  AppAsyncButton.JSON_PROPERTY_CREATED,
  AppAsyncButton.JSON_PROPERTY_READ,
  AppAsyncButton.JSON_PROPERTY_TITLE,
  AppAsyncButton.JSON_PROPERTY_DESCRIPTION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class AppAsyncButton extends NotificationAbstract {
  ...
  public AppAsyncButton meta(@javax.annotation.Nullable Meta meta) {
  ...
  public AppAsyncButton read(@javax.annotation.Nullable Boolean read) {
  ...
  public boolean equals(Object o) {
    ...
    AppAsyncButton appAsyncButton = (AppAsyncButton) o;
    return Objects.equals(this.meta, appAsyncButton.meta) &&
        Objects.equals(this.id, appAsyncButton.id) &&
        Objects.equals(this.accountId, appAsyncButton.accountId) &&
        Objects.equals(this.created, appAsyncButton.created) &&
        Objects.equals(this.read, appAsyncButton.read) &&
        Objects.equals(this.title, appAsyncButton.title) &&
        Objects.equals(this.description, appAsyncButton.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class AppAsyncButton {\n");
