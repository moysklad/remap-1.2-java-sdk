...
public class CashOut extends EntityWithMeta {
  public static CashOut createWithMeta(UUID id) {
    CashOut o = new CashOut();
    Meta meta = new Meta();
    meta.setType("cashout");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "cashout" + "/" + id;
    try {
 ...
 @Size(max=4096)
  ...
  public CashOut attributes(@javax.annotation.Nullable List<@Valid AttributeAbstract> attributes) {
 ...
 @Size(max=255)
  ...
  public CashOut sum(@javax.annotation.Nullable Double sum) {
  ...
  public CashOut vatSum(@javax.annotation.Nullable Double vatSum) {
  ...
  public CashOut operations(@javax.annotation.Nullable List<@Valid FinanceOutOperationAbstract> operations) {
  ...
  public CashOut addOperationsItem(FinanceOutOperationAbstract operationsItem) {
