...
public class CashOut extends EntityWithMeta implements MetaEntity {
  ...
  public CashOut operations(@javax.annotation.Nullable List<FinanceOutOperationAbstract> operations) {
