 ...
 */
public enum PositionTrackingCodeType {
  ...
  PositionTrackingCodeType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PositionTrackingCodeType fromValue(String value) {
    for (PositionTrackingCodeType b : PositionTrackingCodeType.values()) {
