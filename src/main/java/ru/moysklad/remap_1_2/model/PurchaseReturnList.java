 ...
 */
@JsonPropertyOrder({
  PurchaseReturnList.JSON_PROPERTY_CONTEXT,
  PurchaseReturnList.JSON_PROPERTY_META,
  PurchaseReturnList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class PurchaseReturnList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<PurchaseReturn>> rows = JsonNullable.<List<PurchaseReturn>>undefined();

  public PurchaseReturnList() {
  }

  public PurchaseReturnList context(@javax.annotation.Nullable Context context) {
  ...
  public PurchaseReturnList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public PurchaseReturnList rows(@javax.annotation.Nullable List<PurchaseReturn> rows) {
    this.rows = JsonNullable.<List<PurchaseReturn>>of(rows);
    
    return this;
  }


  public PurchaseReturnList addRowsItem(PurchaseReturn rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<PurchaseReturn>>of(new ArrayList<>());
    }
    try {
  ...
  public List<PurchaseReturn> getRows() {
  ...
  public JsonNullable<List<PurchaseReturn>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<PurchaseReturn>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<PurchaseReturn> rows) {
    this.rows = JsonNullable.<List<PurchaseReturn>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    PurchaseReturnList purchaseReturnList = (PurchaseReturnList) o;
    return Objects.equals(this.context, purchaseReturnList.context) &&
        Objects.equals(this.meta, purchaseReturnList.meta) &&
        equalsNullable(this.rows, purchaseReturnList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class PurchaseReturnList {\n");
