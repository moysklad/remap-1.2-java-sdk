 ...
 */
@JsonPropertyOrder({
  PaymentOutList.JSON_PROPERTY_CONTEXT,
  PaymentOutList.JSON_PROPERTY_META,
  PaymentOutList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class PaymentOutList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<PaymentOut> rows = new ArrayList<>();

  public PaymentOutList() {
  }

  public PaymentOutList context(@javax.annotation.Nullable Context context) {
  ...
  public PaymentOutList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public PaymentOutList rows(@javax.annotation.Nullable List<PaymentOut> rows) {
  ...
  public PaymentOutList addRowsItem(PaymentOut rowsItem) {
    if (this.rows == null) {
  ...
  public List<PaymentOut> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<PaymentOut> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentOutList paymentOutList = (PaymentOutList) o;
    return Objects.equals(this.context, paymentOutList.context) &&
        Objects.equals(this.meta, paymentOutList.meta) &&
        Objects.equals(this.rows, paymentOutList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentOutList {\n");
