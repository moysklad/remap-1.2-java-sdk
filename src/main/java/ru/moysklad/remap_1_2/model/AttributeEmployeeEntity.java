 ...
 */
@JsonPropertyOrder({
  AttributeEmployeeEntity.JSON_PROPERTY_TYPE,
  AttributeEmployeeEntity.JSON_PROPERTY_VALUE
})
...
public class AttributeEmployeeEntity extends AttributeAbstract implements Attribute<Employee> {
  ...
  public AttributeEmployeeEntity() {

  }

  public AttributeEmployeeEntity type(@javax.annotation.Nullable TypeEnum type) {
  ...
  public AttributeEmployeeEntity value(@javax.annotation.Nullable Employee value) {
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(@javax.annotation.Nullable Employee value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    AttributeEmployeeEntity attributeEmployeeEntity = (AttributeEmployeeEntity) o;
    return Objects.equals(this.type, attributeEmployeeEntity.type) &&
        Objects.equals(this.value, attributeEmployeeEntity.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributeEmployeeEntity {\n");
