 ...
 */
@JsonPropertyOrder({
  ProductFolderList.JSON_PROPERTY_CONTEXT,
  ProductFolderList.JSON_PROPERTY_META,
  ProductFolderList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProductFolderList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<ProductFolder>> rows = JsonNullable.<List<ProductFolder>>undefined();

  public ProductFolderList() {
  }

  public ProductFolderList context(@javax.annotation.Nullable Context context) {
  ...
  public ProductFolderList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ProductFolderList rows(@javax.annotation.Nullable List<ProductFolder> rows) {
    this.rows = JsonNullable.<List<ProductFolder>>of(rows);
    
    return this;
  }


  public ProductFolderList addRowsItem(ProductFolder rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<ProductFolder>>of(new ArrayList<>());
    }
    try {
  ...
  public List<ProductFolder> getRows() {
  ...
  public JsonNullable<List<ProductFolder>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<ProductFolder>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<ProductFolder> rows) {
    this.rows = JsonNullable.<List<ProductFolder>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    ProductFolderList productFolderList = (ProductFolderList) o;
    return Objects.equals(this.context, productFolderList.context) &&
        Objects.equals(this.meta, productFolderList.meta) &&
        equalsNullable(this.rows, productFolderList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductFolderList {\n");
