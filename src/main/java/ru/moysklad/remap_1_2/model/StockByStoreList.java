...
import ru.moysklad.remap_1_2.model.StockByStore;
 ...
 */
@JsonPropertyOrder({
  StockByStoreList.JSON_PROPERTY_CONTEXT,
  StockByStoreList.JSON_PROPERTY_META,
  StockByStoreList.JSON_PROPERTY_ROWS
})
...
public class StockByStoreList {
  ...
  @javax.annotation.Nullable
  private List<@Valid StockByStore> rows = new ArrayList<>();

  public StockByStoreList() {
  }

  public StockByStoreList context(@javax.annotation.Nullable Context context) {
  ...
  public StockByStoreList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public StockByStoreList rows(@javax.annotation.Nullable List<@Valid StockByStore> rows) {
  ...
  public StockByStoreList addRowsItem(StockByStore rowsItem) {
    if (this.rows == null) {
  ...
  /**
   * Массив строк отчета. Набор типов строк зависит от параметра запроса &#x60;groupBy&#x60; (см. &#x60;meta.type&#x60;: product, variant, consignment). 
   * @return rows
   */
  @javax.annotation.Nullable
  @Valid
  ...
  public List<@Valid StockByStore> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<@Valid StockByStore> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    StockByStoreList stockByStoreList = (StockByStoreList) o;
    return Objects.equals(this.context, stockByStoreList.context) &&
        Objects.equals(this.meta, stockByStoreList.meta) &&
        Objects.equals(this.rows, stockByStoreList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class StockByStoreList {\n");
