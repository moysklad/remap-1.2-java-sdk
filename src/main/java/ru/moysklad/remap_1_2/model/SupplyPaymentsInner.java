 ...
 */
@JsonPropertyOrder({
  SupplyPaymentsInner.JSON_PROPERTY_META,
  SupplyPaymentsInner.JSON_PROPERTY_ID,
  SupplyPaymentsInner.JSON_PROPERTY_ACCOUNT_ID,
  SupplyPaymentsInner.JSON_PROPERTY_NAME,
  SupplyPaymentsInner.JSON_PROPERTY_CODE,
  SupplyPaymentsInner.JSON_PROPERTY_EXTERNAL_CODE,
  SupplyPaymentsInner.JSON_PROPERTY_SYNC_ID,
  SupplyPaymentsInner.JSON_PROPERTY_DESCRIPTION,
  SupplyPaymentsInner.JSON_PROPERTY_CREATED,
  SupplyPaymentsInner.JSON_PROPERTY_DELETED,
  SupplyPaymentsInner.JSON_PROPERTY_UPDATED,
  SupplyPaymentsInner.JSON_PROPERTY_MOMENT,
  SupplyPaymentsInner.JSON_PROPERTY_OWNER,
  SupplyPaymentsInner.JSON_PROPERTY_GROUP,
  SupplyPaymentsInner.JSON_PROPERTY_APPLICABLE,
  SupplyPaymentsInner.JSON_PROPERTY_PRINTED,
  SupplyPaymentsInner.JSON_PROPERTY_PUBLISHED,
  SupplyPaymentsInner.JSON_PROPERTY_RATE,
  SupplyPaymentsInner.JSON_PROPERTY_ORGANIZATION,
  SupplyPaymentsInner.JSON_PROPERTY_AGENT,
  SupplyPaymentsInner.JSON_PROPERTY_EXPENSE_ITEM,
  SupplyPaymentsInner.JSON_PROPERTY_ATTRIBUTES,
  SupplyPaymentsInner.JSON_PROPERTY_CONTRACT,
  SupplyPaymentsInner.JSON_PROPERTY_FILES,
  SupplyPaymentsInner.JSON_PROPERTY_NO_CLOSING_DOCS,
  SupplyPaymentsInner.JSON_PROPERTY_PAYMENT_PURPOSE,
  SupplyPaymentsInner.JSON_PROPERTY_PROJECT,
  SupplyPaymentsInner.JSON_PROPERTY_SALES_CHANNEL,
  SupplyPaymentsInner.JSON_PROPERTY_SHARED,
  SupplyPaymentsInner.JSON_PROPERTY_STATE,
  SupplyPaymentsInner.JSON_PROPERTY_SUM,
  SupplyPaymentsInner.JSON_PROPERTY_VAT_SUM,
  SupplyPaymentsInner.JSON_PROPERTY_FACTURE_IN,
  SupplyPaymentsInner.JSON_PROPERTY_AGENT_ACCOUNT,
  SupplyPaymentsInner.JSON_PROPERTY_ORGANIZATION_ACCOUNT,
  SupplyPaymentsInner.JSON_PROPERTY_OPERATIONS,
  SupplyPaymentsInner.JSON_PROPERTY_INCOMING_NUMBER,
  SupplyPaymentsInner.JSON_PROPERTY_INCOMING_DATE,
...
public class SupplyPaymentsInner {
  ...
  public SupplyPaymentsInner name(@javax.annotation.Nullable String name) {
 ...
 @Size(max=255)
  ...
  public SupplyPaymentsInner code(@javax.annotation.Nullable String code) {
 ...
 @Size(max=255)
  ...
  public SupplyPaymentsInner externalCode(@javax.annotation.Nullable String externalCode) {
 ...
 @Size(max=255)
  ...
  public SupplyPaymentsInner syncId(@javax.annotation.Nullable UUID syncId) {
  ...
  public SupplyPaymentsInner description(@javax.annotation.Nullable String description) {
 ...
 @Size(max=4096)
  ...
  public SupplyPaymentsInner moment(@javax.annotation.Nullable String moment) {
  ...
  public SupplyPaymentsInner owner(@javax.annotation.Nullable Employee owner) {
  ...
  public SupplyPaymentsInner group(@javax.annotation.Nullable Group group) {
  ...
  public SupplyPaymentsInner applicable(@javax.annotation.Nullable Boolean applicable) {
  ...
  public SupplyPaymentsInner rate(@javax.annotation.Nullable CurrencyRate rate) {
  ...
  public SupplyPaymentsInner organization(@javax.annotation.Nullable Organization organization) {
  ...
  public SupplyPaymentsInner agent(@javax.annotation.Nullable Agent agent) {
  ...
  public SupplyPaymentsInner expenseItem(@javax.annotation.Nullable ExpenseItem expenseItem) {
  ...
  public SupplyPaymentsInner attributes(@javax.annotation.Nullable List<@Valid AttributeAbstract> attributes) {
  ...
  public SupplyPaymentsInner addAttributesItem(AttributeAbstract attributesItem) {
  ...
  public SupplyPaymentsInner contract(@javax.annotation.Nullable Contract contract) {
  ...
  public SupplyPaymentsInner files(@javax.annotation.Nullable FileList files) {
  ...
  public SupplyPaymentsInner noClosingDocs(@javax.annotation.Nullable Boolean noClosingDocs) {
  ...
  public SupplyPaymentsInner paymentPurpose(@javax.annotation.Nullable String paymentPurpose) {
 ...
 @Size(max=255)
  ...
  public SupplyPaymentsInner project(@javax.annotation.Nullable Project project) {
  ...
  public SupplyPaymentsInner salesChannel(@javax.annotation.Nullable SalesChannel salesChannel) {
  ...
  public SupplyPaymentsInner state(@javax.annotation.Nullable State state) {
 ...
 @DecimalMin("0")
  ...
  public SupplyPaymentsInner agentAccount(@javax.annotation.Nullable Account agentAccount) {
  ...
  public SupplyPaymentsInner organizationAccount(@javax.annotation.Nullable Account organizationAccount) {
  ...
  public SupplyPaymentsInner operations(@javax.annotation.Nullable List<@Valid FinanceInOperationAbstract> operations) {
  ...
  public SupplyPaymentsInner addOperationsItem(FinanceInOperationAbstract operationsItem) {
  ...
  public SupplyPaymentsInner incomingNumber(@javax.annotation.Nullable String incomingNumber) {
 ...
 @Size(max=255)
  ...
  public SupplyPaymentsInner incomingDate(@javax.annotation.Nullable String incomingDate) {
  ...
  public SupplyPaymentsInner factureOut(@javax.annotation.Nullable FactureOut factureOut) {
  ...
  public boolean equals(Object o) {
    ...
    SupplyPaymentsInner supplyPaymentsInner = (SupplyPaymentsInner) o;
    return Objects.equals(this.meta, supplyPaymentsInner.meta) &&
        Objects.equals(this.id, supplyPaymentsInner.id) &&
        Objects.equals(this.accountId, supplyPaymentsInner.accountId) &&
        Objects.equals(this.name, supplyPaymentsInner.name) &&
        Objects.equals(this.code, supplyPaymentsInner.code) &&
        Objects.equals(this.externalCode, supplyPaymentsInner.externalCode) &&
        Objects.equals(this.syncId, supplyPaymentsInner.syncId) &&
        equalsNullable(this.description, supplyPaymentsInner.description) &&
        Objects.equals(this.created, supplyPaymentsInner.created) &&
        Objects.equals(this.deleted, supplyPaymentsInner.deleted) &&
        Objects.equals(this.updated, supplyPaymentsInner.updated) &&
        Objects.equals(this.moment, supplyPaymentsInner.moment) &&
        equalsNullable(this.owner, supplyPaymentsInner.owner) &&
        Objects.equals(this.group, supplyPaymentsInner.group) &&
        Objects.equals(this.applicable, supplyPaymentsInner.applicable) &&
        Objects.equals(this.printed, supplyPaymentsInner.printed) &&
        Objects.equals(this.published, supplyPaymentsInner.published) &&
        Objects.equals(this.rate, supplyPaymentsInner.rate) &&
        Objects.equals(this.organization, supplyPaymentsInner.organization) &&
        Objects.equals(this.agent, supplyPaymentsInner.agent) &&
        equalsNullable(this.expenseItem, supplyPaymentsInner.expenseItem) &&
        equalsNullable(this.attributes, supplyPaymentsInner.attributes) &&
        equalsNullable(this.contract, supplyPaymentsInner.contract) &&
        equalsNullable(this.files, supplyPaymentsInner.files) &&
        Objects.equals(this.noClosingDocs, supplyPaymentsInner.noClosingDocs) &&
        Objects.equals(this.paymentPurpose, supplyPaymentsInner.paymentPurpose) &&
        equalsNullable(this.project, supplyPaymentsInner.project) &&
        equalsNullable(this.salesChannel, supplyPaymentsInner.salesChannel) &&
        Objects.equals(this.shared, supplyPaymentsInner.shared) &&
        equalsNullable(this.state, supplyPaymentsInner.state) &&
        Objects.equals(this.sum, supplyPaymentsInner.sum) &&
        Objects.equals(this.vatSum, supplyPaymentsInner.vatSum) &&
        equalsNullable(this.factureIn, supplyPaymentsInner.factureIn) &&
        equalsNullable(this.agentAccount, supplyPaymentsInner.agentAccount) &&
        equalsNullable(this.organizationAccount, supplyPaymentsInner.organizationAccount) &&
        equalsNullable(this.operations, supplyPaymentsInner.operations) &&
        equalsNullable(this.incomingNumber, supplyPaymentsInner.incomingNumber) &&
        equalsNullable(this.incomingDate, supplyPaymentsInner.incomingDate) &&
        equalsNullable(this.factureOut, supplyPaymentsInner.factureOut);
  }
  ...
  public String toString() {
    ...
    sb.append("class SupplyPaymentsInner {\n");
