 ...
 */
@JsonPropertyOrder({
  TaskNoteList.JSON_PROPERTY_CONTEXT,
  TaskNoteList.JSON_PROPERTY_META,
  TaskNoteList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class TaskNoteList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<TaskNote> rows = new ArrayList<>();

  public TaskNoteList() {
  }

  public TaskNoteList context(@javax.annotation.Nullable Context context) {
  ...
  public TaskNoteList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public TaskNoteList rows(@javax.annotation.Nullable List<TaskNote> rows) {
  ...
  public TaskNoteList addRowsItem(TaskNote rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<TaskNote> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    TaskNoteList taskNoteList = (TaskNoteList) o;
    return Objects.equals(this.context, taskNoteList.context) &&
        Objects.equals(this.meta, taskNoteList.meta) &&
        Objects.equals(this.rows, taskNoteList.rows);
  }
