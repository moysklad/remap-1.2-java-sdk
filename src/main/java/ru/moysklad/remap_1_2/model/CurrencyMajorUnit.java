 ...
 */
@JsonPropertyOrder({
  CurrencyMajorUnit.JSON_PROPERTY_GENDER,
  CurrencyMajorUnit.JSON_PROPERTY_S1,
  CurrencyMajorUnit.JSON_PROPERTY_S2,
...
public class CurrencyMajorUnit {
  ...
  public CurrencyMajorUnit s1(@javax.annotation.Nullable String s1) {
  ...
  public CurrencyMajorUnit s2(@javax.annotation.Nullable String s2) {
  ...
  public CurrencyMajorUnit s5(@javax.annotation.Nullable String s5) {
  ...
  public boolean equals(Object o) {
    ...
    CurrencyMajorUnit currencyMajorUnit = (CurrencyMajorUnit) o;
    return Objects.equals(this.gender, currencyMajorUnit.gender) &&
        Objects.equals(this.s1, currencyMajorUnit.s1) &&
        Objects.equals(this.s2, currencyMajorUnit.s2) &&
        Objects.equals(this.s5, currencyMajorUnit.s5);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrencyMajorUnit {\n");
