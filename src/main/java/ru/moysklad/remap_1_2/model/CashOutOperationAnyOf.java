 ...
 */
@JsonPropertyOrder({
  CashOutOperationAnyOf.JSON_PROPERTY_META,
  CashOutOperationAnyOf.JSON_PROPERTY_ID,
  CashOutOperationAnyOf.JSON_PROPERTY_ACCOUNT_ID,
  CashOutOperationAnyOf.JSON_PROPERTY_LINKED_SUM
})
@JsonTypeName("CashOutOperation_anyOf")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-05-22T13:41:10.768379078Z[GMT]", comments = "Generator version: 7.14.0")
public class CashOutOperationAnyOf {
  ...
  public CashOutOperationAnyOf meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CashOutOperationAnyOf linkedSum(@javax.annotation.Nonnull Double linkedSum) {
  ...
  public boolean equals(Object o) {
    ...
    CashOutOperationAnyOf cashOutOperationAnyOf = (CashOutOperationAnyOf) o;
    return Objects.equals(this.meta, cashOutOperationAnyOf.meta) &&
        Objects.equals(this.id, cashOutOperationAnyOf.id) &&
        Objects.equals(this.accountId, cashOutOperationAnyOf.accountId) &&
        Objects.equals(this.linkedSum, cashOutOperationAnyOf.linkedSum);
  }
  ...
  public String toString() {
    ...
    sb.append("class CashOutOperationAnyOf {\n");
