 ...
 */
public enum NotificationTaskState {
  ...
  NotificationTaskState(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static NotificationTaskState fromValue(String value) {
    for (NotificationTaskState b : NotificationTaskState.values()) {
