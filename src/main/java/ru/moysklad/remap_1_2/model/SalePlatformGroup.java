...
public enum SalePlatformGroup {
  ...
  SalePlatformGroup(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static SalePlatformGroup fromValue(String value) {
    for (SalePlatformGroup b : SalePlatformGroup.values()) {
