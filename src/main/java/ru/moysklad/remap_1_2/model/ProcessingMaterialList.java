 ...
 */
@JsonPropertyOrder({
  ProcessingMaterialList.JSON_PROPERTY_CONTEXT,
  ProcessingMaterialList.JSON_PROPERTY_META,
  ProcessingMaterialList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProcessingMaterialList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<ProcessingMaterial>> rows = JsonNullable.<List<ProcessingMaterial>>undefined();

  public ProcessingMaterialList() {
  }

  public ProcessingMaterialList context(@javax.annotation.Nullable Context context) {
  ...
  public ProcessingMaterialList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ProcessingMaterialList rows(@javax.annotation.Nullable List<ProcessingMaterial> rows) {
    this.rows = JsonNullable.<List<ProcessingMaterial>>of(rows);
    
    return this;
  }


  public ProcessingMaterialList addRowsItem(ProcessingMaterial rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<ProcessingMaterial>>of(new ArrayList<>());
    }
    try {
  ...
  public List<ProcessingMaterial> getRows() {
  ...
  public JsonNullable<List<ProcessingMaterial>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<ProcessingMaterial>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<ProcessingMaterial> rows) {
    this.rows = JsonNullable.<List<ProcessingMaterial>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessingMaterialList processingMaterialList = (ProcessingMaterialList) o;
    return Objects.equals(this.context, processingMaterialList.context) &&
        Objects.equals(this.meta, processingMaterialList.meta) &&
        equalsNullable(this.rows, processingMaterialList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingMaterialList {\n");
