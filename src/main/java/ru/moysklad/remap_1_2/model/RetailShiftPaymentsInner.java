...
public class RetailShiftPaymentsInner {
  ...
  public RetailShiftPaymentsInner attributes(@javax.annotation.Nullable List<AttributeAbstract> attributes) {
  ...
  public RetailShiftPaymentsInner operations(@javax.annotation.Nullable List<FinanceInOperationAbstract> operations) {
