 ...
 */
@JsonPropertyOrder({
  RetailDemandList.JSON_PROPERTY_CONTEXT,
  RetailDemandList.JSON_PROPERTY_META,
  RetailDemandList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class RetailDemandList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<RetailDemand> rows = new ArrayList<>();

  public RetailDemandList() {
  }

  public RetailDemandList context(@javax.annotation.Nullable Context context) {
  ...
  public RetailDemandList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public RetailDemandList rows(@javax.annotation.Nullable List<RetailDemand> rows) {
  ...
  public RetailDemandList addRowsItem(RetailDemand rowsItem) {
    if (this.rows == null) {
  ...
  public List<RetailDemand> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<RetailDemand> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    RetailDemandList retailDemandList = (RetailDemandList) o;
    return Objects.equals(this.context, retailDemandList.context) &&
        Objects.equals(this.meta, retailDemandList.meta) &&
        Objects.equals(this.rows, retailDemandList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailDemandList {\n");
