 ...
 */
@JsonPropertyOrder({
  CashInList.JSON_PROPERTY_CONTEXT,
  CashInList.JSON_PROPERTY_META,
  CashInList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CashInList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<CashIn> rows = new ArrayList<>();

  public CashInList() {
  }

  public CashInList context(@javax.annotation.Nullable Context context) {
  ...
  public CashInList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CashInList rows(@javax.annotation.Nullable List<CashIn> rows) {
  ...
  public CashInList addRowsItem(CashIn rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<CashIn> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    CashInList cashInList = (CashInList) o;
    return Objects.equals(this.context, cashInList.context) &&
        Objects.equals(this.meta, cashInList.meta) &&
        Objects.equals(this.rows, cashInList.rows);
  }
