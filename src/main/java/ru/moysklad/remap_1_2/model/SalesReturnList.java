 ...
 */
@JsonPropertyOrder({
  SalesReturnList.JSON_PROPERTY_CONTEXT,
  SalesReturnList.JSON_PROPERTY_META,
  SalesReturnList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class SalesReturnList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<SalesReturn> rows = new ArrayList<>();

  public SalesReturnList() {
  }

  public SalesReturnList context(@javax.annotation.Nullable Context context) {
  ...
  public SalesReturnList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public SalesReturnList rows(@javax.annotation.Nullable List<SalesReturn> rows) {
  ...
  public SalesReturnList addRowsItem(SalesReturn rowsItem) {
    if (this.rows == null) {
  ...
  public List<SalesReturn> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<SalesReturn> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    SalesReturnList salesReturnList = (SalesReturnList) o;
    return Objects.equals(this.context, salesReturnList.context) &&
        Objects.equals(this.meta, salesReturnList.meta) &&
        Objects.equals(this.rows, salesReturnList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class SalesReturnList {\n");
