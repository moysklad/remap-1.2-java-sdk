 ...
 */
@JsonPropertyOrder({
  CustomEntityElementList.JSON_PROPERTY_CONTEXT,
  CustomEntityElementList.JSON_PROPERTY_META,
  CustomEntityElementList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CustomEntityElementList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<CustomEntityElement> rows = new ArrayList<>();

  public CustomEntityElementList() {
  }

  public CustomEntityElementList context(@javax.annotation.Nullable Context context) {
  ...
  public CustomEntityElementList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CustomEntityElementList rows(@javax.annotation.Nullable List<CustomEntityElement> rows) {
  ...
  public CustomEntityElementList addRowsItem(CustomEntityElement rowsItem) {
    if (this.rows == null) {
  ...
  public List<CustomEntityElement> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<CustomEntityElement> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    CustomEntityElementList customEntityElementList = (CustomEntityElementList) o;
    return Objects.equals(this.context, customEntityElementList.context) &&
        Objects.equals(this.meta, customEntityElementList.meta) &&
        Objects.equals(this.rows, customEntityElementList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomEntityElementList {\n");
