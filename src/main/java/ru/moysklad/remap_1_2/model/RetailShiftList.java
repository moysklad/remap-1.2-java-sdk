 ...
 */
@JsonPropertyOrder({
  RetailShiftList.JSON_PROPERTY_CONTEXT,
  RetailShiftList.JSON_PROPERTY_META,
  RetailShiftList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class RetailShiftList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<RetailShift> rows = new ArrayList<>();

  public RetailShiftList() {
  }

  public RetailShiftList context(@javax.annotation.Nullable Context context) {
  ...
  public RetailShiftList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public RetailShiftList rows(@javax.annotation.Nullable List<RetailShift> rows) {
  ...
  public RetailShiftList addRowsItem(RetailShift rowsItem) {
    if (this.rows == null) {
  ...
  public List<RetailShift> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<RetailShift> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    RetailShiftList retailShiftList = (RetailShiftList) o;
    return Objects.equals(this.context, retailShiftList.context) &&
        Objects.equals(this.meta, retailShiftList.meta) &&
        Objects.equals(this.rows, retailShiftList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailShiftList {\n");
