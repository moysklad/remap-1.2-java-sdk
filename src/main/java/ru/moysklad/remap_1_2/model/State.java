 ...
 */
@JsonPropertyOrder({
  State.JSON_PROPERTY_META,
  State.JSON_PROPERTY_ID,
  State.JSON_PROPERTY_NAME,
  State.JSON_PROPERTY_ACCOUNT_ID,
  State.JSON_PROPERTY_COLOR,
  State.JSON_PROPERTY_ENTITY_TYPE,
  State.JSON_PROPERTY_STATE_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class State implements MetaEntity {
  public static State createWithMeta(UUID entityType, UUID id) {
    State o = new State();
    Meta meta = new Meta();
    meta.setType("state");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + entityType + "/" + "metadata" + "/" + "states" + "/" + id;
    try {
  ...
  public State meta(@javax.annotation.Nullable Meta meta) {
  ...
  public State color(@javax.annotation.Nullable Integer color) {
  ...
  public boolean equals(Object o) {
    ...
    State state = (State) o;
    return Objects.equals(this.meta, state.meta) &&
        Objects.equals(this.id, state.id) &&
        Objects.equals(this.name, state.name) &&
        Objects.equals(this.accountId, state.accountId) &&
        Objects.equals(this.color, state.color) &&
        Objects.equals(this.entityType, state.entityType) &&
        Objects.equals(this.stateType, state.stateType);
  }
