 ...
 */
@JsonPropertyOrder({
  ProcessingPlanMaterialList.JSON_PROPERTY_CONTEXT,
...
public class ProcessingPlanMaterialList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<ProcessingPlanMaterial>> rows = JsonNullable.<List<ProcessingPlanMaterial>>undefined();

  public ProcessingPlanMaterialList() {
  }

  public ProcessingPlanMaterialList context(@javax.annotation.Nullable Context context) {
  ...
  public ProcessingPlanMaterialList addRowsItem(ProcessingPlanMaterial rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<ProcessingPlanMaterial>>of(new ArrayList<>());
    }
    try {
  ...
  public List<ProcessingPlanMaterial> getRows() {
  ...
  public JsonNullable<List<ProcessingPlanMaterial>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<ProcessingPlanMaterial>> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessingPlanMaterialList processingPlanMaterialList = (ProcessingPlanMaterialList) o;
    return Objects.equals(this.context, processingPlanMaterialList.context) &&
        Objects.equals(this.meta, processingPlanMaterialList.meta) &&
        equalsNullable(this.rows, processingPlanMaterialList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingPlanMaterialList {\n");
