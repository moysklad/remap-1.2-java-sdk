...
public class StoreBalance implements MetaEntity {
  public static StoreBalance createWithMeta(UUID parentId, UUID id) {
    StoreBalance o = new StoreBalance();
    Meta meta = new Meta();
    meta.setType("minimumstock");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "product" + "/" + parentId + "/" + "storebalances" + "/" + id;
    try {
