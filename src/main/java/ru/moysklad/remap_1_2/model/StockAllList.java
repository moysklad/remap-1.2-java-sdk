 ...
 */
@JsonPropertyOrder({
  StockAllList.JSON_PROPERTY_CONTEXT,
...
public class StockAllList {
  ...
  public StockAllList context(@javax.annotation.Nullable Context context) {
  ...
  public StockAllList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public StockAllList addRowsItem(StockAll rowsItem) {
    if (this.rows == null) {
  ...
  /**
   * Массив строк отчета об остатках. Набор типов строк зависит от параметра запроса &#x60;groupBy&#x60; (см. &#x60;meta.type&#x60;: product, variant, consignment). 
   * @return rows
   */
  @javax.annotation.Nullable
  @Valid
  ...
  public boolean equals(Object o) {
    ...
    StockAllList stockAllList = (StockAllList) o;
    return Objects.equals(this.context, stockAllList.context) &&
        Objects.equals(this.meta, stockAllList.meta) &&
        Objects.equals(this.rows, stockAllList.rows);
  }
