 ...
 */
@JsonPropertyOrder({
  AttributeDateTime.JSON_PROPERTY_TYPE,
  AttributeDateTime.JSON_PROPERTY_VALUE
})
...
public class AttributeDateTime extends AttributeAbstract implements Attribute<String> {
  ...
  public AttributeDateTime type(@javax.annotation.Nullable TypeEnum type) {
  ...
  public AttributeDateTime value(@javax.annotation.Nullable String value) {
  ...
  public boolean equals(Object o) {
    ...
    AttributeDateTime attributeDateTime = (AttributeDateTime) o;
    return Objects.equals(this.type, attributeDateTime.type) &&
        Objects.equals(this.value, attributeDateTime.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttributeDateTime {\n");
