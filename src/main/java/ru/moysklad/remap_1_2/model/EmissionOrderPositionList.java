...
public class EmissionOrderPositionList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<EmissionOrderPosition>> rows = JsonNullable.<List<EmissionOrderPosition>>undefined();

  public EmissionOrderPositionList() {
  }

  public EmissionOrderPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public EmissionOrderPositionList rows(@javax.annotation.Nullable List<EmissionOrderPosition> rows) {
    this.rows = JsonNullable.<List<EmissionOrderPosition>>of(rows);
  ...
  public EmissionOrderPositionList addRowsItem(EmissionOrderPosition rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<EmissionOrderPosition>>of(new ArrayList<>());
    }
    try {
  ...
  public List<EmissionOrderPosition> getRows() {
  ...
  public JsonNullable<List<EmissionOrderPosition>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<EmissionOrderPosition>> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmissionOrderPositionList emissionOrderPositionList = (EmissionOrderPositionList) o;
    return Objects.equals(this.context, emissionOrderPositionList.context) &&
        Objects.equals(this.meta, emissionOrderPositionList.meta) &&
        equalsNullable(this.rows, emissionOrderPositionList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmissionOrderPositionList {\n");
