 ...
 */
@JsonPropertyOrder({
  NotificationTaskAssigned.JSON_PROPERTY_PERFORMED_BY,
  NotificationTaskAssigned.JSON_PROPERTY_TASK
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationTaskAssigned extends NotificationAbstract {
  ...
  public NotificationTaskAssigned() {
  }

  public NotificationTaskAssigned performedBy(@javax.annotation.Nullable NotificationNamedEntity performedBy) {
  ...
  public NotificationTaskAssigned task(@javax.annotation.Nullable NotificationTask task) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationTaskAssigned notificationTaskAssigned = (NotificationTaskAssigned) o;
    return Objects.equals(this.performedBy, notificationTaskAssigned.performedBy) &&
        Objects.equals(this.task, notificationTaskAssigned.task);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationTaskAssigned {\n");
