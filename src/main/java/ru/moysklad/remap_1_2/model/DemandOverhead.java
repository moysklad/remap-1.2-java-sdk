...
/**
 * Накладные расходы на уровне документа. Если позиции Отгрузки не заданы, накладные расходы задать нельзя. 
 */
@JsonPropertyOrder({
  DemandOverhead.JSON_PROPERTY_SUM,
  DemandOverhead.JSON_PROPERTY_DISTRIBUTION
})
@JsonTypeName("Demand_overhead")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-05-22T13:41:10.768379078Z[GMT]", comments = "Generator version: 7.14.0")
public class DemandOverhead {
  ...
  public DemandOverhead() {
  }

  public DemandOverhead sum(@javax.annotation.Nullable Double sum) {
  ...
  public DemandOverhead distribution(@javax.annotation.Nullable String distribution) {
  ...
  /**
   * Распределение накладных расходов между позициями. Известные значения описаны в DemandOverheadDistribution 
   * @return distribution
   */
  @javax.annotation.Nullable
  ...
  @JsonProperty(JSON_PROPERTY_DISTRIBUTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDistribution(@javax.annotation.Nullable String distribution) {
    this.distribution = distribution;
  }
  ...
  public boolean equals(Object o) {
    ...
    DemandOverhead demandOverhead = (DemandOverhead) o;
    return Objects.equals(this.sum, demandOverhead.sum) &&
        Objects.equals(this.distribution, demandOverhead.distribution);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sum, distribution);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DemandOverhead {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDistribution() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%sdistribution%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDistribution()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
