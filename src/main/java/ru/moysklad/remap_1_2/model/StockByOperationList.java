...
import ru.moysklad.remap_1_2.model.StockByOperation;
 ...
 */
@JsonPropertyOrder({
  StockByOperationList.JSON_PROPERTY_CONTEXT,
  StockByOperationList.JSON_PROPERTY_META,
  StockByOperationList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-08-25T11:18:02.225766588Z[GMT]", comments = "Generator version: 7.14.0")
public class StockByOperationList {
  ...
  @javax.annotation.Nullable
  private List<@Valid StockByOperation> rows = new ArrayList<>();

  public StockByOperationList() {
  }

  public StockByOperationList context(@javax.annotation.Nullable Context context) {
  ...
  public StockByOperationList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public StockByOperationList rows(@javax.annotation.Nullable List<@Valid StockByOperation> rows) {
  ...
  public StockByOperationList addRowsItem(StockByOperation rowsItem) {
    if (this.rows == null) {
  ...
  public List<@Valid StockByOperation> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<@Valid StockByOperation> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    StockByOperationList stockByOperationList = (StockByOperationList) o;
    return Objects.equals(this.context, stockByOperationList.context) &&
        Objects.equals(this.meta, stockByOperationList.meta) &&
        Objects.equals(this.rows, stockByOperationList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class StockByOperationList {\n");
