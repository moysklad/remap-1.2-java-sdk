...
public class Uom extends EntityWithMeta implements Named, MetaEntity {
  public static Uom createWithMeta(UUID id) {
    Uom o = new Uom();
    Meta meta = new Meta();
    meta.setType("uom");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "uom" + "/" + id;
    try {
