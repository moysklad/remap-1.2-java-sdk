 ...
 */
@JsonPropertyOrder({
  CountryList.JSON_PROPERTY_CONTEXT,
  CountryList.JSON_PROPERTY_META,
  CountryList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CountryList implements EntityList {
  ...
  public CountryList context(@javax.annotation.Nullable Context context) {
  ...
  public CountryList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CountryList rows(@javax.annotation.Nullable List<Country> rows) {
  ...
  public CountryList addRowsItem(Country rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Country> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, countryList.context) &&
        Objects.equals(this.meta, countryList.meta) &&
        Objects.equals(this.rows, countryList.rows);
  }
