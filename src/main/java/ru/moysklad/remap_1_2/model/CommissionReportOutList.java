 ...
 */
@JsonPropertyOrder({
  CommissionReportOutList.JSON_PROPERTY_CONTEXT,
  CommissionReportOutList.JSON_PROPERTY_META,
  CommissionReportOutList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CommissionReportOutList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<CommissionReportOut> rows = new ArrayList<>();

  public CommissionReportOutList() {
  }

  public CommissionReportOutList context(@javax.annotation.Nullable Context context) {
  ...
  public CommissionReportOutList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CommissionReportOutList rows(@javax.annotation.Nullable List<CommissionReportOut> rows) {
  ...
  public CommissionReportOutList addRowsItem(CommissionReportOut rowsItem) {
    if (this.rows == null) {
  ...
  public List<CommissionReportOut> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<CommissionReportOut> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    CommissionReportOutList commissionReportOutList = (CommissionReportOutList) o;
    return Objects.equals(this.context, commissionReportOutList.context) &&
        Objects.equals(this.meta, commissionReportOutList.meta) &&
        Objects.equals(this.rows, commissionReportOutList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommissionReportOutList {\n");
