 ...
 */
public enum WebhookStockReportType {
  ...
  WebhookStockReportType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static WebhookStockReportType fromValue(String value) {
    for (WebhookStockReportType b : WebhookStockReportType.values()) {
