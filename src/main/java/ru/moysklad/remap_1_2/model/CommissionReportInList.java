 ...
 */
@JsonPropertyOrder({
  CommissionReportInList.JSON_PROPERTY_CONTEXT,
  CommissionReportInList.JSON_PROPERTY_META,
  CommissionReportInList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CommissionReportInList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<CommissionReportIn> rows = new ArrayList<>();

  public CommissionReportInList() {
  }

  public CommissionReportInList context(@javax.annotation.Nullable Context context) {
  ...
  public CommissionReportInList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CommissionReportInList rows(@javax.annotation.Nullable List<CommissionReportIn> rows) {
  ...
  public CommissionReportInList addRowsItem(CommissionReportIn rowsItem) {
    if (this.rows == null) {
  ...
  public List<CommissionReportIn> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<CommissionReportIn> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    CommissionReportInList commissionReportInList = (CommissionReportInList) o;
    return Objects.equals(this.context, commissionReportInList.context) &&
        Objects.equals(this.meta, commissionReportInList.meta) &&
        Objects.equals(this.rows, commissionReportInList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommissionReportInList {\n");
