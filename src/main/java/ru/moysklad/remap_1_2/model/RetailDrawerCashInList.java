 ...
 */
@JsonPropertyOrder({
  RetailDrawerCashInList.JSON_PROPERTY_CONTEXT,
  RetailDrawerCashInList.JSON_PROPERTY_META,
  RetailDrawerCashInList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class RetailDrawerCashInList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<RetailDrawerCashIn> rows = new ArrayList<>();

  public RetailDrawerCashInList() {
  }

  public RetailDrawerCashInList context(@javax.annotation.Nullable Context context) {
  ...
  public RetailDrawerCashInList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public RetailDrawerCashInList rows(@javax.annotation.Nullable List<RetailDrawerCashIn> rows) {
  ...
  public RetailDrawerCashInList addRowsItem(RetailDrawerCashIn rowsItem) {
    if (this.rows == null) {
  ...
  public List<RetailDrawerCashIn> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<RetailDrawerCashIn> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    RetailDrawerCashInList retailDrawerCashInList = (RetailDrawerCashInList) o;
    return Objects.equals(this.context, retailDrawerCashInList.context) &&
        Objects.equals(this.meta, retailDrawerCashInList.meta) &&
        Objects.equals(this.rows, retailDrawerCashInList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetailDrawerCashInList {\n");
