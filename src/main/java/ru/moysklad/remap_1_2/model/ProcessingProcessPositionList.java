 ...
 */
@JsonPropertyOrder({
  ProcessingProcessPositionList.JSON_PROPERTY_CONTEXT,
...
public class ProcessingProcessPositionList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<ProcessingProcessPosition>> rows = JsonNullable.<List<ProcessingProcessPosition>>undefined();

  public ProcessingProcessPositionList() {
  }

  public ProcessingProcessPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public ProcessingProcessPositionList addRowsItem(ProcessingProcessPosition rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<ProcessingProcessPosition>>of(new ArrayList<>());
    }
    try {
  ...
  public List<ProcessingProcessPosition> getRows() {
  ...
  public JsonNullable<List<ProcessingProcessPosition>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<ProcessingProcessPosition>> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessingProcessPositionList processingProcessPositionList = (ProcessingProcessPositionList) o;
    return Objects.equals(this.context, processingProcessPositionList.context) &&
        Objects.equals(this.meta, processingProcessPositionList.meta) &&
        equalsNullable(this.rows, processingProcessPositionList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingProcessPositionList {\n");
