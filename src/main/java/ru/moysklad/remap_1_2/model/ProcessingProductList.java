 ...
 */
@JsonPropertyOrder({
  ProcessingProductList.JSON_PROPERTY_CONTEXT,
  ProcessingProductList.JSON_PROPERTY_META,
  ProcessingProductList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ProcessingProductList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<ProcessingProduct>> rows = JsonNullable.<List<ProcessingProduct>>undefined();

  public ProcessingProductList() {
  }

  public ProcessingProductList context(@javax.annotation.Nullable Context context) {
  ...
  public ProcessingProductList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ProcessingProductList rows(@javax.annotation.Nullable List<ProcessingProduct> rows) {
    this.rows = JsonNullable.<List<ProcessingProduct>>of(rows);
    
    return this;
  }


  public ProcessingProductList addRowsItem(ProcessingProduct rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<ProcessingProduct>>of(new ArrayList<>());
    }
    try {
  ...
  public List<ProcessingProduct> getRows() {
  ...
  public JsonNullable<List<ProcessingProduct>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<ProcessingProduct>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<ProcessingProduct> rows) {
    this.rows = JsonNullable.<List<ProcessingProduct>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    ProcessingProductList processingProductList = (ProcessingProductList) o;
    return Objects.equals(this.context, processingProductList.context) &&
        Objects.equals(this.meta, processingProductList.meta) &&
        equalsNullable(this.rows, processingProductList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProcessingProductList {\n");
