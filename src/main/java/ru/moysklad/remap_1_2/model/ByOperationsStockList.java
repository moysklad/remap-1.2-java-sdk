...
import ru.moysklad.remap_1_2.model.ByOperationsStock;
 ...
 */
@JsonPropertyOrder({
  ByOperationsStockList.JSON_PROPERTY_CONTEXT,
  ByOperationsStockList.JSON_PROPERTY_META,
  ByOperationsStockList.JSON_PROPERTY_ROWS
})
...
public class ByOperationsStockList {
  ...
  @javax.annotation.Nullable
  private List<@Valid ByOperationsStock> rows = new ArrayList<>();

  public ByOperationsStockList() {
  }

  public ByOperationsStockList context(@javax.annotation.Nullable Context context) {
  ...
  public ByOperationsStockList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ByOperationsStockList rows(@javax.annotation.Nullable List<@Valid ByOperationsStock> rows) {
  ...
  public ByOperationsStockList addRowsItem(ByOperationsStock rowsItem) {
    if (this.rows == null) {
  ...
  public List<@Valid ByOperationsStock> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<@Valid ByOperationsStock> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ByOperationsStockList byOperationsStockList = (ByOperationsStockList) o;
    return Objects.equals(this.context, byOperationsStockList.context) &&
        Objects.equals(this.meta, byOperationsStockList.meta) &&
        Objects.equals(this.rows, byOperationsStockList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ByOperationsStockList {\n");
