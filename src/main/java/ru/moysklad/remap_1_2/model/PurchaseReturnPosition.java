 ...
 */
@JsonPropertyOrder({
  PurchaseReturnPosition.JSON_PROPERTY_META,
  PurchaseReturnPosition.JSON_PROPERTY_ID,
  PurchaseReturnPosition.JSON_PROPERTY_ACCOUNT_ID,
  PurchaseReturnPosition.JSON_PROPERTY_ASSORTMENT,
  PurchaseReturnPosition.JSON_PROPERTY_DISCOUNT,
  PurchaseReturnPosition.JSON_PROPERTY_PACK,
  PurchaseReturnPosition.JSON_PROPERTY_PRICE,
  PurchaseReturnPosition.JSON_PROPERTY_QUANTITY,
  PurchaseReturnPosition.JSON_PROPERTY_SLOT,
  PurchaseReturnPosition.JSON_PROPERTY_THINGS,
...
public class PurchaseReturnPosition extends EntityWithMeta {
  public static PurchaseReturnPosition createWithMeta(UUID parentId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("purchasereturnposition");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "purchasereturn" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public PurchaseReturnPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public PurchaseReturnPosition assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public PurchaseReturnPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public PurchaseReturnPosition price(@javax.annotation.Nullable Double price) {
  ...
  public PurchaseReturnPosition quantity(@javax.annotation.Nullable Double quantity) {
 ...
 @DecimalMin("0")
  ...
  public PurchaseReturnPosition slot(@javax.annotation.Nullable StoreSlot slot) {
  ...
  public PurchaseReturnPosition things(@javax.annotation.Nullable List<String> things) {
  ...
  public PurchaseReturnPosition addThingsItem(String thingsItem) {
    if (this.things == null) {
  ...
  public PurchaseReturnPosition vat(@javax.annotation.Nullable Integer vat) {
 ...
 @Min(0) @Max(100)
  ...
  public PurchaseReturnPosition vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    PurchaseReturnPosition purchaseReturnPosition = (PurchaseReturnPosition) o;
    return Objects.equals(this.meta, purchaseReturnPosition.meta) &&
        Objects.equals(this.id, purchaseReturnPosition.id) &&
        Objects.equals(this.accountId, purchaseReturnPosition.accountId) &&
        Objects.equals(this.assortment, purchaseReturnPosition.assortment) &&
        Objects.equals(this.discount, purchaseReturnPosition.discount) &&
        equalsNullable(this.pack, purchaseReturnPosition.pack) &&
        Objects.equals(this.price, purchaseReturnPosition.price) &&
        Objects.equals(this.quantity, purchaseReturnPosition.quantity) &&
        equalsNullable(this.slot, purchaseReturnPosition.slot) &&
        Objects.equals(this.things, purchaseReturnPosition.things) &&
        Objects.equals(this.vat, purchaseReturnPosition.vat) &&
        Objects.equals(this.vatEnabled, purchaseReturnPosition.vatEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class PurchaseReturnPosition {\n");
