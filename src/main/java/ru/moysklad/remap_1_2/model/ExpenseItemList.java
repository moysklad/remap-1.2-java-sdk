 ...
 */
@JsonPropertyOrder({
  ExpenseItemList.JSON_PROPERTY_CONTEXT,
  ExpenseItemList.JSON_PROPERTY_META,
  ExpenseItemList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class ExpenseItemList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<ExpenseItem> rows = new ArrayList<>();

  public ExpenseItemList() {
  }

  public ExpenseItemList context(@javax.annotation.Nullable Context context) {
  ...
  public ExpenseItemList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ExpenseItemList rows(@javax.annotation.Nullable List<ExpenseItem> rows) {
  ...
  public ExpenseItemList addRowsItem(ExpenseItem rowsItem) {
    if (this.rows == null) {
  ...
  public List<ExpenseItem> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<ExpenseItem> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExpenseItemList expenseItemList = (ExpenseItemList) o;
    return Objects.equals(this.context, expenseItemList.context) &&
        Objects.equals(this.meta, expenseItemList.meta) &&
        Objects.equals(this.rows, expenseItemList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExpenseItemList {\n");
