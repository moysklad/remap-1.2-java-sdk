 ...
 */
@JsonPropertyOrder({
  PaymentInList.JSON_PROPERTY_CONTEXT,
  PaymentInList.JSON_PROPERTY_META,
  PaymentInList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class PaymentInList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<PaymentIn> rows = new ArrayList<>();

  public PaymentInList() {
  }

  public PaymentInList context(@javax.annotation.Nullable Context context) {
  ...
  public PaymentInList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public PaymentInList rows(@javax.annotation.Nullable List<PaymentIn> rows) {
  ...
  public PaymentInList addRowsItem(PaymentIn rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<PaymentIn> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentInList paymentInList = (PaymentInList) o;
    return Objects.equals(this.context, paymentInList.context) &&
        Objects.equals(this.meta, paymentInList.meta) &&
        Objects.equals(this.rows, paymentInList.rows);
  }
