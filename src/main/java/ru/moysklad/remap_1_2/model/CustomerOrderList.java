 ...
 */
@JsonPropertyOrder({
  CustomerOrderList.JSON_PROPERTY_CONTEXT,
  CustomerOrderList.JSON_PROPERTY_META,
  CustomerOrderList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CustomerOrderList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<CustomerOrder> rows = new ArrayList<>();

  public CustomerOrderList() {
  }

  public CustomerOrderList context(@javax.annotation.Nullable Context context) {
  ...
  public CustomerOrderList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CustomerOrderList rows(@javax.annotation.Nullable List<CustomerOrder> rows) {
  ...
  public CustomerOrderList addRowsItem(CustomerOrder rowsItem) {
    if (this.rows == null) {
  ...
  public List<CustomerOrder> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<CustomerOrder> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, customerOrderList.context) &&
        Objects.equals(this.meta, customerOrderList.meta) &&
        Objects.equals(this.rows, customerOrderList.rows);
  }
