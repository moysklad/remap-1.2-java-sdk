...
public class FinanceOutOperationCommissionReportOut extends FinanceOutOperationAbstract {
  ...
  public FinanceOutOperationCommissionReportOut attributes(@javax.annotation.Nullable List<@Valid AttributeAbstract> attributes) {
 ...
 @Size(max=255)
  ...
  public FinanceOutOperationCommissionReportOut payments(@javax.annotation.Nullable List<RetailShiftPaymentsInner> payments) {
  ...
  public FinanceOutOperationCommissionReportOut addPaymentsItem(RetailShiftPaymentsInner paymentsItem) {
