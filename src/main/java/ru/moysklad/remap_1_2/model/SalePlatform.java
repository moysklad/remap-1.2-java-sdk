 ...
 */
@JsonPropertyOrder({
  SalePlatform.JSON_PROPERTY_META,
  SalePlatform.JSON_PROPERTY_ID,
...
public class SalePlatform {
  public static SalePlatform createWithMeta(UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("saleplatform");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "saleplatform" + "/" + id;
    try {
  ...
  public static final String JSON_PROPERTY_SALE_PLATFORM_GROUP = "salePlatformGroup";
  @javax.annotation.Nullable
  private String salePlatformGroup;
  ...
  public SalePlatform meta(@javax.annotation.Nullable Meta meta) {
  ...
  public SalePlatform name(@javax.annotation.Nullable String name) {
  ...
  public String getSalePlatformGroup() {
    return salePlatformGroup;
  }
  ...
  public boolean equals(Object o) {
    ...
    SalePlatform salePlatform = (SalePlatform) o;
    return Objects.equals(this.meta, salePlatform.meta) &&
        Objects.equals(this.id, salePlatform.id) &&
        Objects.equals(this.name, salePlatform.name) &&
        Objects.equals(this.salePlatformGroup, salePlatform.salePlatformGroup);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, name, salePlatformGroup);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SalePlatform {\n");
    sb.append("    meta: ").append(toIndentedString(meta)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    salePlatformGroup: ").append(toIndentedString(salePlatformGroup)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `salePlatformGroup` to the URL query string
    if (getSalePlatformGroup() != null) {
      try {
        joiner.add(String.format(java.util.Locale.ROOT, "%ssalePlatformGroup%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSalePlatformGroup()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
