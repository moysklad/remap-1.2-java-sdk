...
public class VariantCharacteristic {
  public static VariantCharacteristic createWithMeta(UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("attributemetadata");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "variant" + "/" + "metadata" + "/" + "characteristics" + "/" + id;
    try {
