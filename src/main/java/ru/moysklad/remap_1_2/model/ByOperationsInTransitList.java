...
public class ByOperationsInTransitList {
  ...
  @javax.annotation.Nullable
  private List<ByOperationsInTransit> rows = new ArrayList<>();
  ...
  public ByOperationsInTransitList rows(@javax.annotation.Nullable List<ByOperationsInTransit> rows) {
  ...
  public List<ByOperationsInTransit> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<ByOperationsInTransit> rows) {
    this.rows = rows;
  }
