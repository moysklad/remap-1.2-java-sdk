...
import ru.moysklad.remap_1_2.model.ByOperationsInTransit;
 ...
 */
@JsonPropertyOrder({
  ByOperationsInTransitList.JSON_PROPERTY_CONTEXT,
  ByOperationsInTransitList.JSON_PROPERTY_META,
  ByOperationsInTransitList.JSON_PROPERTY_ROWS
})
...
public class ByOperationsInTransitList {
  ...
  @javax.annotation.Nullable
  private List<@Valid ByOperationsInTransit> rows = new ArrayList<>();

  public ByOperationsInTransitList() {
  }

  public ByOperationsInTransitList context(@javax.annotation.Nullable Context context) {
  ...
  public ByOperationsInTransitList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public ByOperationsInTransitList rows(@javax.annotation.Nullable List<@Valid ByOperationsInTransit> rows) {
  ...
  public ByOperationsInTransitList addRowsItem(ByOperationsInTransit rowsItem) {
    if (this.rows == null) {
  ...
  public List<@Valid ByOperationsInTransit> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<@Valid ByOperationsInTransit> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    ByOperationsInTransitList byOperationsInTransitList = (ByOperationsInTransitList) o;
    return Objects.equals(this.context, byOperationsInTransitList.context) &&
        Objects.equals(this.meta, byOperationsInTransitList.meta) &&
        Objects.equals(this.rows, byOperationsInTransitList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class ByOperationsInTransitList {\n");
