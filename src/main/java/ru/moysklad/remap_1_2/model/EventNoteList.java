 ...
 */
@JsonPropertyOrder({
  EventNoteList.JSON_PROPERTY_CONTEXT,
  EventNoteList.JSON_PROPERTY_META,
  EventNoteList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class EventNoteList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<EventNote> rows = new ArrayList<>();

  public EventNoteList() {
  }

  public EventNoteList context(@javax.annotation.Nullable Context context) {
  ...
  public EventNoteList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public EventNoteList rows(@javax.annotation.Nullable List<EventNote> rows) {
  ...
  public EventNoteList addRowsItem(EventNote rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<EventNote> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventNoteList eventNoteList = (EventNoteList) o;
    return Objects.equals(this.context, eventNoteList.context) &&
        Objects.equals(this.meta, eventNoteList.meta) &&
        Objects.equals(this.rows, eventNoteList.rows);
  }
