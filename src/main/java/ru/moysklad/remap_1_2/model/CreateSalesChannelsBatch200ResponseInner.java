 ...
 */
@JsonPropertyOrder({
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_META,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_ID,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_ACCOUNT_ID,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_ARCHIVED,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_CODE,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_DESCRIPTION,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_EXTERNAL_CODE,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_GROUP,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_NAME,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_OWNER,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_SHARED,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_TYPE,
  CreateSalesChannelsBatch200ResponseInner.JSON_PROPERTY_UPDATED,
...
public class CreateSalesChannelsBatch200ResponseInner {
  ...
  public CreateSalesChannelsBatch200ResponseInner() {
  }
  /**
  ...
  public CreateSalesChannelsBatch200ResponseInner meta(@javax.annotation.Nullable Meta meta) {
  ...
  public CreateSalesChannelsBatch200ResponseInner archived(@javax.annotation.Nullable Boolean archived) {
  ...
  public CreateSalesChannelsBatch200ResponseInner errors(@javax.annotation.Nonnull List<ErrorErrorsInner> errors) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSalesChannelsBatch200ResponseInner createSalesChannelsBatch200ResponseInner = (CreateSalesChannelsBatch200ResponseInner) o;
    return Objects.equals(this.meta, createSalesChannelsBatch200ResponseInner.meta) &&
        Objects.equals(this.id, createSalesChannelsBatch200ResponseInner.id) &&
        Objects.equals(this.accountId, createSalesChannelsBatch200ResponseInner.accountId) &&
        Objects.equals(this.archived, createSalesChannelsBatch200ResponseInner.archived) &&
        Objects.equals(this.code, createSalesChannelsBatch200ResponseInner.code) &&
        equalsNullable(this.description, createSalesChannelsBatch200ResponseInner.description) &&
        Objects.equals(this.externalCode, createSalesChannelsBatch200ResponseInner.externalCode) &&
        Objects.equals(this.group, createSalesChannelsBatch200ResponseInner.group) &&
        Objects.equals(this.name, createSalesChannelsBatch200ResponseInner.name) &&
        equalsNullable(this.owner, createSalesChannelsBatch200ResponseInner.owner) &&
        Objects.equals(this.shared, createSalesChannelsBatch200ResponseInner.shared) &&
        Objects.equals(this.type, createSalesChannelsBatch200ResponseInner.type) &&
        Objects.equals(this.updated, createSalesChannelsBatch200ResponseInner.updated) &&
        Objects.equals(this.errors, createSalesChannelsBatch200ResponseInner.errors);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, archived, code, hashCodeNullable(description), externalCode, group, name, hashCodeNullable(owner), shared, type, updated, errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSalesChannelsBatch200ResponseInner {\n");
