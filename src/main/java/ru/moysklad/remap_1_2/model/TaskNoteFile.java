 ...
 */
@JsonPropertyOrder({
  TaskNoteFile.JSON_PROPERTY_META,
...
public class TaskNoteFile {
  public static TaskNoteFile createWithMeta(UUID parentId, UUID noteId, UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("files");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "task" + "/" + parentId + "/" + "notes" + "/" + noteId + "/" + "files" + "/" + id;
    try {
  ...
  public TaskNoteFile meta(@javax.annotation.Nullable Meta meta) {
  ...
  public TaskNoteFile title(@javax.annotation.Nullable String title) {
  ...
  public TaskNoteFile createdBy(@javax.annotation.Nullable Employee createdBy) {
  ...
  public boolean equals(Object o) {
    ...
    TaskNoteFile taskNoteFile = (TaskNoteFile) o;
    return Objects.equals(this.meta, taskNoteFile.meta) &&
        ...
        Objects.equals(this.tiny, taskNoteFile.tiny) &&
        Objects.equals(this.miniature, taskNoteFile.miniature);
  }
