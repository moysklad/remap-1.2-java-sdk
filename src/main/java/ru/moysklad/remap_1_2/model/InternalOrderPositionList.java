 ...
 */
@JsonPropertyOrder({
  InternalOrderPositionList.JSON_PROPERTY_CONTEXT,
  InternalOrderPositionList.JSON_PROPERTY_META,
  InternalOrderPositionList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class InternalOrderPositionList implements EntityList {
  ...
  @javax.annotation.Nullable
  private JsonNullable<List<InternalOrderPosition>> rows = JsonNullable.<List<InternalOrderPosition>>undefined();

  public InternalOrderPositionList() {
  }

  public InternalOrderPositionList context(@javax.annotation.Nullable Context context) {
  ...
  public InternalOrderPositionList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public InternalOrderPositionList rows(@javax.annotation.Nullable List<InternalOrderPosition> rows) {
    this.rows = JsonNullable.<List<InternalOrderPosition>>of(rows);
    
    return this;
  }


  public InternalOrderPositionList addRowsItem(InternalOrderPosition rowsItem) {
    if (this.rows == null || !this.rows.isPresent()) {
      this.rows = JsonNullable.<List<InternalOrderPosition>>of(new ArrayList<>());
    }
    try {
  ...
  public List<InternalOrderPosition> getRows() {
  ...
  public JsonNullable<List<InternalOrderPosition>> getRows_JsonNullable() {
    return rows;
  }
  
  @JsonProperty(value = JSON_PROPERTY_ROWS, required = false)
  public void setRows_JsonNullable(JsonNullable<List<InternalOrderPosition>> rows) {
    this.rows = rows;
  }

  public void setRows(@javax.annotation.Nullable List<InternalOrderPosition> rows) {
    this.rows = JsonNullable.<List<InternalOrderPosition>>of(rows);
  }
  ...
  public boolean equals(Object o) {
    ...
    InternalOrderPositionList internalOrderPositionList = (InternalOrderPositionList) o;
    return Objects.equals(this.context, internalOrderPositionList.context) &&
        Objects.equals(this.meta, internalOrderPositionList.meta) &&
        equalsNullable(this.rows, internalOrderPositionList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class InternalOrderPositionList {\n");
