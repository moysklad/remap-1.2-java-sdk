 ...
 */
@JsonPropertyOrder({
  TaxRateList.JSON_PROPERTY_CONTEXT,
  TaxRateList.JSON_PROPERTY_META,
  TaxRateList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class TaxRateList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<TaxRate> rows = new ArrayList<>();

  public TaxRateList() {
  }

  public TaxRateList context(@javax.annotation.Nullable Context context) {
  ...
  public TaxRateList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public TaxRateList rows(@javax.annotation.Nullable List<TaxRate> rows) {
  ...
  public TaxRateList addRowsItem(TaxRate rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<TaxRate> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    TaxRateList taxRateList = (TaxRateList) o;
    return Objects.equals(this.context, taxRateList.context) &&
        Objects.equals(this.meta, taxRateList.meta) &&
        Objects.equals(this.rows, taxRateList.rows);
  }
