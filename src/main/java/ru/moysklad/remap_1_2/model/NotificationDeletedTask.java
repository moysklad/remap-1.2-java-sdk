 ...
 */
@JsonPropertyOrder({
  NotificationDeletedTask.JSON_PROPERTY_NAME
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NotificationDeletedTask {

  public static final String JSON_PROPERTY_NAME = "name";
  @javax.annotation.Nullable
  private String name;

  public NotificationDeletedTask() {
  }

  public NotificationDeletedTask name(@javax.annotation.Nullable String name) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationDeletedTask notificationDeletedTask = (NotificationDeletedTask) o;
    return Objects.equals(this.name, notificationDeletedTask.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationDeletedTask {\n");
