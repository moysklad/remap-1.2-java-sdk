 ...
 */
public enum CostDistributionType {
  ...
  CostDistributionType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static CostDistributionType fromValue(String value) {
    for (CostDistributionType b : CostDistributionType.values()) {
