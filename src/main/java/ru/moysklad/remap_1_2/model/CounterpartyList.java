 ...
 */
@JsonPropertyOrder({
  CounterpartyList.JSON_PROPERTY_CONTEXT,
  CounterpartyList.JSON_PROPERTY_META,
  CounterpartyList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class CounterpartyList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Counterparty> rows = new ArrayList<>();

  public CounterpartyList() {
  }

  public CounterpartyList context(@javax.annotation.Nullable Context context) {
  ...
  public CounterpartyList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public CounterpartyList rows(@javax.annotation.Nullable List<Counterparty> rows) {
  ...
  public CounterpartyList addRowsItem(Counterparty rowsItem) {
    if (this.rows == null) {
  ...
  public List<Counterparty> getRows() {
    return rows;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Counterparty> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    CounterpartyList counterpartyList = (CounterpartyList) o;
    return Objects.equals(this.context, counterpartyList.context) &&
        Objects.equals(this.meta, counterpartyList.meta) &&
        Objects.equals(this.rows, counterpartyList.rows);
  }
  ...
  public String toString() {
    ...
    sb.append("class CounterpartyList {\n");
