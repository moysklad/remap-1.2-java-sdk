 ...
 */
@JsonPropertyOrder({
  Country.JSON_PROPERTY_META,
  Country.JSON_PROPERTY_ID,
  Country.JSON_PROPERTY_ACCOUNT_ID,
  Country.JSON_PROPERTY_NAME,
  Country.JSON_PROPERTY_DESCRIPTION,
  Country.JSON_PROPERTY_CODE,
  Country.JSON_PROPERTY_EXTERNAL_CODE,
  Country.JSON_PROPERTY_UPDATED,
  Country.JSON_PROPERTY_GROUP,
  Country.JSON_PROPERTY_OWNER,
  Country.JSON_PROPERTY_SHARED
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class Country extends EntityWithMeta implements Named, MetaEntity {
  public static Country createWithMeta(UUID id) {
    Country o = new Country();
    Meta meta = new Meta();
    meta.setType("country");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "country" + "/" + id;
    try {
  ...
  public Country meta(@javax.annotation.Nullable Meta meta) {
  ...
  public Country group(@javax.annotation.Nullable Group group) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, country.meta) &&
        Objects.equals(this.id, country.id) &&
        Objects.equals(this.accountId, country.accountId) &&
        ...
        Objects.equals(this.externalCode, country.externalCode) &&
        Objects.equals(this.updated, country.updated) &&
        Objects.equals(this.group, country.group) &&
        equalsNullable(this.owner, country.owner) &&
        Objects.equals(this.shared, country.shared);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, name, description, code, externalCode, updated, group, hashCodeNullable(owner), shared);
  }
