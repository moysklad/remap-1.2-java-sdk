 ...
 */
@JsonPropertyOrder({
  InvoiceInPosition.JSON_PROPERTY_META,
  InvoiceInPosition.JSON_PROPERTY_ID,
  InvoiceInPosition.JSON_PROPERTY_ACCOUNT_ID,
  InvoiceInPosition.JSON_PROPERTY_QUANTITY,
  InvoiceInPosition.JSON_PROPERTY_PRICE,
  InvoiceInPosition.JSON_PROPERTY_DISCOUNT,
  InvoiceInPosition.JSON_PROPERTY_VAT,
  InvoiceInPosition.JSON_PROPERTY_VAT_ENABLED,
  InvoiceInPosition.JSON_PROPERTY_ASSORTMENT,
  InvoiceInPosition.JSON_PROPERTY_PACK
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class InvoiceInPosition extends EntityWithMeta implements DocumentPosition, MetaEntity {
  public static InvoiceInPosition createWithMeta(UUID parentId, UUID id) {
    InvoiceInPosition o = new InvoiceInPosition();
    Meta meta = new Meta();
    meta.setType("invoiceposition");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "invoicein" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public InvoiceInPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public InvoiceInPosition id(@javax.annotation.Nullable UUID id) {
  ...
  public InvoiceInPosition quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public InvoiceInPosition price(@javax.annotation.Nullable Double price) {
  ...
  public InvoiceInPosition discount(@javax.annotation.Nullable Double discount) {
  ...
  public InvoiceInPosition vat(@javax.annotation.Nullable Integer vat) {
  ...
  public InvoiceInPosition vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public InvoiceInPosition assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public InvoiceInPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public boolean equals(Object o) {
    ...
    InvoiceInPosition invoiceInPosition = (InvoiceInPosition) o;
    return Objects.equals(this.meta, invoiceInPosition.meta) &&
        Objects.equals(this.id, invoiceInPosition.id) &&
        Objects.equals(this.accountId, invoiceInPosition.accountId) &&
        Objects.equals(this.quantity, invoiceInPosition.quantity) &&
        Objects.equals(this.price, invoiceInPosition.price) &&
        Objects.equals(this.discount, invoiceInPosition.discount) &&
        Objects.equals(this.vat, invoiceInPosition.vat) &&
        Objects.equals(this.vatEnabled, invoiceInPosition.vatEnabled) &&
        Objects.equals(this.assortment, invoiceInPosition.assortment) &&
        equalsNullable(this.pack, invoiceInPosition.pack);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, quantity, price, discount, vat, vatEnabled, assortment, hashCodeNullable(pack));
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoiceInPosition {\n");
