 ...
 */
@JsonPropertyOrder({
  VariantList.JSON_PROPERTY_CONTEXT,
  VariantList.JSON_PROPERTY_META,
  VariantList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class VariantList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Variant> rows = new ArrayList<>();

  public VariantList() {
  }

  public VariantList context(@javax.annotation.Nullable Context context) {
  ...
  public VariantList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public VariantList rows(@javax.annotation.Nullable List<Variant> rows) {
  ...
  public VariantList addRowsItem(Variant rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Variant> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, variantList.context) &&
        Objects.equals(this.meta, variantList.meta) &&
        Objects.equals(this.rows, variantList.rows);
  }
