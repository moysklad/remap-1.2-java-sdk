 ...
 */
@JsonPropertyOrder({
  WebhookStock.JSON_PROPERTY_META,
  WebhookStock.JSON_PROPERTY_ID,
  WebhookStock.JSON_PROPERTY_ACCOUNT_ID,
  WebhookStock.JSON_PROPERTY_STOCK_TYPE,
  WebhookStock.JSON_PROPERTY_REPORT_TYPE,
  WebhookStock.JSON_PROPERTY_URL,
...
public class WebhookStock {
  public static WebhookStock createWithMeta(UUID id) {
    ...
    Meta meta = new Meta();
    meta.setType("webhookstock");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "webhookstock" + "/" + id;
    try {
  ...
  public WebhookStock meta(@javax.annotation.Nullable Meta meta) {
  ...
  public WebhookStock stockType(@javax.annotation.Nullable String stockType) {
  ...
  public boolean equals(Object o) {
    ...
    WebhookStock webhookStock = (WebhookStock) o;
    return Objects.equals(this.meta, webhookStock.meta) &&
        Objects.equals(this.id, webhookStock.id) &&
        Objects.equals(this.accountId, webhookStock.accountId) &&
        Objects.equals(this.stockType, webhookStock.stockType) &&
        Objects.equals(this.reportType, webhookStock.reportType) &&
        Objects.equals(this.url, webhookStock.url) &&
        Objects.equals(this.enabled, webhookStock.enabled) &&
        Objects.equals(this.authorApplication, webhookStock.authorApplication);
  }

  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, stockType, reportType, url, enabled, authorApplication);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WebhookStock {\n");
