 ...
 */
@JsonPropertyOrder({
  NewMentionInEvent.JSON_PROPERTY_OPERATION
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class NewMentionInEvent extends NotificationAbstract {

  public static final String JSON_PROPERTY_OPERATION = "operation";
  @javax.annotation.Nullable
  private NotificationNamedEntity operation;

  public NewMentionInEvent() {
  }
  /**
  ...
  @JsonCreator
  public NewMentionInEvent(
    @JsonProperty(value = JSON_PROPERTY_OPERATION, required = false) NotificationNamedEntity operation
  ) {
    this();
  ...
  public NotificationNamedEntity getOperation() {
    return operation;
  }
  ...
  public boolean equals(Object o) {
    ...
    NewMentionInEvent newMentionInEvent = (NewMentionInEvent) o;
    return Objects.equals(this.operation, newMentionInEvent.operation);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewMentionInEvent {\n");
