 ...
 */
@JsonPropertyOrder({
  StoreList.JSON_PROPERTY_CONTEXT,
  StoreList.JSON_PROPERTY_META,
  StoreList.JSON_PROPERTY_ROWS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class StoreList implements EntityList {
  ...
  @javax.annotation.Nullable
  private List<Store> rows = new ArrayList<>();

  public StoreList() {
  }

  public StoreList context(@javax.annotation.Nullable Context context) {
  ...
  public StoreList meta(@javax.annotation.Nullable MetaList meta) {
  ...
  public StoreList rows(@javax.annotation.Nullable List<Store> rows) {
  ...
  public StoreList addRowsItem(Store rowsItem) {
    if (this.rows == null) {
  ...
  @JsonProperty(JSON_PROPERTY_ROWS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRows(@javax.annotation.Nullable List<Store> rows) {
    this.rows = rows;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.context, storeList.context) &&
        Objects.equals(this.meta, storeList.meta) &&
        Objects.equals(this.rows, storeList.rows);
  }
