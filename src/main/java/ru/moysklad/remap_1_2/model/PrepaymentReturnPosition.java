 ...
 */
@JsonPropertyOrder({
  PrepaymentReturnPosition.JSON_PROPERTY_META,
  PrepaymentReturnPosition.JSON_PROPERTY_ID,
  PrepaymentReturnPosition.JSON_PROPERTY_ACCOUNT_ID,
  PrepaymentReturnPosition.JSON_PROPERTY_ASSORTMENT,
  PrepaymentReturnPosition.JSON_PROPERTY_DISCOUNT,
  PrepaymentReturnPosition.JSON_PROPERTY_PACK,
  PrepaymentReturnPosition.JSON_PROPERTY_PRICE,
  PrepaymentReturnPosition.JSON_PROPERTY_QUANTITY,
  PrepaymentReturnPosition.JSON_PROPERTY_VAT,
  PrepaymentReturnPosition.JSON_PROPERTY_VAT_ENABLED
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-09-01T11:48:09.280618073Z[GMT]", comments = "Generator version: 7.14.0")
public class PrepaymentReturnPosition extends EntityWithMeta implements DocumentPosition, MetaEntity {
  public static PrepaymentReturnPosition createWithMeta(UUID parentId, UUID id) {
    PrepaymentReturnPosition o = new PrepaymentReturnPosition();
    Meta meta = new Meta();
    meta.setType("prepaymentreturnposition");
    String href = ru.moysklad.remap_1_2.Configuration.getDefaultApiClient().getBaseURL() + "/" + "entity" + "/" + "prepaymentreturn" + "/" + parentId + "/" + "positions" + "/" + id;
    try {
  ...
  public PrepaymentReturnPosition() {
  }
  /**
  ...
  public PrepaymentReturnPosition meta(@javax.annotation.Nullable Meta meta) {
  ...
  public PrepaymentReturnPosition id(@javax.annotation.Nullable UUID id) {
  ...
  public PrepaymentReturnPosition assortment(@javax.annotation.Nullable ProductMarker assortment) {
  ...
  public PrepaymentReturnPosition discount(@javax.annotation.Nullable Double discount) {
  ...
  public PrepaymentReturnPosition pack(@javax.annotation.Nullable Pack pack) {
  ...
  public PrepaymentReturnPosition price(@javax.annotation.Nullable Double price) {
  ...
  public PrepaymentReturnPosition quantity(@javax.annotation.Nullable Double quantity) {
  ...
  public PrepaymentReturnPosition vat(@javax.annotation.Nullable Integer vat) {
  ...
  public PrepaymentReturnPosition vatEnabled(@javax.annotation.Nullable Boolean vatEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    PrepaymentReturnPosition prepaymentReturnPosition = (PrepaymentReturnPosition) o;
    return Objects.equals(this.meta, prepaymentReturnPosition.meta) &&
        Objects.equals(this.id, prepaymentReturnPosition.id) &&
        Objects.equals(this.accountId, prepaymentReturnPosition.accountId) &&
        Objects.equals(this.assortment, prepaymentReturnPosition.assortment) &&
        Objects.equals(this.discount, prepaymentReturnPosition.discount) &&
        equalsNullable(this.pack, prepaymentReturnPosition.pack) &&
        Objects.equals(this.price, prepaymentReturnPosition.price) &&
        Objects.equals(this.quantity, prepaymentReturnPosition.quantity) &&
        Objects.equals(this.vat, prepaymentReturnPosition.vat) &&
        Objects.equals(this.vatEnabled, prepaymentReturnPosition.vatEnabled);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(meta, id, accountId, assortment, discount, hashCodeNullable(pack), price, quantity, vat, vatEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrepaymentReturnPosition {\n");
